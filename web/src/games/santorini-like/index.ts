...
const SantoriniLikeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SantoriniLikeGame as unknown as React.ComponentType<unknown> })));
...
export const santoriniLikePlugin: GamePlugin<SantoriniLikeState, SantoriniLikeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: SantoriniLikeState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-santorini-like-answer-0"]', pulses: 3 } : null, component:SantoriniLikeGame,
};
