...
const Chess960Game = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Chess960Game as unknown as React.ComponentType<unknown> })));
...
Click a piece to select it, then click a highlighted square to move. You play White; the bot plays Black. Easy = depth 2, Medium = depth 3, Hard = depth 4.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".c9-promo-btn", pulses: 3 }; },
