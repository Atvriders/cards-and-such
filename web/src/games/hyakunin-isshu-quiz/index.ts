...
const HyakuninIsshuGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HyakuninIsshuGame as unknown as React.ComponentType<unknown> })));
...
export const hyakuninIsshuPlugin: GamePlugin<HyakuninIsshuState, HyakuninIsshuAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HyakuninIsshuState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HyakuninIsshuGame,
};
