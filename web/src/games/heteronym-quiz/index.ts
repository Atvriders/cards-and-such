...
const HeteronymQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HeteronymQuizGame as unknown as React.ComponentType<unknown> })));
...
export const heteronymQuizPlugin: GamePlugin<HeteronymQuizState, HeteronymQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HeteronymQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HeteronymQuizGame,
};
