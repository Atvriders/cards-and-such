...
export type RamschSkatState = HuTrickState;
export type RamschSkatAction = HuTrickAction;
export interface RamschSkatSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: RamschSkatSettings): RamschSkatState => engine.initialState(seed);
