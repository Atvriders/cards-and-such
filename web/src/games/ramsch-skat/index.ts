...
const RamschSkatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RamschSkatGame as unknown as React.ComponentType<unknown> })));
...
export const ramschSkatPlugin: GamePlugin<RamschSkatState, RamschSkatAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: RamschSkatState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-ram-s-${pick.id}"]`, pulses: 3 };
    }
