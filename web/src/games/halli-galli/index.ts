...
const HalliGalliGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HalliGalliGame as unknown as React.ComponentType<unknown> })));
...
export const halliGalliPlugin: GamePlugin<HalliGalliState, HalliGalliAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: HalliGalliState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-halli-galli-answer-0"]', pulses: 3 } : null, component: HalliGalliGame,
};
