...
const WonderfulWorldWarGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WonderfulWorldWarGame as unknown as React.ComponentType<unknown> })));
