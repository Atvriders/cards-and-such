...
export interface RailroadInkYellowSettings { dummy: boolean; }
export interface RailroadInkYellowState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type RailroadInkYellowAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: RailroadInkYellowSettings): RailroadInkYellowState {
  return {
    rngSeed: seed,
...
export function reducer(state: RailroadInkYellowState, action: RailroadInkYellowAction): RailroadInkYellowState {
...
export function isTerminal(state: RailroadInkYellowState): { score: number } | null {
