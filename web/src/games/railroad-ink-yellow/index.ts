...
const RailroadInkYellowGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RailroadInkYellowGame as unknown as React.ComponentType<unknown> })));
...
export const railroadInkYellowPlugin: GamePlugin<RailroadInkYellowState, RailroadInkYellowAction, typeof settings> = {
  ...
  title: "Railroad Ink Yellow",
  category: "dice",
  players: { min: 1, max: 1, multiplayer: false },
  description: "Desert-themed Railroad Ink with sandstorms and oasis bonuses.",
  howToPlay: `Railroad Ink Yellow is a 12-roll dice-and-mark game with themed scoring.
...
Theme: Each odd roll: +1 oasis bonus.
