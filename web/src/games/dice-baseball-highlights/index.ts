...
const DiceBaseballHighlightsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceBaseballHighlightsGame as unknown as React.ComponentType<unknown> })));
