...
export interface BigFortySettings { dummy: boolean; }

export interface BigFortyState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: BigFortySettings): BigFortyState {
...
export function reducer(state: BigFortyState, action: BigFortyAction): BigFortyState {
...
export function isTerminal(state: BigFortyState): { score: number } | null {
