...
const TarokyGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TarokyGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const tarokyPlugin: GamePlugin<TarokyState, TarokyAction, typeof settings> = {
  id: "taroky",
  title: "Taroky",
  category: "cards",
  ...
  reducer,
  isTerminal,
  hint: (state: TarokyState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-tarokyc-${pick.id}"]`, pulses: 3 };
    }
