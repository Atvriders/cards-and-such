...
export type TarokyState = HuTrickState;
export type TarokyAction = HuTrickAction;
export interface TarokySettings { dummy: boolean }
...
export const initialState = (seed: number, _s: TarokySettings): TarokyState => engine.initialState(seed);
