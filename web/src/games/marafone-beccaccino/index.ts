...
const MarafoneGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MarafoneGame as unknown as React.ComponentType<unknown> })));
...
export const marafoneBeccaccinoPlugin: GamePlugin<MarafoneState, MarafoneAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: MarafoneState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-marafc-${pick.id}"]`, pulses: 3 };
    }
