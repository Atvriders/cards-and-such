...
export type MarafoneState = HuTrickState;
export type MarafoneAction = HuTrickAction;
export interface MarafoneSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: MarafoneSettings): MarafoneState => engine.initialState(seed);
