...
export const MAX_GUESSES = 21;

export type Tile = "absent" | "present" | "correct" | "blank";

export interface SedecordleMiniSettings {
  rounds: "5" | "8" | "10";
}
...
export function initialState(seed: number, _settings: SedecordleMiniSettings): SedecordleMiniState {
  return {
