...
const AzulSintraGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AzulSintraGame as unknown as React.ComponentType<unknown> })));
...
export const azulSintraPlugin: GamePlugin<AzulSintraState, AzulSintraAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: AzulSintraState): HintTarget | null => {
    const sel = tileHintSelector(state, "azulsi-grid");
