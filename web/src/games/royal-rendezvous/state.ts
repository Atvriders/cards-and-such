...
export interface RoyalRendezvousSettings { dummy: boolean; }

export interface RoyalRendezvousState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type RoyalRendezvousAction =
  | { type: "keep" }
...
export function reducer(state: RoyalRendezvousState, action: RoyalRendezvousAction): RoyalRendezvousState {
...
export function isTerminal(state: RoyalRendezvousState): { score: number } | null {
