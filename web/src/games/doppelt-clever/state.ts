...
export interface DoppeltCleverSettings { dummy: boolean; }
export interface DoppeltCleverState {
  rngSeed: number;
...
export type DoppeltCleverAction =
  | { type: "roll" }
...
export function initialState(seed: number, _s: DoppeltCleverSettings): DoppeltCleverState {
  return {
    rngSeed: seed >>> 0,
...
export function reducer(state: DoppeltCleverState, action: DoppeltCleverAction): DoppeltCleverState {
...
export function isTerminal(state: DoppeltCleverState): { score: number } | null {
