...
export type DoubleDeckPinochleState = HuTrickState;
export type DoubleDeckPinochleAction = HuTrickAction;
export interface DoubleDeckPinochleSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: DoubleDeckPinochleSettings): DoubleDeckPinochleState => engine.initialState(seed);
