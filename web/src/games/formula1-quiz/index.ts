...
const Formula1QuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Formula1QuizGame as unknown as React.ComponentType<unknown> })));
...
export const formula1QuizPlugin: GamePlugin<Formula1QuizState, Formula1QuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: Formula1QuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:Formula1QuizGame,
};
