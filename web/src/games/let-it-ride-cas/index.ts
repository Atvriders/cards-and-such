...
const hint = (state: LetItRideCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-let-it-ride-cas-primary"]', pulses: 3 } : null);
export const letItRideCasPlugin: GamePlugin<LetItRideCasState, LetItRideCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: LetItRideCasGame,
};
