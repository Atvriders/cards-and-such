...
const MarvelMcuQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MarvelMcuQuizGame as unknown as React.ComponentType<unknown> })));
...
export const marvelMcuQuizPlugin: GamePlugin<MarvelMcuQuizState, MarvelMcuQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MarvelMcuQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MarvelMcuQuizGame,
};
