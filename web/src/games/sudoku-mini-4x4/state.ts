...
export interface SudokuMini4x4State {
  ...
  score: number;
  phase: "playing" | "done";
  settings: SudokuMini4x4Settings;
}

export type SudokuMini4x4Action =
...
export function initialState(seed: number, settings: SudokuMini4x4Settings): SudokuMini4x4State {
