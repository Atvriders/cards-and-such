...
const VikingQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.VikingQuizGame as unknown as React.ComponentType<unknown> })));
...
export const vikingQuizPlugin: GamePlugin<VikingQuizState, VikingQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: VikingQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:VikingQuizGame,
};
