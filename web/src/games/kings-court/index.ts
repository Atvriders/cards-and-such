...
const KingsCourtGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KingsCourtGame as unknown as React.ComponentType<unknown> })));
...
export const kingsCourtPlugin: GamePlugin<KingsCourtState, KingsCourtAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-kings-court-primary"]', pulses: 3 }),component:KingsCourtGame,
};
