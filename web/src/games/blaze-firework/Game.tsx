...
export function blazeFireworkGame({ state, dispatch, onGameOver }: GameProps<blazeFireworkState, blazeFireworkSettings>): JSX.Element {
      ...
      <div className="rw-grid" style={{ gridTemplateColumns: `repeat(${GRID_SIZE}, 44px)` }}>
        {state.cells.map((filled, i) => (
          <button
            ...
            onClick={() => dispatch({ type: "mark", index: i } as blazeFireworkAction)}
