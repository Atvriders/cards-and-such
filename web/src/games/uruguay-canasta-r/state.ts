...
export interface UruguayCanastaRSettings { dummy: boolean; }
export interface UruguayCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type UruguayCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: UruguayCanastaRSettings): UruguayCanastaRState {
...
export function reducer(state: UruguayCanastaRState, action: UruguayCanastaRAction): UruguayCanastaRState {
...
export function isTerminal(state: UruguayCanastaRState): { score: number } | null {
