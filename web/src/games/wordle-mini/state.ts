...
export const PUZZLES: Puzzle[] = [
  { prompt: "Sour citrus fruit", answer: "LEMON", distractors: ["MELON","NYLON","ALMON"] },
  { prompt: "Stringed instrument", answer: "PIANO", distractors: ["TANGO","VIOLA","CELLO"] },
  { prompt: "Frozen water", answer: "GLACE", distractors: ["FROST","RIVER","STEAM"] },
  { prompt: "Garden flower", answer: "ROSES", distractors: ["TULIP","DAISY","LILAC"] },
  { prompt: "Sea predator", answer: "SHARK", distractors: ["WHALE","TROUT","SQUID"] },
  { prompt: "Weather event", answer: "STORM", distractors: ["CLOUD","RAINY","WINDY"] },
  { prompt: "Land vehicle", answer: "TRUCK", distractors: ["TRAIN","CYCLE","SCOOT"] },
  { prompt: "Metal mined", answer: "STEEL", distractors: ["BRONZE","COPPR","IRONY"] },
  { prompt: "Citrus tree", answer: "LIMES", distractors: ["APPLE","GRAPE","PEACH"] },
  { prompt: "Bird of prey", answer: "EAGLE", distractors: ["CROWS","HAWKS","OWLET"] },
];

export interface WordleMiniSettings { rounds: "5" | "8" | "10"; }
