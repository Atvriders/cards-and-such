...
export interface WaspSoliSettings { dummy: boolean; }

export interface WaspSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: WaspSoliSettings): WaspSoliState {
...
export function reducer(state: WaspSoliState, action: WaspSoliAction): WaspSoliState {
...
export function isTerminal(state: WaspSoliState): { score: number } | null {
