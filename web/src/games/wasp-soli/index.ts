...
const WaspSoliGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WaspSoliGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const waspSoliPlugin: GamePlugin<WaspSoliState, WaspSoliAction, typeof settings> = {
  id: "wasp-soli",
  title: "Wasp",
  category: "solitaire",
  players: { min: 1, max: 1, multiplayer: false },
  description: "Solitaire micro-variant — Scorpion variant where all four base cards land on foundations automatically.",
