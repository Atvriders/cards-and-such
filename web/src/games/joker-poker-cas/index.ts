...
const hint = (state: JokerPokerCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-joker-poker-cas-primary"]', pulses: 3 } : null);
export const jokerPokerCasPlugin: GamePlugin<JokerPokerCasState, JokerPokerCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: JokerPokerCasGame,
};
