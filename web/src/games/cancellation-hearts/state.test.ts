...
describe("cancellation-hearts initialState", () => {
...
describe("cancellation-hearts legalPlays", () => {
...
describe("cancellation-hearts reducer", () => {
...
describe("cancellation-hearts full game", () => {
