...
const FourColorFlushGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FourColorFlushGame as unknown as React.ComponentType<unknown> })));
...
export const fourColorFlushPlugin: GamePlugin<FourColorFlushState, FourColorFlushAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-four-color-flush-primary"]', pulses: 3 }),component:FourColorFlushGame,
};
