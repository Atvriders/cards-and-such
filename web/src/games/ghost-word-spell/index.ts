...
const GhostWordSpellGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GhostWordSpellGame as unknown as React.ComponentType<unknown> })));
...
export const ghostWordSpellPlugin: GamePlugin<GhostWordSpellState, GhostWordSpellAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: GhostWordSpellState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-ghost-word-spell-answer-0"]', pulses: 3 } : null, component:GhostWordSpellGame,
};
