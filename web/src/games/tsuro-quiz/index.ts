...
const TsuroQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TsuroQuizGame as unknown as React.ComponentType<unknown> })));
...
export const tsuroQuizPlugin: GamePlugin<TsuroQuizState, TsuroQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TsuroQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TsuroQuizGame,
};
