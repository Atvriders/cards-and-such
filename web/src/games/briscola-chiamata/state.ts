...
export type BriscolaChiamataState = HuTrickState;
export type BriscolaChiamataAction = HuTrickAction;
export interface BriscolaChiamataSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: BriscolaChiamataSettings): BriscolaChiamataState => engine.initialState(seed);
