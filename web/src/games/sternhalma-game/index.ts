...
const SternhalmaGameGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SternhalmaGameGame as unknown as React.ComponentType<unknown> })));
...
export const sternhalmaGamePlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".shm-board")) ? { selector: ".shm-board", pulses: 3 } : null,
