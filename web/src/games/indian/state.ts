...
export interface IndianSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: IndianSettings): IndianState {
...
export function reducer(state: IndianState, action: IndianAction): IndianState {
...
export function isTerminal(state: IndianState): { score: number } | null {
