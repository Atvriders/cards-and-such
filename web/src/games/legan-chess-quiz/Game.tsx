    ...
    <div className="legchq-wrap">
      ...
      <div className="legchq-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as LeganChessQuizAction)}><span className="legchq-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
