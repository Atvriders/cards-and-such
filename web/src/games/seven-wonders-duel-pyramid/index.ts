...
const SevenWondersDuelPyramidGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SevenWondersDuelPyramidGame as unknown as React.ComponentType<unknown> })));
