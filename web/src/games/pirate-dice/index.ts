...
Reach the treasure target to win! Your final score rewards doing it in fewer turns. A bold captain banks big hauls; a wise one knows when to stop.`,
  ...
  hint: (state) => {
    ...
    if (phase === "rolling") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "rolling-dice") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "preRoll") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "ready") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "playerRoll") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "roll") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "play") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "playing") return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
    if (phase === "roundOver") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "result") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "settled") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "banked") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "done") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "farkled") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    if (phase === "busted") return { selector: '[data-testid="hint-target-pirate-dice-nextTurn"]', pulses: 3 };
    return { selector: '[data-testid="hint-target-pirate-dice-roll"]', pulses: 3 };
  },
