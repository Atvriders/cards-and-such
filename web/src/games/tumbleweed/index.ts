...
const TumbleweedGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TumbleweedGame as unknown as React.ComponentType<unknown> })));
...
Bot: greedy placement maximizing territory difference.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver || (s as any).won || (s as any).isWon || (s as any).isComplete || (s as any).complete) return null; return { selector: '[data-testid="hint-target-tumbleweed-action"]', pulses: 3 }; },
