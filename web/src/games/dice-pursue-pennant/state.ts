...
export type DicePursuePennantStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DicePursuePennantState, action: DicePursuePennantStateAction): DicePursuePennantState {
