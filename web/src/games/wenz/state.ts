...
export type WenzState = HuTrickState;
export type WenzAction = HuTrickAction;
export interface WenzSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: WenzSettings): WenzState => engine.initialState(seed);
