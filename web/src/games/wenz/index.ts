...
const WenzGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WenzGame as unknown as React.ComponentType<unknown> })));
...
export const wenzPlugin: GamePlugin<WenzState, WenzAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: WenzState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-wenzc-${pick.id}"]`, pulses: 3 };
    }
