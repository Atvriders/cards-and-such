...
const IronswornDelveQuestGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.IronswornDelveQuestGame as unknown as React.ComponentType<unknown> })));
...
export const ironswornDelveQuestPlugin: GamePlugin<IronswornDelveQuestState, IronswornDelveQuestAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: IronswornDelveQuestState): HintTarget | null => (state.phase === "choose" ? { selector: '[data-testid="hint-target-ironsworn-delve-quest-primary"]', pulses: 3 } : null), component: IronswornDelveQuestGame,
};
