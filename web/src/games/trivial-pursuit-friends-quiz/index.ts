...
const TrivialPursuitFriendsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TrivialPursuitFriendsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const trivialPursuitFriendsQuizPlugin: GamePlugin<TrivialPursuitFriendsQuizState, TrivialPursuitFriendsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TrivialPursuitFriendsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TrivialPursuitFriendsQuizGame,
};
