...
const BetweenTwoCitiesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BetweenTwoCitiesGame as unknown as React.ComponentType<unknown> })));
