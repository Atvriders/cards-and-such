...
export type QuoitsTossAction = { type: "throw" } | { type: "next" };

export function initialState(seed: number, _s: QuoitsTossSettings): QuoitsTossState {
...
export function isTerminal(s: QuoitsTossState): { score: number } | null { return s.phase === "done" ? { score: s.score } : null; }
