...
import "./Game.css";
export function FantasylandOfcGame({ state, dispatch, onGameOver }: GameProps<FantasylandOfcState, FantasylandOfcSettings>): JSX.Element {
  const t = isTerminal(state); useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  if (state.phase === "done") return <div className="dm-wrap thmFantasy"><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  return (
    <div className="dm-wrap thmFantasy">
