...
const CalicoGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CalicoGame as unknown as React.ComponentType<unknown> })));
...
export const calicoPlugin: GamePlugin<CalicoState, CalicoAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: CalicoState): HintTarget | null => {
    const sel = tileHintSelector(state, "cal-grid");
