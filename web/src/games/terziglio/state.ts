...
export type TerziglioState = HuTrickState;
export type TerziglioAction = HuTrickAction;
export interface TerziglioSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: TerziglioSettings): TerziglioState => engine.initialState(seed);
