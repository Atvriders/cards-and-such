...
export interface BearRiverSettings { dummy: boolean; }

export interface BearRiverState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: BearRiverSettings): BearRiverState {
...
export function reducer(state: BearRiverState, action: BearRiverAction): BearRiverState {
...
export function isTerminal(state: BearRiverState): { score: number } | null {
