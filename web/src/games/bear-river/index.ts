...
const BearRiverGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BearRiverGame as unknown as React.ComponentType<unknown> })));
...
export const bearRiverPlugin: GamePlugin<BearRiverState, BearRiverAction, typeof settings> = {
  ...
  reducer,isTerminal,component:BearRiverGame,
