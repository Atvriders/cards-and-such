...
const SevenWondersPyramidExtraGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SevenWondersPyramidExtraGame as unknown as React.ComponentType<unknown> })));
