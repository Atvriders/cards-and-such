...
const GapsTwoDeckGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GapsTwoDeckGame as unknown as React.ComponentType<unknown> })));
...
export const gapsTwoDeckPlugin: GamePlugin<GapsTwoDeckState, GapsTwoDeckAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as GapsTwoDeckSettings),
