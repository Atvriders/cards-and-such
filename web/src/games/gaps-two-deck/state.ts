...
export interface GapsTwoDeckSettings { dummy: boolean; }

export interface GapsTwoDeckState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: GapsTwoDeckState, action: GapsTwoDeckAction): GapsTwoDeckState {
...
export function isTerminal(state: GapsTwoDeckState): { score: number } | null {
