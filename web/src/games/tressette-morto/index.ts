...
const TressetteMortoGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TressetteMortoGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const tressetteMortoPlugin: GamePlugin<TressetteMortoState, TressetteMortoAction, typeof settings> = {
  id: "tressette-morto",
  ...
  reducer,
  isTerminal,
  hint: (state: TressetteMortoState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-tremc-${pick.id}"]`, pulses: 3 };
    }
