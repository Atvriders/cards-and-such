...
export const INITIAL_FLIP = 21;
export const MAX_CLICKS = 30;

export interface MiniPyramidSolitaireSettings { dummy: boolean; }

export interface MiniPyramidSolitaireState {
  rngSeed: number;
...
export type MiniPyramidSolitaireAction = { type: "remove"; index: number } | { type: "noop" };
...
export function initialState(seed: number, _settings: MiniPyramidSolitaireSettings): MiniPyramidSolitaireState {
...
export function reducer(state: MiniPyramidSolitaireState, action: MiniPyramidSolitaireAction): MiniPyramidSolitaireState {
...
export function isTerminal(state: MiniPyramidSolitaireState): { score: number } | null {
