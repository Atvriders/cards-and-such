...
const TienLenQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TienLenQuizGame as unknown as React.ComponentType<unknown> })));
...
export const tienLenQuizPlugin: GamePlugin<TienLenQuizState, TienLenQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TienLenQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TienLenQuizGame,
};
