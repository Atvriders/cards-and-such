...
import type { KingsQueensPatState, KingsQueensPatAction, KingsQueensPatSettings } from "./state.js";
import { initialState, reducer, isTerminal, ruleset } from "./state.js";
const KingsQueensPatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KingsQueensPatGame as unknown as React.ComponentType<unknown> })));
import { canMove } from "../../engines/tableau/moves.js";
const settings = { _dummy: { kind: "boolean" as const, label: "_", default: false } } as const;
type S = SettingsOf<typeof settings>;
export const kingsQueensPatPlugin: GamePlugin<KingsQueensPatState, KingsQueensPatAction, typeof settings> = {
  id: "kings-queens-pat",
  title: "Kings & Queens Patience",
  category: "solitaire",
