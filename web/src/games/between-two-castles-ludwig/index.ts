...
const BetweenTwoCastlesLudwigGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BetweenTwoCastlesLudwigGame as unknown as React.ComponentType<unknown> })));
