...
const SundialGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SundialGame as unknown as React.ComponentType<unknown> })));
...
export const sundialPlugin: GamePlugin<SundialState, SundialAction, typeof settings> = {
  ...
  hint: (state: SundialState): HintTarget | null => {
    ...
    if (state.held) {
      return { selector: '[data-testid="hint-target-sundial-tick"]', pulses: 3 };
    }
    return null;
  },
  reducer,
