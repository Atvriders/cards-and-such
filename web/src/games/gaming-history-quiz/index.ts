...
const GamingHistoryQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GamingHistoryQuizGame as unknown as React.ComponentType<unknown> })));
...
export const gamingHistoryQuizPlugin: GamePlugin<GamingHistoryQuizState, GamingHistoryQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: GamingHistoryQuizState): HintTarget | null => {
    if (state.phase !== "playing") return null;
    return { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 };
  },
  component:GamingHistoryQuizGame,
};
