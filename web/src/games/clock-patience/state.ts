...
export interface ClockPatienceSettings { dummy: boolean; }

export interface ClockPatienceState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type ClockPatienceAction =
  | { type: "keep" }
...
export function reducer(state: ClockPatienceState, action: ClockPatienceAction): ClockPatienceState {
...
export function isTerminal(state: ClockPatienceState): { score: number } | null {
