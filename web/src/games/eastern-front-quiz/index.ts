...
const EasternFrontQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EasternFrontQuizGame as unknown as React.ComponentType<unknown> })));
...
export const easternFrontQuizPlugin: GamePlugin<EasternFrontQuizState, EasternFrontQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: EasternFrontQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:EasternFrontQuizGame,
};
