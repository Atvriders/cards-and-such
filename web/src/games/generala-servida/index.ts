...
const GeneralaServidaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GeneralaServidaGame as unknown as React.ComponentType<unknown> })));
...
export const generalaServidaPlugin: GamePlugin<GeneralaServidaState, GeneralaServidaAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state): HintTarget | null => (state.phase === "done" ? null : { selector: '[data-testid="hint-target-generala-servida-primary"]', pulses: 3 }), component:GeneralaServidaGame,
};
