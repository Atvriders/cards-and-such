...
const TrivialPursuitEightiesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TrivialPursuitEightiesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const trivialPursuitEightiesQuizPlugin: GamePlugin<TrivialPursuitEightiesQuizState, TrivialPursuitEightiesQuizAction, typeof settings> = {
  ...
  reducer, isTerminal, 
  hint: (state: TrivialPursuitEightiesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component: TrivialPursuitEightiesQuizGame,
};
