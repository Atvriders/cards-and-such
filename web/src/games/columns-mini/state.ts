...
export interface ColumnsMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface ColumnsMiniState {
  rngSeed: number;
  grid: Grid;
...
export function initialState(seed: number, _settings: ColumnsMiniSettings): ColumnsMiniState {
...
export function reducer(state: ColumnsMiniState, action: ColumnsMiniAction): ColumnsMiniState {
...
export function isTerminal(state: ColumnsMiniState): { score: number } | null {
