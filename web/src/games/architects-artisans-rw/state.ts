...
export interface ArchitectsArtisansRwSettings { dummy: boolean; }
export interface ArchitectsArtisansRwState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type ArchitectsArtisansRwAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: ArchitectsArtisansRwSettings): ArchitectsArtisansRwState {
  return {
    rngSeed: seed,
...
export function reducer(state: ArchitectsArtisansRwState, action: ArchitectsArtisansRwAction): ArchitectsArtisansRwState {
...
export function isTerminal(state: ArchitectsArtisansRwState): { score: number } | null {
