...
const SakuraGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SakuraGame as unknown as React.ComponentType<unknown> })));
...
export const sakuraPlugin: GamePlugin<SakuraState, SakuraAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SakuraState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SakuraGame,
};
