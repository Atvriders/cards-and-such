...
export function DoubleWarShedGame({ state, dispatch, onGameOver }: GameProps<DoubleWarShedState, DoubleWarShedSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="dm-wrap"><h3>Double War</h3><div className="dm-done"><h2>Done!</h2><div>W: {state.wins} L: {state.losses}</div><div className="dm-final">{state.score} pts</div></div></div>;
  return (
