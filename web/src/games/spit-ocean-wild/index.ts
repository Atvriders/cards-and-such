...
const SpitOceanWild = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SpitOceanWild as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const spitOceanWildPlugin: GamePlugin<SpitOceanWildState, SpitOceanWildAction, typeof settings> = {
  ...
  description: "Draw poker variant where one community card is wild for everyone.",
