...
import type { PizzaCutState, PizzaCutSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./PizzaCut.css";
export function PizzaCut({ state, dispatch, onGameOver }:GameProps<PizzaCutState,PizzaCutSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-pizza-cut-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
