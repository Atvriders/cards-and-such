...
const Daytona500QuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Daytona500QuizGame as unknown as React.ComponentType<unknown> })));
...
export const daytona500QuizPlugin: GamePlugin<Daytona500QuizState, Daytona500QuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: Daytona500QuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:Daytona500QuizGame,
};
