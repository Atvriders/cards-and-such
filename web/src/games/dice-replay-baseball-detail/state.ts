...
export type DiceReplayBaseballDetailStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceReplayBaseballDetailState, action: DiceReplayBaseballDetailStateAction): DiceReplayBaseballDetailState {
