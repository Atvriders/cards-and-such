...
export function TheEstatesBidGame({ state, dispatch, onGameOver }: GameProps<TheEstatesBidState, TheEstatesBidSettings>): JSX.Element {
  const t = isTerminal(state);
  useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  return (
    <div className="dr-wrap">
      <h3 className="dr-title">The Estates: Bid Draft</h3>
