...
export interface JosephineSettings { dummy: boolean; }

export interface JosephineState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: JosephineSettings): JosephineState {
...
export function reducer(state: JosephineState, action: JosephineAction): JosephineState {
...
export function isTerminal(state: JosephineState): { score: number } | null {
