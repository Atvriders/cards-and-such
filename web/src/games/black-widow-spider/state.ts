...
export interface BlackWidowSpiderSettings { dummy: boolean; }

export interface BlackWidowSpiderState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type BlackWidowSpiderAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: BlackWidowSpiderSettings): BlackWidowSpiderState {
...
export function reducer(state: BlackWidowSpiderState, action: BlackWidowSpiderAction): BlackWidowSpiderState {
...
export function isTerminal(state: BlackWidowSpiderState): { score: number } | null {
