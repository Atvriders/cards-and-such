...
export interface FourteenOutSettings { dummy: boolean; }

export interface FourteenOutState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: FourteenOutSettings): FourteenOutState {
...
export function reducer(state: FourteenOutState, action: FourteenOutAction): FourteenOutState {
...
export function isTerminal(state: FourteenOutState): { score: number } | null {
