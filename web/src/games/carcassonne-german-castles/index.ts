...
const CarcassonneGermanCastlesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CarcassonneGermanCastlesGame as unknown as React.ComponentType<unknown> })));
