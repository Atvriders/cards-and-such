...
const FarmAnimalQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FarmAnimalQuizGame as unknown as React.ComponentType<unknown> })));
...
export const farmAnimalQuizPlugin: GamePlugin<FarmAnimalQuizState, FarmAnimalQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: FarmAnimalQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:FarmAnimalQuizGame,
};
