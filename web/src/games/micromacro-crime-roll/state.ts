...
export interface MicromacroCrimeRollSettings { dummy: boolean; }
export interface MicromacroCrimeRollState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type MicromacroCrimeRollAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: MicromacroCrimeRollSettings): MicromacroCrimeRollState {
  return {
    rngSeed: seed,
...
export function reducer(state: MicromacroCrimeRollState, action: MicromacroCrimeRollAction): MicromacroCrimeRollState {
...
export function isTerminal(state: MicromacroCrimeRollState): { score: number } | null {
