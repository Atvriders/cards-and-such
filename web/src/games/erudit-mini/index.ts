...
const EruditMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EruditMiniGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const eruditMiniPlugin: GamePlugin<EruditMiniState, EruditMiniAction, typeof settings> = {
  ...
  hint: (state: EruditMiniState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-erudit-mini-answer-0"]', pulses: 3 } : null,component: EruditMiniGame,
};
