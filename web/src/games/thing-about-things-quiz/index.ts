...
const ThingAboutThingsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ThingAboutThingsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const thingAboutThingsQuizPlugin: GamePlugin<ThingAboutThingsQuizState, ThingAboutThingsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ThingAboutThingsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ThingAboutThingsQuizGame,
};
