...
export function DiceClutchGame({ state, dispatch, onGameOver }: GameProps<DiceClutchState, DiceClutchSettings>): JSX.Element {
  ...
  return (
    <div className="dm-wrap">
      <div className="dm-info">Round {state.round} / {TOTAL_ROUNDS}{isClutch ? " — CLUTCH! 5x multiplier" : ""}</div>
