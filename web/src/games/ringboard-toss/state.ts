...
export type RingboardTossAction = { type: "throw" } | { type: "next" };

export function initialState(seed: number, _s: RingboardTossSettings): RingboardTossState {
...
export function isTerminal(s: RingboardTossState): { score: number } | null { return s.phase === "done" ? { score: s.score } : null; }
