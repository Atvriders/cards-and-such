...
const CerealBrandsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CerealBrandsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const cerealBrandsQuizPlugin: GamePlugin<CerealBrandsQuizState, CerealBrandsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CerealBrandsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CerealBrandsQuizGame,
};
