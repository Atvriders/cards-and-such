...
import type { DictatorsQuizState, DictatorsQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./DictatorsQuiz.css";
export function DictatorsQuiz({ state, dispatch, onGameOver }: GameProps<DictatorsQuizState, DictatorsQuizSettings>): JSX.Element {
