...
export interface GolfSolitaireSettings { dummy: boolean; }

export interface GolfSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type GolfSolitaireAction =
  | { type: "keep" }
...
export function reducer(state: GolfSolitaireState, action: GolfSolitaireAction): GolfSolitaireState {
...
export function isTerminal(state: GolfSolitaireState): { score: number } | null {
