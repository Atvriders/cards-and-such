...
const SuperiorCanfieldGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SuperiorCanfieldGame as unknown as React.ComponentType<unknown> })));
...
export const superiorCanfieldPlugin: GamePlugin<SuperiorCanfieldState, SuperiorCanfieldAction, typeof settings> = {
  ...
  component: SuperiorCanfieldGame,
};
