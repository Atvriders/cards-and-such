...
export interface FreezeoutTournamentSettings { dummy: boolean; }
export interface FreezeoutTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type FreezeoutTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: FreezeoutTournamentSettings): FreezeoutTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: FreezeoutTournamentState, action: FreezeoutTournamentAction): FreezeoutTournamentState {
...
export function isTerminal(state: FreezeoutTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
