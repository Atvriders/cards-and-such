...
describe("AlliterationPick", () => {
  it("creates >= 8 questions", () => { expect(initialState(1,S).questions.length).toBeGreaterThanOrEqual(8); });
  ...
  it("tick decrements time", () => {
    ...
    expect(s2.timeLeft).toBeLessThanOrEqual(15);
  });
});
