...
const EurovisionQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EurovisionQuizGame as unknown as React.ComponentType<unknown> })));
...
export const eurovisionQuizPlugin: GamePlugin<EurovisionQuizState, EurovisionQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: EurovisionQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:EurovisionQuizGame,
};
