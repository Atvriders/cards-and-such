...
export type KnockoutWhistState = HuTrickState;
export type KnockoutWhistAction = HuTrickAction;
export interface KnockoutWhistSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: KnockoutWhistSettings): KnockoutWhistState => engine.initialState(seed);
