...
const LiteratureGenresQuiz = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LiteratureGenresQuiz as unknown as React.ComponentType<unknown> })));
const settings = {
...
By the end you will be able to identify a bildungsroman, explain what makes something gothic, and distinguish hard-boiled noir from a cozy mystery. Perfect for literature students, avid readers, and anyone who loves books!`,
  ...
  reducer,
  isTerminal,
  hint: (state: LitGenresState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
