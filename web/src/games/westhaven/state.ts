...
export interface WesthavenSettings { dummy: boolean; }

export interface WesthavenState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: WesthavenState, action: WesthavenAction): WesthavenState {
...
export function isTerminal(state: WesthavenState): { score: number } | null {
