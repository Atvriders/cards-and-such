...
const CardQuadQuestGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardQuadQuestGame as unknown as React.ComponentType<unknown> })));
...
export const cardQuadQuestPlugin: GamePlugin<CardQuadQuestState, CardQuadQuestAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-quad-quest-primary"]', pulses: 3 }), component:CardQuadQuestGame,
};
