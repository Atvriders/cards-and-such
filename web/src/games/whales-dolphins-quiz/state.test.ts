...
describe("WhalesDolphinsQuiz", () => {
  it("creates 10 questions", () => { expect(initialState(1,S).questions.length).toBeGreaterThanOrEqual(1); expect(initialState(1,S).questions.length).toBeLessThanOrEqual(10); });
