...
export interface CitadelSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: CitadelSettings): CitadelState {
...
export function reducer(state: CitadelState, action: CitadelAction): CitadelState {
...
export function isTerminal(state: CitadelState): { score: number } | null {
