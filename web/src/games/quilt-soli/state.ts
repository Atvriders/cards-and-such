...
export interface QuiltSoliSettings { dummy: boolean; }

export interface QuiltSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: QuiltSoliSettings): QuiltSoliState {
...
export function reducer(state: QuiltSoliState, action: QuiltSoliAction): QuiltSoliState {
...
export function isTerminal(state: QuiltSoliState): { score: number } | null {
