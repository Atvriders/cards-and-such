...
export interface HoldemSpreadLimitSettings { dummy: boolean; }
export interface HoldemSpreadLimitState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type HoldemSpreadLimitAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: HoldemSpreadLimitSettings): HoldemSpreadLimitState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: HoldemSpreadLimitState, action: HoldemSpreadLimitAction): HoldemSpreadLimitState {
...
export function isTerminal(state: HoldemSpreadLimitState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
