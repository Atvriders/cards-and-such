...
const KittyWhistGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KittyWhistGame as unknown as React.ComponentType<unknown> })));
...
export const kittyWhistPlugin: GamePlugin<KittyWhistState, KittyWhistAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: KittyWhistState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-kitwh-${pick.id}"]`, pulses: 3 };
    }
