...
export type KittyWhistState = HuTrickState;
export type KittyWhistAction = HuTrickAction;
...
export const initialState = (seed: number, _s: KittyWhistSettings): KittyWhistState => engine.initialState(seed);
