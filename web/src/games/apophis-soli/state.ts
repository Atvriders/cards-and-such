...
export interface ApophisSoliSettings { dummy: boolean; }

export interface ApophisSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: ApophisSoliState, action: ApophisSoliAction): ApophisSoliState {
...
export function isTerminal(state: ApophisSoliState): { score: number } | null {
