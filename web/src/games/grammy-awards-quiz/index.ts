...
const GrammyAwardsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GrammyAwardsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const grammyAwardsQuizPlugin: GamePlugin<GrammyAwardsQuizState, GrammyAwardsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: GrammyAwardsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:GrammyAwardsQuizGame,
};
