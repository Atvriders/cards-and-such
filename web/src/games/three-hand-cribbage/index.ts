...
const hint = (state: ThreeHandCribbageState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const threeHandCribbagePlugin: GamePlugin<ThreeHandCribbageState, ThreeHandCribbageAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: ThreeHandCribbageGame,
};
