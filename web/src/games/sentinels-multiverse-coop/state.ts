...
export interface SentinelsMultiverseCoopSettings { dummy: boolean; }
export interface SentinelsMultiverseCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type SentinelsMultiverseCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: SentinelsMultiverseCoopSettings): SentinelsMultiverseCoopState {
