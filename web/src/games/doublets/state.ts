...
export interface DoubletsSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: DoubletsSettings): DoubletsState {
...
export function reducer(state: DoubletsState, action: DoubletsAction): DoubletsState {
...
export function isTerminal(state: DoubletsState): { score: number } | null {
