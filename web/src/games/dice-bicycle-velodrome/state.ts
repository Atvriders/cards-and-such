...
export type DiceBicycleVelodromeStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceBicycleVelodromeState, action: DiceBicycleVelodromeStateAction): DiceBicycleVelodromeState {
