...
import { UltimateTexasCasGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: UltimateTexasCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-ultimate-texas-cas-primary"]', pulses: 3 } : null);
export const ultimateTexasCasPlugin: GamePlugin<UltimateTexasCasState, UltimateTexasCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: UltimateTexasCasGame,
};
