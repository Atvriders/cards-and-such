...
export interface UltimateTexasCasSettings { dummy: boolean; }
export interface UltimateTexasCasState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type UltimateTexasCasAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: UltimateTexasCasSettings): UltimateTexasCasState {
  return { rngSeed: seed, round: 1, cardA: null, cardB: null, cardC: null, phase: "ready", score: 0, pts: 0, result: "" };
}
export function reducer(state: UltimateTexasCasState, action: UltimateTexasCasAction): UltimateTexasCasState {
...
export function isTerminal(state: UltimateTexasCasState): { score: number } | null {
