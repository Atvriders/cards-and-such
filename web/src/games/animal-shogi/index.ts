...
const AnimalShogiGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AnimalShogiGame as unknown as React.ComponentType<unknown> })));
...
export const animalShogiPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".ash-board")) ? { selector: ".ash-board", pulses: 3 } : null,
