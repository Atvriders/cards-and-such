...
import { HeadsUpHoldemCasGame } from "./Game.js";
const settings = { dummy: { kind:"boolean" as const, label:"dummy", default:false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: HeadsUpHoldemCasState): HintTarget | null => (state.phase === "deal" ? { selector: '[data-testid="hint-target-heads-up-holdem-cas-primary"]', pulses: 3 } : null);
export const headsUpHoldemCasPlugin: GamePlugin<HeadsUpHoldemCasState, HeadsUpHoldemCasAction, typeof settings> = {
  ...
  reducer,isTerminal,hint, component: HeadsUpHoldemCasGame,
};
