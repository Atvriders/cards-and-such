...
const EndangeredSpeciesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EndangeredSpeciesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const endangeredSpeciesQuizPlugin: GamePlugin<EndangeredSpeciesQuizState, EndangeredSpeciesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: EndangeredSpeciesQuizState): HintTarget | null => {
    if (state.phase !== "playing") return null;
    return { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 };
  },
  component:EndangeredSpeciesQuizGame,
};
