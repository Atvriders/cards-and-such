...
const HopscotchSolitaireGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HopscotchSolitaireGame as unknown as React.ComponentType<unknown> })));
...
export const hopscotchSolitairePlugin: GamePlugin<HopscotchSolitaireState, HopscotchSolitaireAction, typeof settings> = {
  id: "hopscotch-solitaire",
  title: "Hopscotch Solitaire",
  category: "solitaire",
  ...
  component: HopscotchSolitaireGame,
};
