...
export interface DoubleRailSettings { dummy: boolean; }

export interface DoubleRailState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: DoubleRailSettings): DoubleRailState {
...
export function reducer(state: DoubleRailState, action: DoubleRailAction): DoubleRailState {
...
export function isTerminal(state: DoubleRailState): { score: number } | null {
