...
export function StarforgedSagaGame({ state, dispatch, onGameOver }: GameProps<StarforgedSagaState, StarforgedSagaSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="sfs-wrap"><div className="sfs-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
