...
const KingOfHillChessGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KingOfHillChessGame as unknown as React.ComponentType<unknown> })));
...
export const kingOfHillChessPlugin: GamePlugin<KingOfHillChessState, KingOfHillChessAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: KingOfHillChessState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-king-of-hill-chess-answer-0"]', pulses: 3 } : null, component:KingOfHillChessGame,
};
