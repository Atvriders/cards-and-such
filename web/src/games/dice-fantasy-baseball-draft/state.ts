...
export type DiceFantasyBaseballDraftStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceFantasyBaseballDraftState, action: DiceFantasyBaseballDraftStateAction): DiceFantasyBaseballDraftState {
