...
const DiceFantasyBaseballDraftGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceFantasyBaseballDraftGame as unknown as React.ComponentType<unknown> })));
