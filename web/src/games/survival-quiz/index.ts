...
const SurvivalQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SurvivalQuizGame as unknown as React.ComponentType<unknown> })));
...
export const survivalQuizPlugin: GamePlugin<SurvivalQuizState, SurvivalQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SurvivalQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SurvivalQuizGame,
};
