...
describe("CogClick", () => {
  ...
  it("pop awards score", () => { let s=initialState(1,S); s=reducer(s,{type:"tick"}); const id=s.targets[0]!.id; s=reducer(s,{type:"pop",id}); expect(s.score).toBeGreaterThanOrEqual(8); });
