...
export type HulaHoopAction = { type: "catch"; id: number } | { type: "tick" } | { type: "spawn" };

export function initialState(seed: number, settings: HulaHoopSettings): HulaHoopState {
...
export function reducer(state: HulaHoopState, action: HulaHoopAction): HulaHoopState {
...
export function isTerminal(state: HulaHoopState): { score: number } | null {
