...
const LosingCheckersGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LosingCheckersGame as unknown as React.ComponentType<unknown> })));
...
export const losingCheckersPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".lch-board")) ? { selector: ".lch-board", pulses: 3 } : null,
