...
export type SplendorCitiesState = DraftState;
export type SplendorCitiesAction = DraftAction;
...
export function initialState(seed: number, _settings: SplendorCitiesSettings): SplendorCitiesState {
...
export function score(state: SplendorCitiesState): number {
  return draftFinalScore(state);
}

export function isTerminal(state: SplendorCitiesState): { score: number } | null {
