...
export interface ExiledKingsSettings { dummy: boolean; }

export interface ExiledKingsState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: ExiledKingsSettings): ExiledKingsState {
...
export function reducer(state: ExiledKingsState, action: ExiledKingsAction): ExiledKingsState {
...
export function isTerminal(state: ExiledKingsState): { score: number } | null {
