...
const DuelPantheonGodsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DuelPantheonGodsGame as unknown as React.ComponentType<unknown> })));
