...
const SnookerSkillGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SnookerSkillGame as unknown as React.ComponentType<unknown> })));
...
export const snookerSkillPlugin: GamePlugin<SnookerSkillState, SnookerSkillAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-snooker-skill-action"]', pulses: 3 }; },
