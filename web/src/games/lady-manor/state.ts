...
export interface LadyManorSettings { dummy: boolean; }

export interface LadyManorState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: LadyManorSettings): LadyManorState {
...
export function reducer(state: LadyManorState, action: LadyManorAction): LadyManorState {
...
export function isTerminal(state: LadyManorState): { score: number } | null {
