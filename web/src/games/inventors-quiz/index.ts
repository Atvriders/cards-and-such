...
const InventorsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.InventorsQuizGame as unknown as React.ComponentType<unknown> })));
const settings = { questions: { kind:"enum" as const, label:"Questions", options:["10","20","30"] as const, default:"10" as const } } as const;
type S = SettingsOf<typeof settings>;
export const inventorsQuizPlugin: GamePlugin<InventorsQuizState, InventorsQuizAction, typeof settings> = {
  id:"inventors-quiz", title:"Famous Inventors Quiz", category:"board",
  players:{ min:1, max:1, multiplayer:false },
  description:"The minds and gadgets that changed the world.",
