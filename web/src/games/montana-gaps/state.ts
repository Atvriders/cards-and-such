...
export interface MontanaGapsSettings { dummy: boolean; }

export interface MontanaGapsState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: MontanaGapsState, action: MontanaGapsAction): MontanaGapsState {
...
export function isTerminal(state: MontanaGapsState): { score: number } | null {
