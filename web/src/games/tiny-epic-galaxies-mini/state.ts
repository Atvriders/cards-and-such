...
export interface TinyEpicGalaxiesMiniSettings { dummy: boolean; }
export interface TinyEpicGalaxiesMiniState {
  rngSeed: number;
  round: number;
  rolls: number[];
  bonus: number;
...
export type TinyEpicGalaxiesMiniAction = { type: "roll" } | { type: "next" };
export function initialState(seed: number, _s: TinyEpicGalaxiesMiniSettings): TinyEpicGalaxiesMiniState {
...
export function reducer(state: TinyEpicGalaxiesMiniState, action: TinyEpicGalaxiesMiniAction): TinyEpicGalaxiesMiniState {
...
export function isTerminal(state: TinyEpicGalaxiesMiniState): { score: number } | null {
