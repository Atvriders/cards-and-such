...
const RollingStonesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RollingStonesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const rollingStonesQuizPlugin: GamePlugin<RollingStonesQuizState, RollingStonesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: RollingStonesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:RollingStonesQuizGame,
};
