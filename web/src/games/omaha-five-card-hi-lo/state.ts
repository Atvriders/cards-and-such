...
export interface OmahaFiveCardHiLoSettings { dummy: boolean; }
export interface OmahaFiveCardHiLoState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type OmahaFiveCardHiLoAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: OmahaFiveCardHiLoSettings): OmahaFiveCardHiLoState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: OmahaFiveCardHiLoState, action: OmahaFiveCardHiLoAction): OmahaFiveCardHiLoState {
...
export function isTerminal(state: OmahaFiveCardHiLoState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
