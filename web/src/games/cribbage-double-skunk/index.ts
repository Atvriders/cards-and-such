...
export const cribbageDoubleSkunkPlugin: GamePlugin<CribbageDoubleSkunkState, CribbageDoubleSkunkAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-cribbage-double-skunk-action"]', pulses: 3 }; },
