...
const PylosPyramidGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PylosPyramidGame as unknown as React.ComponentType<unknown> })));
...
export const pylosPyramidPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".pyl-board")) ? { selector: ".pyl-board", pulses: 3 } : null,
