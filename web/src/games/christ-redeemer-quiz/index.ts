...
const ChristRedeemerQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ChristRedeemerQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. Embrace the wonder!`,
  ...
  reducer,isTerminal,
  hint: (state: ChristRedeemerQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ChristRedeemerQuizGame,
};
