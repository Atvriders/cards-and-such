...
const ComposersModernQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ComposersModernQuizGame as unknown as React.ComponentType<unknown> })));
...
export const composersModernQuizPlugin: GamePlugin<ComposersModernQuizState, ComposersModernQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ComposersModernQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ComposersModernQuizGame,
};
