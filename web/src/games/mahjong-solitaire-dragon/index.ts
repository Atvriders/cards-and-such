...
const MahjongSolitaireDragon = /* @__PURE__ */ lazy(() => import("./MahjongSolitaireDragon.js").then((mod) => ({ default: mod.MahjongSolitaireDragon as unknown as React.ComponentType<unknown> })));
