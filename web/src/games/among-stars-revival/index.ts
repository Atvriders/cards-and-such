...
const AmongStarsRevivalGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AmongStarsRevivalGame as unknown as React.ComponentType<unknown> })));
