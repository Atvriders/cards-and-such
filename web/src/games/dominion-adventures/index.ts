...
export const dominion_adventures_plugin: GamePlugin<DominionAdventuresState, DominionAdventuresAction, typeof settings> = {
...
export default dominion_adventures_plugin;
