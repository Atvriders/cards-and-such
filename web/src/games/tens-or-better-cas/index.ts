...
import { TensOrBetterCasGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: TensOrBetterCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-tens-or-better-cas-primary"]', pulses: 3 } : null);
export const tensOrBetterCasPlugin: GamePlugin<TensOrBetterCasState, TensOrBetterCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: TensOrBetterCasGame,
};
