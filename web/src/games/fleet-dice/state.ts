...
export interface FleetDiceSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: FleetDiceSettings): FleetDiceState {
  return {
    rngSeed: seed >>> 0,
