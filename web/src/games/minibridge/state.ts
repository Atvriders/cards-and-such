...
export type MiniBridgeState = HuTrickState;
export type MiniBridgeAction = HuTrickAction;
...
export const initialState = (seed: number, _s: MiniBridgeSettings): MiniBridgeState => engine.initialState(seed);
