...
const MiniBridgeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MiniBridgeGame as unknown as React.ComponentType<unknown> })));
...
export const minibridgePlugin: GamePlugin<MiniBridgeState, MiniBridgeAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: MiniBridgeState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-minib-${pick.id}"]`, pulses: 3 };
    }
