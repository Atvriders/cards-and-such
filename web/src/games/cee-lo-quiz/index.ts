...
const CeeLoQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CeeLoQuizGame as unknown as React.ComponentType<unknown> })));
...
export const ceeLoQuizPlugin: GamePlugin<CeeLoQuizState, CeeLoQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CeeLoQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CeeLoQuizGame,
};
