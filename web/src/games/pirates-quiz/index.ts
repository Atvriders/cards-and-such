...
const PiratesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PiratesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const piratesQuizPlugin: GamePlugin<PiratesQuizState, PiratesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: PiratesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:PiratesQuizGame,
};
