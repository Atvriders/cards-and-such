  ...
  return (
    <div className="arc-wrap">
      ...
      {state.phase==="aiming" && <>
        ...
        <button data-testid="hint-target-jelly-jar-toss-action" title="Throw the jelly jar" className="arc-btn" onClick={()=>dispatch({type:"throw"} as JellyJarTossAction)}>Go!</button>
      </>}
