...
const KyotoShogiGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KyotoShogiGame as unknown as React.ComponentType<unknown> })));
...
export const kyotoShogiPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".kts-board")) ? { selector: ".kts-board", pulses: 3 } : null,
