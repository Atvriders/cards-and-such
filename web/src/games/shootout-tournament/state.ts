...
export interface ShootoutTournamentSettings { dummy: boolean; }
export interface ShootoutTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type ShootoutTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: ShootoutTournamentSettings): ShootoutTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: ShootoutTournamentState, action: ShootoutTournamentAction): ShootoutTournamentState {
...
export function isTerminal(state: ShootoutTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
