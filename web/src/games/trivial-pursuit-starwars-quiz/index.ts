...
const TrivialPursuitStarwarsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TrivialPursuitStarwarsQuizGame as unknown as React.ComponentType<unknown> })));
