...
const ProbabilityQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ProbabilityQuizGame as unknown as React.ComponentType<unknown> })));
...
export const probabilityQuizPlugin: GamePlugin<ProbabilityQuizState, ProbabilityQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ProbabilityQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ProbabilityQuizGame,
};
