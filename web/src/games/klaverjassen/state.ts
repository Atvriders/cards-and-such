...
export type KlaverjassenState = HuTrickState;
export type KlaverjassenAction = HuTrickAction;
...
export const initialState = (seed: number, _s: KlaverjassenSettings): KlaverjassenState => engine.initialState(seed);
