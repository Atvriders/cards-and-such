...
const KniffelGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KniffelGame as unknown as React.ComponentType<unknown> })));
...
export const kniffelPlugin: GamePlugin<KniffelState, KniffelAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state): HintTarget | null => (state.phase === "done" ? null : { selector: '[data-testid="hint-target-kniffel-primary"]', pulses: 3 }), component:KniffelGame,
};
