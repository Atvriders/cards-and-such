...
export interface PandemicBaseSettings { dummy: boolean; }
export interface PandemicBaseState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type PandemicBaseAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: PandemicBaseSettings): PandemicBaseState {
