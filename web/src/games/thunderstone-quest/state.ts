...
export interface ThunderstoneQuestSettings { dummy: boolean; }
export interface ThunderstoneQuestState {
  rngSeed: number;
  round: number;
  hand: number[];
  lastPts: number;
...
export type ThunderstoneQuestAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: ThunderstoneQuestSettings): ThunderstoneQuestState {
