...
export interface KnockRummyRSettings { dummy: boolean; }
export interface KnockRummyRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type KnockRummyRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: KnockRummyRSettings): KnockRummyRState {
...
export function reducer(state: KnockRummyRState, action: KnockRummyRAction): KnockRummyRState {
...
export function isTerminal(state: KnockRummyRState): { score: number } | null {
