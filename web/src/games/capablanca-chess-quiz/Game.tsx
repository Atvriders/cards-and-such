    ...
    <div className="capchq-wrap">
      ...
      <div className="capchq-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as CapablancaChessQuizAction)}><span className="capchq-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
