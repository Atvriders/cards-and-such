...
export function DiceQuadBetGame({ state, dispatch, onGameOver }: GameProps<DiceQuadBetState, DiceQuadBetSettings>): JSX.Element {
    ...
    <div className="dm-wrap">
      ...
      {state.phase === "betting" ? (
        ...
        <>
          ...
          <button className="dm-btn" onClick={() => dispatch({ type:"next" } as DiceQuadBetAction)}>Next</button>
        </>
      )}
    </div>
  );
