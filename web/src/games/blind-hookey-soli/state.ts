...
export interface BlindHookeySoliSettings { dummy: boolean; }

export interface BlindHookeySoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type BlindHookeySoliAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: BlindHookeySoliSettings): BlindHookeySoliState {
...
export function reducer(state: BlindHookeySoliState, action: BlindHookeySoliAction): BlindHookeySoliState {
...
export function isTerminal(state: BlindHookeySoliState): { score: number } | null {
