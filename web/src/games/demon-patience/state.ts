...
export interface DemonPatienceSettings { dummy: boolean; }

export interface DemonPatienceState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type DemonPatienceAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: DemonPatienceSettings): DemonPatienceState {
...
export function reducer(state: DemonPatienceState, action: DemonPatienceAction): DemonPatienceState {
...
export function isTerminal(state: DemonPatienceState): { score: number } | null {
