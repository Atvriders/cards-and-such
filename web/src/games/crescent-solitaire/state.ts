...
export interface CrescentSolitaireSettings { dummy: boolean; }

export interface CrescentSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type CrescentSolitaireAction =
  | { type: "keep" }
...
export function reducer(state: CrescentSolitaireState, action: CrescentSolitaireAction): CrescentSolitaireState {
...
export function isTerminal(state: CrescentSolitaireState): { score: number } | null {
