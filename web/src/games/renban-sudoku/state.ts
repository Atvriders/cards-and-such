...
export interface RenbanSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: RenbanSudokuSettings;
}

export type RenbanSudokuAction =
...
export function initialState(seed: number, settings: RenbanSudokuSettings): RenbanSudokuState {
