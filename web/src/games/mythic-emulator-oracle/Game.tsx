...
export function MythicEmulatorOracleGame({ state, dispatch, onGameOver }: GameProps<MythicEmulatorOracleState, MythicEmulatorOracleSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="meo-wrap"><div className="meo-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#fde047" }}>{state.score} pts</p></div></div>;
