...
export type WhistState = HuTrickState;
export type WhistAction = HuTrickAction;
export interface WhistSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: WhistSettings): WhistState => engine.initialState(seed);
