...
const ZingoBingoQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ZingoBingoQuizGame as unknown as React.ComponentType<unknown> })));
...
export const zingoBingoQuizPlugin: GamePlugin<ZingoBingoQuizState, ZingoBingoQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ZingoBingoQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ZingoBingoQuizGame,
};
