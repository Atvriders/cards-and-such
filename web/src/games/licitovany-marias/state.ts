...
export type LicitovanyMariasState = HuTrickState;
export type LicitovanyMariasAction = HuTrickAction;
export interface LicitovanyMariasSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: LicitovanyMariasSettings): LicitovanyMariasState => engine.initialState(seed);
