...
const KurosawaQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KurosawaQuizGame as unknown as React.ComponentType<unknown> })));
...
export const kurosawaQuizPlugin: GamePlugin<KurosawaQuizState, KurosawaQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: KurosawaQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:KurosawaQuizGame,
};
