...
export interface WariosWoodsMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface WariosWoodsMiniState {
  rngSeed: number;
  grid: Grid;
...
export type WariosWoodsMiniAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: WariosWoodsMiniSettings): WariosWoodsMiniState {
...
export function reducer(state: WariosWoodsMiniState, action: WariosWoodsMiniAction): WariosWoodsMiniState {
...
export function isTerminal(state: WariosWoodsMiniState): { score: number } | null {
