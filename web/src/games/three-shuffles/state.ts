...
export interface ThreeShufflesSettings { dummy: boolean; }

export interface ThreeShufflesState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type ThreeShufflesAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: ThreeShufflesSettings): ThreeShufflesState {
...
export function reducer(state: ThreeShufflesState, action: ThreeShufflesAction): ThreeShufflesState {
...
export function isTerminal(state: ThreeShufflesState): { score: number } | null {
