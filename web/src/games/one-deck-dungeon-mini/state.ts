...
export interface OneDeckDungeonMiniSettings { dummy: boolean; }
export interface OneDeckDungeonMiniState {
  rngSeed: number;
  round: number;
  you: number[];
  foe: number[];
...
export type OneDeckDungeonMiniAction = { type: "roll" } | { type: "next" };
export function initialState(seed: number, _s: OneDeckDungeonMiniSettings): OneDeckDungeonMiniState {
...
export function reducer(state: OneDeckDungeonMiniState, action: OneDeckDungeonMiniAction): OneDeckDungeonMiniState {
...
export function isTerminal(state: OneDeckDungeonMiniState): { score: number } | null {
