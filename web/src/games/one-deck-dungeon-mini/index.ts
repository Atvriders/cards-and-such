...
const OneDeckDungeonMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OneDeckDungeonMiniGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind:"boolean" as const, label:"dummy", default:false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: OneDeckDungeonMiniState): HintTarget | null => (state.phase === "rolling" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const oneDeckDungeonMiniPlugin: GamePlugin<OneDeckDungeonMiniState, OneDeckDungeonMiniAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: hint, component:OneDeckDungeonMiniGame,
};
