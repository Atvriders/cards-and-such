...
const KabaddiCardGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KabaddiCardGame as unknown as React.ComponentType<unknown> })));
...
export const kabaddiCardPlugin: GamePlugin<KabaddiCardState, KabaddiCardAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: KabaddiCardState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:KabaddiCardGame,
};
