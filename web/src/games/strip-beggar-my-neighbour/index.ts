...
const StripBeggarMyNeighbourGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.StripBeggarMyNeighbourGame as unknown as React.ComponentType<unknown> })));
