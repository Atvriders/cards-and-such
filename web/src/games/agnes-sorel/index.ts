...
const AgnesSorelGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AgnesSorelGame as unknown as React.ComponentType<unknown> })));
