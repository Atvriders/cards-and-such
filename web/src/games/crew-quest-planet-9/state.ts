...
export interface CrewQuestPlanet9Settings { dummy: boolean; }
export interface CrewQuestPlanet9State {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type CrewQuestPlanet9Action = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: CrewQuestPlanet9Settings): CrewQuestPlanet9State {
