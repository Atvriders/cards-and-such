...
const DrawfulQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DrawfulQuizGame as unknown as React.ComponentType<unknown> })));
...
export const drawfulQuizPlugin: GamePlugin<DrawfulQuizState, DrawfulQuizAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: DrawfulQuizState): HintTarget | null => state.phase === "ask" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component: DrawfulQuizGame,
};

export default drawfulQuizPlugin;
