...
export const PUZZLES: Puzzle[] = [
  { prompt: "KHOOR (shift -3) =", choices: ["HELLO", "WORLD", "MAGIC", "BREAD"], correctIndex: 0 },
  { prompt: "ZRUOG (shift -3) =", choices: ["HELLO", "WORLD", "MAGIC", "BREAD"], correctIndex: 1 },
  { prompt: "FDW (shift -3) =", choices: ["DOG", "CAT", "RAT", "BAT"], correctIndex: 1 },
  { prompt: "GRJ (shift -3) =", choices: ["DOG", "CAT", "RAT", "BAT"], correctIndex: 0 },
  { prompt: "VXQ (shift -3) =", choices: ["SUN", "MOON", "STAR", "SKY"], correctIndex: 0 },
  { prompt: "PRRQ (shift -3) =", choices: ["MOON", "STAR", "SUN", "SKY"], correctIndex: 0 },
  { prompt: "ELUG (shift -3) =", choices: ["BIRD", "FISH", "BEAR", "WOLF"], correctIndex: 0 },
  { prompt: "ILVK (shift -3) =", choices: ["FISH", "BIRD", "WOLF", "BEAR"], correctIndex: 0 },
  { prompt: "EHDU (shift -3) =", choices: ["BEAR", "WOLF", "FISH", "BIRD"], correctIndex: 0 },
  { prompt: "ZROI (shift -3) =", choices: ["WOLF", "BEAR", "BIRD", "FISH"], correctIndex: 0 },
];
