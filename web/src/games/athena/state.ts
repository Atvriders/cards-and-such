...
export interface AthenaSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: AthenaSettings): AthenaState {
...
export function reducer(state: AthenaState, action: AthenaAction): AthenaState {
...
export function isTerminal(state: AthenaState): { score: number } | null {
