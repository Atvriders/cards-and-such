...
const AthenaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AthenaGame as unknown as React.ComponentType<unknown> })));
...
export const athenaPlugin: GamePlugin<AthenaState, AthenaAction, typeof settings> = {
  ...
  reducer,isTerminal,component:AthenaGame,
