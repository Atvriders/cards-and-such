...
const SomersetGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SomersetGame as unknown as React.ComponentType<unknown> })));
...
export const somersetSolPlugin: GamePlugin<SomersetState, SomersetAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as SomersetSettings),
  reducer,
  isTerminal,
  hint: (state: SomersetState): HintTarget | null => {
