    ...
    <div className="antonymquiz-wrap">
      ...
      <div className="antonymquiz-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type: "select", choice: i } as AntonymQuizAction)}><span className="antonymquiz-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
