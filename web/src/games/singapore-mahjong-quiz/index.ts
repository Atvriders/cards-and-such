...
const SingaporeMahjongGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SingaporeMahjongGame as unknown as React.ComponentType<unknown> })));
...
export const singaporeMahjongPlugin: GamePlugin<SingaporeMahjongState, SingaporeMahjongAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SingaporeMahjongState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SingaporeMahjongGame,
};
