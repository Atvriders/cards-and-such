...
const ElvisQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ElvisQuizGame as unknown as React.ComponentType<unknown> })));
...
export const elvisQuizPlugin: GamePlugin<ElvisQuizState, ElvisQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ElvisQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ElvisQuizGame,
};
