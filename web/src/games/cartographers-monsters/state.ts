...
export interface CartographersMonstersSettings { dummy: boolean; }
export interface CartographersMonstersState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type CartographersMonstersAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: CartographersMonstersSettings): CartographersMonstersState {
  return {
    rngSeed: seed,
...
export function reducer(state: CartographersMonstersState, action: CartographersMonstersAction): CartographersMonstersState {
...
export function isTerminal(state: CartographersMonstersState): { score: number } | null {
