...
export interface DeucesSettings { dummy: boolean; }

export interface DeucesState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: DeucesSettings): DeucesState {
...
export function reducer(state: DeucesState, action: DeucesAction): DeucesState {
...
export function isTerminal(state: DeucesState): { score: number } | null {
