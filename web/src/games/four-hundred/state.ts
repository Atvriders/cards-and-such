...
export type FourHundredState = HuTrickState;
export type FourHundredAction = HuTrickAction;
export interface FourHundredSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: FourHundredSettings): FourHundredState => engine.initialState(seed);
