...
export function WretchedLogGame({ state, dispatch, onGameOver }: GameProps<WretchedLogState, WretchedLogSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="wrl-wrap"><div className="wrl-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
