...
const ChessHistoryQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ChessHistoryQuizGame as unknown as React.ComponentType<unknown> })));
...
export const chessHistoryQuizPlugin: GamePlugin<ChessHistoryQuizState, ChessHistoryQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ChessHistoryQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ChessHistoryQuizGame,
};
