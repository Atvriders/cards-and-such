...
export interface ForbiddenJungleCoopSettings { dummy: boolean; }
export interface ForbiddenJungleCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type ForbiddenJungleCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: ForbiddenJungleCoopSettings): ForbiddenJungleCoopState {
