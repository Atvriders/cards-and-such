...
const Nineteen70sQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Nineteen70sQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 15 questions in Settings. Test your memory of the era, learn something along the way, and aim for a high score!`,
  ...
  reducer,isTerminal,
  hint: (state: Nineteen70sQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:Nineteen70sQuizGame,
};
