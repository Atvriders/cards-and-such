...
export interface LaBelleLucieFanSettings { dummy: boolean; }

export interface LaBelleLucieFanState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type LaBelleLucieFanAction =
  | { type: "keep" }
...
export function reducer(state: LaBelleLucieFanState, action: LaBelleLucieFanAction): LaBelleLucieFanState {
...
export function isTerminal(state: LaBelleLucieFanState): { score: number } | null {
