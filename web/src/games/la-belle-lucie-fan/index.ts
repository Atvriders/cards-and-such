...
const LaBelleLucieFanGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LaBelleLucieFanGame as unknown as React.ComponentType<unknown> })));
...
export const laBelleLucieFanPlugin: GamePlugin<LaBelleLucieFanState, LaBelleLucieFanAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as LaBelleLucieFanSettings),
  reducer,
  isTerminal,
  hint: (state: LaBelleLucieFanState): HintTarget | null => {
