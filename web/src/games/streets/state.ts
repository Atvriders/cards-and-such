...
export interface StreetsSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: StreetsSettings): StreetsState {
...
export function reducer(state: StreetsState, action: StreetsAction): StreetsState {
...
export function isTerminal(state: StreetsState): { score: number } | null {
