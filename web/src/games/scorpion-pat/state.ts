...
export interface ScorpionPatSettings { dummy: boolean; }

export interface ScorpionPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: ScorpionPatSettings): ScorpionPatState {
...
export function reducer(state: ScorpionPatState, action: ScorpionPatAction): ScorpionPatState {
...
export function isTerminal(state: ScorpionPatState): { score: number } | null {
