...
const BrazilCultureQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BrazilCultureQuizGame as unknown as React.ComponentType<unknown> })));
...
export const brazilCultureQuizPlugin: GamePlugin<BrazilCultureQuizState, BrazilCultureQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BrazilCultureQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BrazilCultureQuizGame,
};
