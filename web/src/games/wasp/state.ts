...
export interface WaspSettings { dummy: boolean; }
...
export function reducer(state: WaspState, action: WaspAction): WaspState {
...
export function isTerminal(state: WaspState): { score: number } | null {
