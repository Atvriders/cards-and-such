...
const BantumiGameGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BantumiGameGame as unknown as React.ComponentType<unknown> })));
...
export const bantumiGamePlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".btm-board")) ? { selector: ".btm-board", pulses: 3 } : null,
