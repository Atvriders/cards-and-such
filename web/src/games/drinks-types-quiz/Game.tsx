...
import type { DrinksTypesQuizState, DrinksTypesQuizAction, DrinksTypesQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./Game.css";

export function DrinksTypesQuiz({
  state,
  dispatch,
  onGameOver,
}: GameProps<DrinksTypesQuizState, DrinksTypesQuizSettings>): JSX.Element {
    ...
    <div className="qz-wrap">
      ...
      {!state.done && entry ? (
        <>
            ...
            {entry.choices.map((choice, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => dispatch({ type: "select", index: i } as DrinksTypesQuizAction)}
                >
                  {choice}
                </button>
              );
          ...
          {state.selected !== null && (
            <button className="qz-next" onClick={() => dispatch({ type: "next" } as DrinksTypesQuizAction)}>
