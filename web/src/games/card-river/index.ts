...
const CardRiverGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardRiverGame as unknown as React.ComponentType<unknown> })));
...
export const cardRiverPlugin: GamePlugin<CardRiverState, CardRiverAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-river-primary"]', pulses: 3 }), component:CardRiverGame,
};
