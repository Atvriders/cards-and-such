...
import { initialState, reducer, isTerminal, scoreCardFlowerShop, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardFlowerShop", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardFlowerShop([])).toBeGreaterThanOrEqual(0); });
