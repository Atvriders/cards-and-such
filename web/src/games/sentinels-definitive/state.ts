...
export interface SentinelsDefinitiveSettings { dummy: boolean; }
export interface SentinelsDefinitiveState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type SentinelsDefinitiveAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: SentinelsDefinitiveSettings): SentinelsDefinitiveState {
