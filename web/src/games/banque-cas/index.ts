...
const hint = (state: BanqueCasState): HintTarget | null => (state.phase === "bet" ? { selector: '[data-testid="hint-target-banque-cas-primary"]', pulses: 3 } : null);
export const banqueCasPlugin: GamePlugin<BanqueCasState, BanqueCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: BanqueCasGame,
};
