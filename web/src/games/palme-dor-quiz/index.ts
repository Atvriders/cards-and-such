...
const PalmeDorQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PalmeDorQuizGame as unknown as React.ComponentType<unknown> })));
...
export const palmeDorQuizPlugin: GamePlugin<PalmeDorQuizState, PalmeDorQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: PalmeDorQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:PalmeDorQuizGame,
};
