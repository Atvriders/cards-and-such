...
const loldleLolGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.loldleLolGame as unknown as React.ComponentType<unknown> })));
...
export const loldleLolPlugin: GamePlugin<loldleLolState, loldleLolAction, typeof settings> = {
  ...
  hint: (state: loldleLolState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-loldle-lol-answer-0"]', pulses: 3 } : null,component: loldleLolGame,
};
