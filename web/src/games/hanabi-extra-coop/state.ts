...
export interface HanabiExtraCoopSettings { dummy: boolean; }
export interface HanabiExtraCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type HanabiExtraCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: HanabiExtraCoopSettings): HanabiExtraCoopState {
