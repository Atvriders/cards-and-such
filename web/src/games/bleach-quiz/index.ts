...
const BleachQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BleachQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions. From Soul Reaper basics to the Soul King's secrets, see if your reiatsu can rival a Captain's.`,
  ...
  reducer,isTerminal,
  hint: (state: BleachQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BleachQuizGame,
};
