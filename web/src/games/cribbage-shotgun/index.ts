...
const CribbageShotgunGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CribbageShotgunGame as unknown as React.ComponentType<unknown> })));
...
export const cribbageShotgunPlugin: GamePlugin<CribbageShotgunState, CribbageShotgunAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-cribbage-shotgun-action"]', pulses: 3 }; },
