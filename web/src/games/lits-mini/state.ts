...
export interface LitsMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: LitsMiniSettings;
}

export type LitsMiniAction =
...
export function initialState(seed: number, settings: LitsMiniSettings): LitsMiniState {
