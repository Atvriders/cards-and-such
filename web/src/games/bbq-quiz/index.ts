...
const BBQQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BBQQuizGame as unknown as React.ComponentType<unknown> })));
...
export const bbqQuizPlugin: GamePlugin<BBQQuizState, BBQQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BBQQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BBQQuizGame,
};
