...
export type DiceRussianPyramidStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceRussianPyramidState, action: DiceRussianPyramidStateAction): DiceRussianPyramidState {
