...
const BotanyQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BotanyQuizGame as unknown as React.ComponentType<unknown> })));
...
export const botanyQuizPlugin: GamePlugin<BotanyQuizState, BotanyQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BotanyQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BotanyQuizGame,
};
