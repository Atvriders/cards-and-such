...
const ItalianDraughtsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ItalianDraughtsGame as unknown as React.ComponentType<unknown> })));
...
export const italianDraughtsPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".idg-board")) ? { selector: ".idg-board", pulses: 3 } : null,
