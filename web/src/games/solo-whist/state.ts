...
export type SoloWhistState = HuTrickState;
export type SoloWhistAction = HuTrickAction;
export interface SoloWhistSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: SoloWhistSettings): SoloWhistState => engine.initialState(seed);
