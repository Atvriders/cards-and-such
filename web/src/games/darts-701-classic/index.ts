...
const Darts701ClassicGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Darts701ClassicGame as unknown as React.ComponentType<unknown> })));
...
export const darts701ClassicPlugin: GamePlugin<Darts701ClassicState, Darts701ClassicAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-darts-701-classic-action"]', pulses: 3 }; },
