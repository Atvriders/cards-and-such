...
export interface AeonsEndWarEternalSettings { dummy: boolean; }
export interface AeonsEndWarEternalState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type AeonsEndWarEternalAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: AeonsEndWarEternalSettings): AeonsEndWarEternalState {
