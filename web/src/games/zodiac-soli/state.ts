...
export interface ZodiacSoliSettings { dummy: boolean; }

export interface ZodiacSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: ZodiacSoliSettings): ZodiacSoliState {
...
export function reducer(state: ZodiacSoliState, action: ZodiacSoliAction): ZodiacSoliState {
...
export function isTerminal(state: ZodiacSoliState): { score: number } | null {
