...
const ZodiacSoliGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ZodiacSoliGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const zodiacSoliPlugin: GamePlugin<ZodiacSoliState, ZodiacSoliAction, typeof settings> = {
  id: "zodiac-soli",
  title: "Zodiac Solitaire",
  category: "solitaire",
  players: { min: 1, max: 1, multiplayer: false },
  description: "Solitaire micro-variant — Two-deck twelve-pile patience aligned to the zodiac wheel.",
