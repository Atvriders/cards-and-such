...
export interface ImperialSettlersRwSettings { rounds: "10"; }

export interface ImperialSettlersRwState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type ImperialSettlersRwAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: ImperialSettlersRwSettings): ImperialSettlersRwState {
  return { rngSeed: seed >>> 0, score: 0, round: 1, maxRounds: 10, hand: [], lastGain: 0, phase: "ready" };
}

export function reducer(state: ImperialSettlersRwState, action: ImperialSettlersRwAction): ImperialSettlersRwState {
...
export function isTerminal(state: ImperialSettlersRwState): { score: number } | null {
