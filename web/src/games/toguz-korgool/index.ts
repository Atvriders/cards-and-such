...
const ToguzKorgoolGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ToguzKorgoolGame as unknown as React.ComponentType<unknown> })));
...
export const toguzKorgoolPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".tkg-board")) ? { selector: ".tkg-board", pulses: 3 } : null,
