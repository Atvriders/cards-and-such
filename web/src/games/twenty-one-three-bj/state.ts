...
export interface TwentyOneThreeBjSettings { dummy: boolean; }
export interface TwentyOneThreeBjState { rngSeed: number; round: number; you: number[]; dealer: number[]; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; yourTotal: number; dealerTotal: number; }
export type TwentyOneThreeBjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: TwentyOneThreeBjSettings): TwentyOneThreeBjState {
...
export function reducer(state: TwentyOneThreeBjState, action: TwentyOneThreeBjAction): TwentyOneThreeBjState {
...
export function isTerminal(state: TwentyOneThreeBjState): { score: number } | null {
