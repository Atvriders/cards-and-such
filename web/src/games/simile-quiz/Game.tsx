    ...
    <div className="similequiz-wrap">
      ...
      <div className="similequiz-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type: "select", choice: i } as SimileQuizAction)}><span className="similequiz-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
