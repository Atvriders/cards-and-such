...
export interface MysticValeCraftCard {
  id: string;
  name: string;
  cost: number;
  coin: number;
...
export const SHOP: readonly MysticValeCraftCard[] = [
  { id: "starter1", name: "Sapling", cost: 0, coin: 1, vp: 0, kind: "starter" },
  { id: "treasure1", name: "Sprout", cost: 3, coin: 2, vp: 0, kind: "treasure" },
  { id: "treasure2", name: "Bloom", cost: 6, coin: 3, vp: 0, kind: "treasure" },
  { id: "victory1", name: "Glade", cost: 2, coin: 0, vp: 1, kind: "victory" },
  { id: "victory2", name: "Grove", cost: 5, coin: 0, vp: 3, kind: "victory" },
  { id: "victory3", name: "Sanctuary", cost: 8, coin: 0, vp: 6, kind: "victory" },
];
...
export type MysticValeCraftAction =
  | { type: "playAll" }
...
export function cardById(id: string): MysticValeCraftCard {
...
export function totalScore(state: MysticValeCraftState): number {
  if (state.phase === "done") {
