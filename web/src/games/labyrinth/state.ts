...
export interface LabyrinthSolSettings { dummy: boolean; }

export interface LabyrinthSolState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type LabyrinthSolAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: LabyrinthSolSettings): LabyrinthSolState {
...
export function reducer(state: LabyrinthSolState, action: LabyrinthSolAction): LabyrinthSolState {
...
export function isTerminal(state: LabyrinthSolState): { score: number } | null {
