...
export function WretchedForestGame({ state, dispatch, onGameOver }: GameProps<WretchedForestState, WretchedForestSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="wrf-wrap"><div className="wrf-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
