...
export interface PerfectPairsBjSettings { dummy: boolean; }
export interface PerfectPairsBjState { rngSeed: number; round: number; hand: number[]; total: number; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; }
export type PerfectPairsBjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: PerfectPairsBjSettings): PerfectPairsBjState {
...
export function reducer(state: PerfectPairsBjState, action: PerfectPairsBjAction): PerfectPairsBjState {
...
export function isTerminal(state: PerfectPairsBjState): { score: number } | null {
