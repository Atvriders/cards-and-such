...
export interface BlockadeSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: BlockadeSettings): BlockadeState {
...
export function reducer(state: BlockadeState, action: BlockadeAction): BlockadeState {
...
export function isTerminal(state: BlockadeState): { score: number } | null {
