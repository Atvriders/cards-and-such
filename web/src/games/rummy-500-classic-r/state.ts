...
export interface Rummy500ClassicRSettings { dummy: boolean; }
export interface Rummy500ClassicRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type Rummy500ClassicRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: Rummy500ClassicRSettings): Rummy500ClassicRState {
...
export function reducer(state: Rummy500ClassicRState, action: Rummy500ClassicRAction): Rummy500ClassicRState {
...
export function isTerminal(state: Rummy500ClassicRState): { score: number } | null {
