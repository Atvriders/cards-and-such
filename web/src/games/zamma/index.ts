...
const ZammaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ZammaGame as unknown as React.ComponentType<unknown> })));
...
export const zammaPlugin: GamePlugin<ZammaState, ZammaAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: ZammaState): HintTarget | null => state.phase === "playing" ? { selector: '.zm-board', pulses: 3 } : null, component:ZammaGame,
};
