...
const hint = (state: PokerPatienceState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const pokerPatiencePlugin: GamePlugin<PokerPatienceState, PokerPatienceAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: PokerPatienceGame,
};
