...
export function WretchedMagusGame({ state, dispatch, onGameOver }: GameProps<WretchedMagusState, WretchedMagusSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="wrm-wrap"><div className="wrm-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
