...
export interface quacksAlchemistsSettings { dummy: boolean; }
export interface quacksAlchemistsState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type quacksAlchemistsAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: quacksAlchemistsSettings): quacksAlchemistsState {
  return {
    rngSeed: seed,
...
export function reducer(state: quacksAlchemistsState, action: quacksAlchemistsAction): quacksAlchemistsState {
...
export function isTerminal(state: quacksAlchemistsState): { score: number } | null {
