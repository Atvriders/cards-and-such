...
export interface DutchWhispersSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: DutchWhispersSudokuSettings;
}

export type DutchWhispersSudokuAction =
...
export function initialState(seed: number, settings: DutchWhispersSudokuSettings): DutchWhispersSudokuState {
