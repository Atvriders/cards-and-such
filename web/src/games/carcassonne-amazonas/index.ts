...
export const carcassonneAmazonasPlugin: GamePlugin<CarcassonneAmazonasState, CarcassonneAmazonasAction, typeof settings> = {
  ...
  description: "Jungle rivers; canoe exploration and animal encounter scoring.",
  howToPlay: `Carcassonne: Amazonas is a single-player tile-placement puzzle. Jungle rivers; canoe exploration and animal encounter scoring. Tiles draw from a randomized queue, and your job is to place each one onto a small grid in a way that maximises end-of-game scoring.

How it works: Rivers (one type) score double for any adjacent river tile. Other tiles score normally. Build long river runs for big point swings.
