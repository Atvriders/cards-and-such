...
const MilleBornesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MilleBornesGame as unknown as React.ComponentType<unknown> })));
...
export const milleBornesPlugin: GamePlugin<MilleBornesState, MilleBornesAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: MilleBornesState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-mille-bornes-primary"]', pulses: 3 } : null), component: MilleBornesGame,
};
