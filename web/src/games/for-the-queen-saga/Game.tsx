...
export function ForTheQueenSagaGame({ state, dispatch, onGameOver }: GameProps<ForTheQueenSagaState, ForTheQueenSagaSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="ftq-wrap"><div className="ftq-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#be185d" }}>{state.score} pts</p></div></div>;
