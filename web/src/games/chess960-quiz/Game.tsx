    ...
    <div className="ch960q-wrap">
      ...
      <div className="ch960q-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as Chess960QuizAction)}><span className="ch960q-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
