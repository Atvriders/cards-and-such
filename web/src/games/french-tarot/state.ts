...
export type FrenchTarotState = HuTrickState;
export type FrenchTarotAction = HuTrickAction;
...
export const initialState = (seed: number, _s: FrenchTarotSettings): FrenchTarotState => engine.initialState(seed);
