...
const TvDramasQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TvDramasQuizGame as unknown as React.ComponentType<unknown> })));
...
export const tvDramasQuizPlugin: GamePlugin<TvDramasQuizState, TvDramasQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TvDramasQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TvDramasQuizGame,
};
