    ...
    <div className="losech-wrap">
      ...
      <div className="losech-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as LosingChessAction)}><span className="losech-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
