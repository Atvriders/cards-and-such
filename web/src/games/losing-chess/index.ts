...
const LosingChessGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LosingChessGame as unknown as React.ComponentType<unknown> })));
...
export const losingChessPlugin: GamePlugin<LosingChessState, LosingChessAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: LosingChessState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-losing-chess-answer-0"]', pulses: 3 } : null, component:LosingChessGame,
};
