...
export interface PresidentsCabinetSettings { dummy: boolean; }

export interface PresidentsCabinetState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type PresidentsCabinetAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: PresidentsCabinetSettings): PresidentsCabinetState {
...
export function reducer(state: PresidentsCabinetState, action: PresidentsCabinetAction): PresidentsCabinetState {
...
export function isTerminal(state: PresidentsCabinetState): { score: number } | null {
