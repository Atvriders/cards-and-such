...
const hint = (state: MiniBaccaratCasState): HintTarget | null => (state.phase === "bet" ? { selector: '[data-testid="hint-target-mini-baccarat-cas-primary"]', pulses: 3 } : null);
export const miniBaccaratCasPlugin: GamePlugin<MiniBaccaratCasState, MiniBaccaratCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: MiniBaccaratCasGame,
};
