...
const BunnyKingdomGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BunnyKingdomGame as unknown as React.ComponentType<unknown> })));
