...
const MusicalInstrumentsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MusicalInstrumentsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const musicalInstrumentsQuizPlugin: GamePlugin<MusicalInstrumentsQuizState, MusicalInstrumentsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MusicalInstrumentsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MusicalInstrumentsQuizGame,
};
