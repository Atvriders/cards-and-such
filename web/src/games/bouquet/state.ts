...
export interface BouquetSettings { dummy: boolean; }
...
export function reducer(state: BouquetState, action: BouquetAction): BouquetState {
...
export function isTerminal(state: BouquetState): { score: number } | null {
