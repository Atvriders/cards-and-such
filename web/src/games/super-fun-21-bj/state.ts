...
export interface SuperFun21BjSettings { dummy: boolean; }
export interface SuperFun21BjState { rngSeed: number; round: number; hand: number[]; total: number; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; }
export type SuperFun21BjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: SuperFun21BjSettings): SuperFun21BjState {
...
export function reducer(state: SuperFun21BjState, action: SuperFun21BjAction): SuperFun21BjState {
...
export function isTerminal(state: SuperFun21BjState): { score: number } | null {
