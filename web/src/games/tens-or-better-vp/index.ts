...
const TensOrBetterVpGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TensOrBetterVpGame as unknown as React.ComponentType<unknown> })));
...
export const tensOrBetterVpPlugin: GamePlugin<TensOrBetterVpState, TensOrBetterVpAction, typeof settings> = {
  ...
  reducer, isTerminal,
  hint: (state: TensOrBetterVpState): HintTarget | null => isTerminal(state) ? null : { selector: '[data-testid="hint-target-tens-or-better-vp-primary"]', pulses: 3 },
  component: TensOrBetterVpGame,
};
