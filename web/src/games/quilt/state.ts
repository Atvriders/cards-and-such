...
export interface QuiltSettings { dummy: boolean; }
...
export function reducer(state: QuiltState, action: QuiltAction): QuiltState {
...
export function isTerminal(state: QuiltState): { score: number } | null {
