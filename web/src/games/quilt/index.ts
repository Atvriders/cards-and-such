...
const QuiltGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.QuiltGame as unknown as React.ComponentType<unknown> })));
...
export const quiltPlugin: GamePlugin<QuiltState, QuiltAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as QuiltSettings),
  reducer,
  isTerminal,
  hint: (state: QuiltState): HintTarget | null => {
