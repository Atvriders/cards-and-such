...
export interface RoundCornerGinRSettings { dummy: boolean; }
export interface RoundCornerGinRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type RoundCornerGinRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: RoundCornerGinRSettings): RoundCornerGinRState {
...
export function reducer(state: RoundCornerGinRState, action: RoundCornerGinRAction): RoundCornerGinRState {
...
export function isTerminal(state: RoundCornerGinRState): { score: number } | null {
