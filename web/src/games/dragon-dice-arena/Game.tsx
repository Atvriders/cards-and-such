...
type DragonDiceArenaSettingsT = DragonDiceArenaState["" extends "" ? "rngSeed" : never];

export function DragonDiceArena({ state, dispatch, onGameOver }: GameProps<DragonDiceArenaState, { rounds: "10" }>): JSX.Element {
