...
const EvolutionClimateGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EvolutionClimateGame as unknown as React.ComponentType<unknown> })));
