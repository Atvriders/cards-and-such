    ...
    <div className="ynsh-wrap">
      ...
      <div className="ynsh-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as YinshAbsAction)}><span className="ynsh-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
