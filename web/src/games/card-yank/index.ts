...
const CardYankGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardYankGame as unknown as React.ComponentType<unknown> })));
...
export const cardYankPlugin: GamePlugin<CardYankState, CardYankAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-yank-primary"]', pulses: 3 }),component:CardYankGame,
};
