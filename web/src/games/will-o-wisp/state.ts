...
export interface WillOWispSettings { dummy: boolean; }

export interface WillOWispState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: WillOWispState, action: WillOWispAction): WillOWispState {
...
export function isTerminal(state: WillOWispState): { score: number } | null {
