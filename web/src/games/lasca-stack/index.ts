...
const LascaStackGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LascaStackGame as unknown as React.ComponentType<unknown> })));
...
export const lascaStackPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".lsk-board")) ? { selector: ".lsk-board", pulses: 3 } : null,
