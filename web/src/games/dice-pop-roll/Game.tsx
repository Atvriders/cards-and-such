...
export function DicePopRollGame({ state, dispatch, onGameOver }: GameProps<DicePopRollState, DicePopRollSettings>): JSX.Element {
    ...
    <div className="dm-wrap">
      ...
      {state.phase === "betting" ? (
        ...
        <>
          ...
          <button className="dm-btn" onClick={() => dispatch({ type:"next" } as DicePopRollAction)}>Next</button>
        </>
      )}
    </div>
  );
