...
export const DECK: { name: string; value: number }[] = [
  { name: "Empty", value: 0 },
  { name: "Trap", value: 1 },
  { name: "Treasure", value: 3 },
  { name: "Monster", value: 4 },
  { name: "Door", value: 5 },
  { name: "Boss", value: 8 },
];

export interface TinyEpicDungeonMiniSettings { dummy: boolean; }
export interface TinyEpicDungeonMiniState {
  rngSeed: number;
  round: number;
...
export type TinyEpicDungeonMiniAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: TinyEpicDungeonMiniSettings): TinyEpicDungeonMiniState {
...
export function reducer(state: TinyEpicDungeonMiniState, action: TinyEpicDungeonMiniAction): TinyEpicDungeonMiniState {
...
export function isTerminal(state: TinyEpicDungeonMiniState): { score: number } | null {
