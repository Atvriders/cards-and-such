...
export interface ThumbPouchSettings { dummy: boolean; }

export interface ThumbPouchState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: ThumbPouchSettings): ThumbPouchState {
...
export function reducer(state: ThumbPouchState, action: ThumbPouchAction): ThumbPouchState {
...
export function isTerminal(state: ThumbPouchState): { score: number } | null {
