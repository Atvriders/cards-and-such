...
export type BarbuState = HuTrickState;
export type BarbuAction = HuTrickAction;
...
export const initialState = (seed: number, _s: BarbuSettings): BarbuState => engine.initialState(seed);
