...
export interface LadyOfManorSettings { dummy: boolean; }

export interface LadyOfManorState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: LadyOfManorState, action: LadyOfManorAction): LadyOfManorState {
...
export function isTerminal(state: LadyOfManorState): { score: number } | null {
