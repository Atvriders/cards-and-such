...
export interface QwixxMixxerSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: QwixxMixxerSettings): QwixxMixxerState {
  return {
    rngSeed: seed >>> 0,
