...
const hint = (state: FourCardPokerCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-four-card-poker-cas-primary"]', pulses: 3 } : null);
export const fourCardPokerCasPlugin: GamePlugin<FourCardPokerCasState, FourCardPokerCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: FourCardPokerCasGame,
};
