...
const LabyrinthPatienceGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LabyrinthPatienceGame as unknown as React.ComponentType<unknown> })));
...
export const labyrinthPatiencePlugin: GamePlugin<LabyrinthPatienceState, LabyrinthPatienceAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as LabyrinthPatienceSettings),
  reducer,
  isTerminal,
  hint: (state: LabyrinthPatienceState): HintTarget | null => {
