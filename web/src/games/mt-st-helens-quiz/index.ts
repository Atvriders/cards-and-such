...
const MtStHelensQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MtStHelensQuizGame as unknown as React.ComponentType<unknown> })));
...
export const mtStHelensQuizPlugin: GamePlugin<MtStHelensQuizState, MtStHelensQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MtStHelensQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MtStHelensQuizGame,
};
