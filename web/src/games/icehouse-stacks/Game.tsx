...
export function AbsGame({ state, dispatch, onGameOver }: GameProps<AbsState, AbsSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    ...
    return <div className="ab-wrap"><h3>Icehouse (Stacks)</h3><div className="ab-done"><h2>{msg}</h2><div className="ab-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="ab-wrap">
      <h3>Icehouse (Stacks)</h3>
