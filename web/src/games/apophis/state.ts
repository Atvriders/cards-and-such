...
export interface ApophisSettings { dummy: boolean; }

export interface ApophisState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: ApophisState, action: ApophisAction): ApophisState {
...
export function isTerminal(state: ApophisState): { score: number } | null {
