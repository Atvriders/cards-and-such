...
const DisneyClassicsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DisneyClassicsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const disneyClassicsQuizPlugin: GamePlugin<DisneyClassicsQuizState, DisneyClassicsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: DisneyClassicsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:DisneyClassicsQuizGame,
};
