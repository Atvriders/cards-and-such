...
import { initialState, reducer, isTerminal, scoreCardCoffee, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardCoffee", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardCoffee([])).toBeGreaterThanOrEqual(0); });
