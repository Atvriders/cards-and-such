...
const CardCoffeeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardCoffeeGame as unknown as React.ComponentType<unknown> })));
...
export const cardCoffeePlugin: GamePlugin<CardCoffeeState, CardCoffeeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-coffee-primary"]', pulses: 3 }), component:CardCoffeeGame,
};
