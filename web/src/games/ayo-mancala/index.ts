...
const AyoMancalaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AyoMancalaGame as unknown as React.ComponentType<unknown> })));
...
export const ayoMancalaPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".ayo-board")) ? { selector: ".ayo-board", pulses: 3 } : null,
