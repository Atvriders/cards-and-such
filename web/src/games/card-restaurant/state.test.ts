...
import { initialState, reducer, isTerminal, scoreCardRestaurant, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardRestaurant", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardRestaurant([])).toBeGreaterThanOrEqual(0); });
