...
const DiceShrineGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceShrineGame as unknown as React.ComponentType<unknown> })));
...
export const diceShrinePlugin: GamePlugin<DiceShrineState, DiceShrineAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: any) => { if ((state as any).phase === "gameover" || (state as any).gameOver) return null; return { selector: '[data-testid="hint-target-dice-shrine-roll"]', pulses: 3 }; },
  component:DiceShrineGame,
};
