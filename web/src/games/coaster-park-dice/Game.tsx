...
type CoasterParkDiceSettingsT = CoasterParkDiceState["" extends "" ? "rngSeed" : never];

export function CoasterParkDice({ state, dispatch, onGameOver }: GameProps<CoasterParkDiceState, { rounds: "10" }>): JSX.Element {
