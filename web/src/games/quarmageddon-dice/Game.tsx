...
type QuarmageddonDiceSettingsT = QuarmageddonDiceState["" extends "" ? "rngSeed" : never];

export function QuarmageddonDice({ state, dispatch, onGameOver }: GameProps<QuarmageddonDiceState, { rounds: "10" }>): JSX.Element {
