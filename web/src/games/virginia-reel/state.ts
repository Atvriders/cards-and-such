...
export interface VirginiaReelSettings { dummy: boolean; }

export interface VirginiaReelState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type VirginiaReelAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: VirginiaReelSettings): VirginiaReelState {
...
export function reducer(state: VirginiaReelState, action: VirginiaReelAction): VirginiaReelState {
...
export function isTerminal(state: VirginiaReelState): { score: number } | null {
