...
Tips: think about words that wear many hats. A word like "coral" is both a color and a sea creature. "Jazz" is music and can describe a style. Cross-domain thinking is the key skill here.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".cc-btn", pulses: 3 }; },
