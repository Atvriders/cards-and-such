...
export interface PandemicHotZoneRwSettings { dummy: boolean; }
export interface PandemicHotZoneRwState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type PandemicHotZoneRwAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: PandemicHotZoneRwSettings): PandemicHotZoneRwState {
  return {
    rngSeed: seed,
...
export function reducer(state: PandemicHotZoneRwState, action: PandemicHotZoneRwAction): PandemicHotZoneRwState {
...
export function isTerminal(state: PandemicHotZoneRwState): { score: number } | null {
