...
const CardLeapFrogGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardLeapFrogGame as unknown as React.ComponentType<unknown> })));
...
export const cardLeapFrogPlugin: GamePlugin<CardLeapFrogState, CardLeapFrogAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-leap-frog-primary"]', pulses: 3 }), component:CardLeapFrogGame,
};
