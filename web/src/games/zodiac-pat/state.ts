...
export interface ZodiacPatSettings { dummy: boolean; }

export interface ZodiacPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: ZodiacPatState, action: ZodiacPatAction): ZodiacPatState {
...
export function isTerminal(state: ZodiacPatState): { score: number } | null {
