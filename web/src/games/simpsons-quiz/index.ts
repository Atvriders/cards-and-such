...
const SimpsonsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SimpsonsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const simpsonsQuizPlugin: GamePlugin<SimpsonsState, SimpsonsAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SimpsonsState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SimpsonsQuizGame,
};
