...
export interface CapitalismShedSettings { dummy: boolean; }
export interface CapitalismShedState { rngSeed: number; round: number; you: number; cpu: number; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; wins: number; losses: number; }
export type CapitalismShedAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: CapitalismShedSettings): CapitalismShedState {
  return { rngSeed: seed, round: 1, you: 7, cpu: 7, phase: "ready", score: 0, pts: 0, result: "", wins: 0, losses: 0 };
}
export function reducer(state: CapitalismShedState, action: CapitalismShedAction): CapitalismShedState {
...
export function isTerminal(state: CapitalismShedState): { score: number } | null {
