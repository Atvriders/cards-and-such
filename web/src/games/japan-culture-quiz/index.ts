...
const JapanCultureQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.JapanCultureQuizGame as unknown as React.ComponentType<unknown> })));
...
export const japanCultureQuizPlugin: GamePlugin<JapanCultureQuizState, JapanCultureQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: JapanCultureQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:JapanCultureQuizGame,
};
