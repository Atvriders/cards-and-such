...
export function CardPullBetGame({ state, dispatch, onGameOver }: GameProps<CardPullBetState, CardPullBetSettings>): JSX.Element {
    ...
    <div className="cm-wrap">
      ...
      {state.phase === "betting" ? (
        ...
        <>
          ...
          <button className="cm-btn" onClick={() => dispatch({ type:"next" } as CardPullBetAction)}>Next</button>
        </>
      )}
    </div>
  );
