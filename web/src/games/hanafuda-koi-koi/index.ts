...
const HanafudaKoiKoiGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HanafudaKoiKoiGame as unknown as React.ComponentType<unknown> })));
...
export const hanafudaKoiKoiPlugin: GamePlugin<HanafudaKoiKoiState, HanafudaKoiKoiAction, typeof settings> = {
  ...
  reducer, isTerminal,
  hint: (state: HanafudaKoiKoiState): HintTarget | null => {
    if (isTerminal(state)) return null;
    return { selector: '[data-testid="hint-target-hanafuda-koi-koi-next"]', pulses: 3 };
  },
  component: HanafudaKoiKoiGame,
};
