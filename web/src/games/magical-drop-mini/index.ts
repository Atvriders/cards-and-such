...
const MagicalDropMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MagicalDropMiniGame as unknown as React.ComponentType<unknown> })));
...
export const magicalDropMiniPlugin: GamePlugin<MagicalDropMiniState, MagicalDropMiniAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-magical-drop-mini-action"]', pulses: 3 }; }, component:MagicalDropMiniGame,
};
