...
import { TrialTrolleyQuiz } from "./Game.js";
...
export const trialTrolleyQuizPlugin: GamePlugin<TrialTrolleyQuizState, TrialTrolleyQuizAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TrialTrolleyQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
