...
const BlokusClassicGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BlokusClassicGame as unknown as React.ComponentType<unknown> })));
...
export const blokusClassicPlugin: GamePlugin<BlokusClassicState, BlokusClassicAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: BlokusClassicState): HintTarget | null => {
    const sel = tileHintSelector(state, "blkc-grid");
