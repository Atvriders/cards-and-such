...
describe("PaintingTechniquesQuiz", () => {
  ...
  it("game completes after all questions", () => {
    let s=initialState(1,S);
    for(let i=0;i<10;i++){ s=reducer(s,{type:"select",choice:s.questions[s.currentIndex]!.correct}); s=reducer(s,{type:"submit"}); s=reducer(s,{type:"next"}); }
