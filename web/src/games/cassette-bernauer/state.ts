...
export interface CassetteBernauerSettings { dummy: boolean; }

export interface CassetteBernauerState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type CassetteBernauerAction =
  | { type: "keep" }
...
export function reducer(state: CassetteBernauerState, action: CassetteBernauerAction): CassetteBernauerState {
...
export function isTerminal(state: CassetteBernauerState): { score: number } | null {
