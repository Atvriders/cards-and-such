...
export type TressetteState = HuTrickState;
export type TressetteAction = HuTrickAction;
export interface TressetteSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: TressetteSettings): TressetteState => engine.initialState(seed);
