...
export interface StalactitesPatSettings { dummy: boolean; }

export interface StalactitesPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type StalactitesPatAction =
  | { type: "keep" }
...
export function reducer(state: StalactitesPatState, action: StalactitesPatAction): StalactitesPatState {
...
export function isTerminal(state: StalactitesPatState): { score: number } | null {
