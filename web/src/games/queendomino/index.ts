...
const QueendominoGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.QueendominoGame as unknown as React.ComponentType<unknown> })));
