...
export interface strixhavenCurriculumSettings { dummy: boolean; }
export interface strixhavenCurriculumState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type strixhavenCurriculumAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: strixhavenCurriculumSettings): strixhavenCurriculumState {
  return {
    rngSeed: seed,
...
export function reducer(state: strixhavenCurriculumState, action: strixhavenCurriculumAction): strixhavenCurriculumState {
...
export function isTerminal(state: strixhavenCurriculumState): { score: number } | null {
