...
export interface AllAmericanVpSettings { dummy: boolean; }
export interface AllAmericanVpState { rngSeed: number; round: number; hand: number[]; phase: "deal" | "scored" | "done"; score: number; pts: number; result: string; rank: string; }
export type AllAmericanVpAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: AllAmericanVpSettings): AllAmericanVpState {
  return { rngSeed: seed, round: 1, hand: [], phase: "deal", score: 0, pts: 0, result: "", rank: "" };
}
export function reducer(state: AllAmericanVpState, action: AllAmericanVpAction): AllAmericanVpState {
...
export function isTerminal(state: AllAmericanVpState): { score: number } | null {
