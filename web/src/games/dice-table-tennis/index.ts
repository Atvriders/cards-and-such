...
const DiceTableTennisGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceTableTennisGame as unknown as React.ComponentType<unknown> })));
...
export const diceTableTennisPlugin: GamePlugin<DiceTableTennisState, DiceTableTennisAction, typeof settings> = {
  id: "dice-table-tennis",
  title: "Dice Table Tennis",
  category: "dice",
  players: { min: 1, max: 1, multiplayer: false },
  description: 'Dice Table Tennis: play rallies to 11; first to target wins the match.',
  howToPlay: 'Dice Table Tennis is a real, dice-driven simulation. Dice Table Tennis: play rallies to 11; first to target wins the match.\\n\\nPress Roll to take your turn. Each round resolves immediately and the running score updates after every roll. Press Next to advance until the match ends.\\n\\nGame state is fully seeded for replay parity, and the log strip shows your most recent rolls.',
  settings,
