...
const RiskMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RiskMiniGame as unknown as React.ComponentType<unknown> })));
...
Win by controlling all 6 territories. After 30 turns whoever owns more territories wins. Score = 60 × territories + 4 × armies + 600 conquest bonus.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".riskmini-btn", pulses: 3 }; },
