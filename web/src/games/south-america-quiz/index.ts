...
const SouthAmericaQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SouthAmericaQuizGame as unknown as React.ComponentType<unknown> })));
...
export const southAmericaQuizPlugin: GamePlugin<SouthAmericaQuizState, SouthAmericaQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SouthAmericaQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SouthAmericaQuizGame,
};
