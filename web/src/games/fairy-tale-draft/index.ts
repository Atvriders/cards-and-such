...
const FairyTaleDraftGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FairyTaleDraftGame as unknown as React.ComponentType<unknown> })));
