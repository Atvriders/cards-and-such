...
export interface TurboTournamentSettings { dummy: boolean; }
export interface TurboTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type TurboTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: TurboTournamentSettings): TurboTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: TurboTournamentState, action: TurboTournamentAction): TurboTournamentState {
...
export function isTerminal(state: TurboTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
