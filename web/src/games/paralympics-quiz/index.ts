...
const ParalympicsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ParalympicsQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. Spirit in motion — this quiz celebrates the resilience and excellence of Paralympic athletes from around the world.`,
  ...
  reducer,isTerminal,
  hint: (state: ParalympicsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ParalympicsQuizGame,
};
