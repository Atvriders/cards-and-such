...
export interface MarvelChampionsCoopSettings { dummy: boolean; }
export interface MarvelChampionsCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type MarvelChampionsCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: MarvelChampionsCoopSettings): MarvelChampionsCoopState {
