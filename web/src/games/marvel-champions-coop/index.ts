...
export const marvel_champions_coop_plugin: GamePlugin<MarvelChampionsCoopState, MarvelChampionsCoopAction, typeof settings> = {
...
export default marvel_champions_coop_plugin;
