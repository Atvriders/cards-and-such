...
const AshesPhoenixbornGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AshesPhoenixbornGame as unknown as React.ComponentType<unknown> })));
...
export const ashesPhoenixbornPlugin: GamePlugin<AshesPhoenixbornState, AshesPhoenixbornAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-ashes-phoenixborn-primary"]', pulses: 3 }),
