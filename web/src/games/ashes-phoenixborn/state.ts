...
export interface AshesPhoenixbornSettings { dummy: boolean; }
export interface AshesPhoenixbornState {
  rngSeed: number;
  round: number;
  you: number[];
  foe: number[];
...
export type AshesPhoenixbornAction = { type: "roll" } | { type: "next" };
export function initialState(seed: number, _s: AshesPhoenixbornSettings): AshesPhoenixbornState {
...
export function reducer(state: AshesPhoenixbornState, action: AshesPhoenixbornAction): AshesPhoenixbornState {
...
export function isTerminal(state: AshesPhoenixbornState): { score: number } | null {
