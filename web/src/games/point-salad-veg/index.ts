...
const PointSaladVegGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PointSaladVegGame as unknown as React.ComponentType<unknown> })));
