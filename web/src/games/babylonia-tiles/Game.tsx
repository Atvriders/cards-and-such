...
export function BabyloniaTiles({ state, dispatch, onGameOver }: GameProps<BabyloniaTilesState, { mode: "easy" }>): JSX.Element {
      ...
      <div className="g-grid">
        {state.board.map((c, i) => (
          <div
            ...
            onClick={() => c === "" && dispatch({ type: "play", index: i } as BabyloniaTilesAction)}
          >
            {c}
          </div>
        ))}
