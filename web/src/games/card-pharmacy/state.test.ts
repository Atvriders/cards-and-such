...
import { initialState, reducer, isTerminal, scoreCardPharmacy, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardPharmacy", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardPharmacy([])).toBeGreaterThanOrEqual(0); });
