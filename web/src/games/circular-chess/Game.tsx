    ...
    <div className="circch-wrap">
      ...
      <div className="circch-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as CircularChessAction)}><span className="circch-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
