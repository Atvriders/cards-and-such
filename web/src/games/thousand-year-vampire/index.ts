...
const ThousandYearVampireGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ThousandYearVampireGame as unknown as React.ComponentType<unknown> })));
...
export const thousandYearVampirePlugin: GamePlugin<ThousandYearVampireState, ThousandYearVampireAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: ThousandYearVampireState): HintTarget | null => (state.phase === "choose" ? { selector: '[data-testid="hint-target-thousand-year-vampire-primary"]', pulses: 3 } : null), component: ThousandYearVampireGame,
};
