...
export function ShitheadGame({ state, dispatch, onGameOver }: GameProps<ShitheadState, ShitheadSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="shithead-wrap shit-shed"><div className="shithead-done bounce-in"><h2>Done!</h2><div>W: {state.wins} L: {state.losses}</div><div className="shithead-final">{state.score} pts</div></div></div>;
  return (
    <div className="shithead-wrap shit-shed">
      ...
      <div className="shithead-score pulse">{state.score} pts</div>
