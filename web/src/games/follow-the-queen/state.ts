...
export interface FollowTheQueenSettings { dummy: boolean; }
export interface FollowTheQueenState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type FollowTheQueenAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: FollowTheQueenSettings): FollowTheQueenState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: FollowTheQueenState, action: FollowTheQueenAction): FollowTheQueenState {
...
export function isTerminal(state: FollowTheQueenState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
