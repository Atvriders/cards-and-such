...
const TamCucGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TamCucGame as unknown as React.ComponentType<unknown> })));
...
export const tamCucPlugin: GamePlugin<TamCucState, TamCucAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TamCucState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TamCucGame,
};
