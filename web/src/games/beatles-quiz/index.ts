...
const BeatlesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BeatlesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const beatlesQuizPlugin: GamePlugin<BeatlesQuizState, BeatlesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BeatlesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BeatlesQuizGame,
};
