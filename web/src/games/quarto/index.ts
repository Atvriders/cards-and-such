...
const Quarto = /* @__PURE__ */ lazy(() => import("./Quarto.js").then((mod) => ({ default: mod.Quarto as unknown as React.ComponentType<unknown> })));
...
Tip: Beware of handing the opponent a piece that could complete multiple line types — they will find the best cell for it.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver || (s as any).won || (s as any).isWon || (s as any).isComplete || (s as any).complete) return null; return { selector: '[data-testid="hint-target-quarto-action"]', pulses: 3 }; },
  component: Quarto,
};
