...
export type TarocchiState = HuTrickState;
export type TarocchiAction = HuTrickAction;
...
export const initialState = (seed: number, _s: TarocchiSettings): TarocchiState => engine.initialState(seed);
