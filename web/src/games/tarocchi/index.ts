...
const TarocchiGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TarocchiGame as unknown as React.ComponentType<unknown> })));
...
export const tarocchiPlugin: GamePlugin<TarocchiState, TarocchiAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TarocchiState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-tarocchi-${pick.id}"]`, pulses: 3 };
    }
