...
export interface LittleKillerSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: LittleKillerSudokuSettings;
}

export type LittleKillerSudokuAction =
...
export function initialState(seed: number, settings: LittleKillerSudokuSettings): LittleKillerSudokuState {
