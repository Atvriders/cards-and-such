...
export interface AllInARowSettings { dummy: boolean; }

export interface AllInARowState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: AllInARowSettings): AllInARowState {
...
export function reducer(state: AllInARowState, action: AllInARowAction): AllInARowState {
...
export function isTerminal(state: AllInARowState): { score: number } | null {
