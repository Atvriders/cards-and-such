...
const FeedTheCat = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FeedTheCat as unknown as React.ComponentType<unknown> })));
...
You have 30 seconds total. The longer you survive with a full meter, the higher your score. Items spawn faster as the game progresses, so stay sharp and prioritize the food that keeps your cat happiest. Aim for a combo of high-value treats and steady fish catches to maximize your final score!`,
  ...
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-feed-the-cat-action"]', pulses: 3 }; },
