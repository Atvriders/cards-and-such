...
const QuoridorAbsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.QuoridorAbsGame as unknown as React.ComponentType<unknown> })));
...
export const quoridorAbsPlugin: GamePlugin<QuoridorAbsState, QuoridorAbsAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: QuoridorAbsState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quoridor-abs-answer-0"]', pulses: 3 } : null, component:QuoridorAbsGame,
};
