...
export interface NonConsecutiveSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: NonConsecutiveSudokuSettings;
}

export type NonConsecutiveSudokuAction =
...
export function initialState(seed: number, settings: NonConsecutiveSudokuSettings): NonConsecutiveSudokuState {
