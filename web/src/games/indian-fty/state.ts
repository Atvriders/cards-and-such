...
export interface IndianFtySettings { dummy: boolean; }

export interface IndianFtyState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: IndianFtySettings): IndianFtyState {
...
export function reducer(state: IndianFtyState, action: IndianFtyAction): IndianFtyState {
...
export function isTerminal(state: IndianFtyState): { score: number } | null {
