...
export interface HogwartsBattleCoopSettings { dummy: boolean; }
export interface HogwartsBattleCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type HogwartsBattleCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: HogwartsBattleCoopSettings): HogwartsBattleCoopState {
