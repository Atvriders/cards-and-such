...
export interface PersianRummyRSettings { dummy: boolean; }
export interface PersianRummyRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type PersianRummyRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: PersianRummyRSettings): PersianRummyRState {
...
export function reducer(state: PersianRummyRState, action: PersianRummyRAction): PersianRummyRState {
...
export function isTerminal(state: PersianRummyRState): { score: number } | null {
