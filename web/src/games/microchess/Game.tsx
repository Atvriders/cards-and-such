    ...
    <div className="microch-wrap">
      ...
      <div className="microch-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as MicrochessAction)}><span className="microch-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
