...
import { TabulaGameGame } from "./Game.js";
const settings = { dummy: { kind:"boolean" as const, label:"dummy", default:false } } as const;
type S = SettingsOf<typeof settings>;
export const tabulaGamePlugin: GamePlugin<TabulaGameState, TabulaGameAction, typeof settings> = {
  id: "tabula-game",
  title: "Tabula (Roman)",
  category: "dice",
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as TabulaGameSettings),
  reducer,
  isTerminal,
  component: TabulaGameGame,
};
