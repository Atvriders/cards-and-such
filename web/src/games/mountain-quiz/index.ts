...
const MountainQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MountainQuizGame as unknown as React.ComponentType<unknown> })));
...
export const mountainQuizPlugin: GamePlugin<MountainQuizState, MountainQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MountainQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MountainQuizGame,
};
