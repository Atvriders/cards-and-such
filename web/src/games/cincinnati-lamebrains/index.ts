...
const hint = (state: CincinnatiLamebrainsState): HintTarget | null => ((state.phase === "ready" || state.phase === "dealt") ? { selector: ".g-btn", pulses: 3 } : null);
...
export const cincinnatiLamebrainsPlugin: GamePlugin<CincinnatiLamebrainsState, CincinnatiLamebrainsAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: CincinnatiLamebrains,
};
