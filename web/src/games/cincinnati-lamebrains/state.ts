...
export interface CincinnatiLamebrainsSettings { rounds: "10"; }

export interface CincinnatiLamebrainsState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type CincinnatiLamebrainsAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: CincinnatiLamebrainsSettings): CincinnatiLamebrainsState {
  return { rngSeed: seed >>> 0, score: 0, round: 1, maxRounds: 10, hand: [], lastGain: 0, phase: "ready" };
}

export function reducer(state: CincinnatiLamebrainsState, action: CincinnatiLamebrainsAction): CincinnatiLamebrainsState {
...
export function isTerminal(state: CincinnatiLamebrainsState): { score: number } | null {
