...
export type EggDropAction = { type: "catch"; id: number } | { type: "tick" } | { type: "spawn" };

export function initialState(seed: number, settings: EggDropSettings): EggDropState {
...
export function reducer(state: EggDropState, action: EggDropAction): EggDropState {
...
export function isTerminal(state: EggDropState): { score: number } | null {
