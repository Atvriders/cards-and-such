...
export const TARGET_THRESHOLD = 8;
...
export type DiceVillageAction = { type: "roll" } | { type: "next" };
export function isWin(a: number, b: number): boolean { return a + b >= 8; }
...
export function isTerminal(state: DiceVillageState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
