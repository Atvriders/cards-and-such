...
const Nmbr9StackGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Nmbr9StackGame as unknown as React.ComponentType<unknown> })));
