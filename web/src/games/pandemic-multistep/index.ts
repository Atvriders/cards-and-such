...
import { PandemicMultistep_CFG, initialState, reducer, isTerminal } from "./state.js";
import { coopHintSelector } from "../_shared/coop-engine.js";
const PandemicMultistepGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PandemicMultistepGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const pandemicMultistepPlugin: GamePlugin<PandemicMultistepState, PandemicMultistepAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: PandemicMultistepState): HintTarget | null => {
    const sel = coopHintSelector(state, PandemicMultistep_CFG);
