...
export interface PandemicMultistepSettings { dummy: boolean; }
export interface PandemicMultistepState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type PandemicMultistepAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: PandemicMultistepSettings): PandemicMultistepState {
