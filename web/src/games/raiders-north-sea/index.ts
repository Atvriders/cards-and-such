...
const RaidersNorthSeaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RaidersNorthSeaGame as unknown as React.ComponentType<unknown> })));
