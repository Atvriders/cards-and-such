...
const HangmanClGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HangmanClGame as unknown as React.ComponentType<unknown> })));
...
export const hangmanClPlugin: GamePlugin<HangmanClState, HangmanClAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: HangmanClState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-hangman-cl-answer-0"]', pulses: 3 } : null, component:HangmanClGame,
};
