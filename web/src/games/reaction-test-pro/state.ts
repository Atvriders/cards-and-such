...
// Reaction Test Pro: stimuli appear; react when condition is met.
...
export interface ReactionTestProSettings { dummy: boolean; }

export interface ReactionTestProState {
  rngSeed: number;
...
export type ReactionTestProAction =
  | { type: "tick" }
  | { type: "react" };

export function initialState(seed: number, _settings: ReactionTestProSettings): ReactionTestProState {
...
export function reducer(state: ReactionTestProState, action: ReactionTestProAction): ReactionTestProState {
...
export function isTerminal(state: ReactionTestProState): { score: number } | null {
