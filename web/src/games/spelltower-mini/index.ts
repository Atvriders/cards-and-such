...
const SpelltowerMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SpelltowerMiniGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const spelltowerMiniPlugin: GamePlugin<SpelltowerMiniState, SpelltowerMiniAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: SpelltowerMiniState): HintTarget | null => {
