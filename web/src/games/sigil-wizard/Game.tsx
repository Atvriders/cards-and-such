...
export function SigilWizardGame({ state, dispatch, onGameOver }: GameProps<SigilWizardState, SigilWizardSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="sgw-wrap"><div className="sgw-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
