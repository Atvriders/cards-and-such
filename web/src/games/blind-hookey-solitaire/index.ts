...
const BlindHookeySolitaireGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BlindHookeySolitaireGame as unknown as React.ComponentType<unknown> })));
...
export const blindHookeySolitairePlugin: GamePlugin<BlindHookeySolitaireState, BlindHookeySolitaireAction, typeof settings> = {
  ...
  reducer,isTerminal,component:BlindHookeySolitaireGame,
