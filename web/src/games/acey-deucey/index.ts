...
import type { AceyState, AceyAction, AceySettings } from "./state.js";
import { initialState, reducer, isTerminal } from "./state.js";
const AceyGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AceyGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const aceyDeuceyPlugin: GamePlugin<AceyState, AceyAction, typeof settings> = {
  id: "acey-deucey",
  title: "Acey-Deucey",
  category: "board",
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as AceySettings),
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".acey-d-movebtn", pulses: 3 }; },
  component: AceyGame,
};
