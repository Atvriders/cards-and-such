...
const LibertaliaGalecrestGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LibertaliaGalecrestGame as unknown as React.ComponentType<unknown> })));
