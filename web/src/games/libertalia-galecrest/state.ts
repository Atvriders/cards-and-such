...
export const SUIT_NAMES = ["Captain","Crew","Booty","Storm"] as const;
...
export type LibertaliaGalecrestState = DraftState;
export type LibertaliaGalecrestAction = DraftAction;
...
export function initialState(seed: number, _settings: LibertaliaGalecrestSettings): LibertaliaGalecrestState {
...
export function score(state: LibertaliaGalecrestState): number {
  return draftFinalScore(state);
}

export function isTerminal(state: LibertaliaGalecrestState): { score: number } | null {
