...
export type DiceStratArenaAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceStratArenaState, action: DiceStratArenaAction): DiceStratArenaState {
  ...
  if (action.type === "roll") {
    ...
    let pts = 0;
    let logEntry = "";
    let extra: Partial<DiceStratArenaState> = {};
