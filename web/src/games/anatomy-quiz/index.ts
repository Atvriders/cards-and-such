...
const AnatomyQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AnatomyQuizGame as unknown as React.ComponentType<unknown> })));
...
export const anatomyQuizPlugin: GamePlugin<AnatomyQuizState, AnatomyQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: AnatomyQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:AnatomyQuizGame,
};
