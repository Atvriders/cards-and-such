...
const ShuffleQuarterPubGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ShuffleQuarterPubGame as unknown as React.ComponentType<unknown> })));
...
export const shuffleQuarterPlugin: GamePlugin<ShuffleQuarterPubState, ShuffleQuarterPubAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-shuffle-quarter-pub-action"]', pulses: 3 }; },
