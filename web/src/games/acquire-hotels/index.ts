...
const AcquireHotelsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AcquireHotelsGame as unknown as React.ComponentType<unknown> })));
...
export const acquireHotelsPlugin: GamePlugin<AcquireHotelsState, AcquireHotelsAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: AcquireHotelsState): HintTarget | null => (state.phase === "choosing" ? { selector: '[data-testid="hint-target-acquire-hotels-primary"]', pulses: 3 } : null),
