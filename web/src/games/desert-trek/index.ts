...
const DesertTrek = /* @__PURE__ */ lazy(() => import("./DesertTrek.js").then((mod) => ({ default: mod.DesertTrek as unknown as React.ComponentType<unknown> })));
...
Tips: seek out oases early to replenish water. Avoid quicksand unless it saves you from a long detour. Sand dunes are hard walls — plan your route around clusters of them before moving.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver || (s as any).won || (s as any).isWon || (s as any).isComplete || (s as any).complete) return null; return { selector: '[data-testid="hint-target-desert-trek-action"]', pulses: 3 }; },
