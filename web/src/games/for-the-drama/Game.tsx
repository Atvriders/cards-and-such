...
export function ForTheDramaGame({ state, dispatch, onGameOver }: GameProps<ForTheDramaState, ForTheDramaSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="ftd-wrap"><div className="ftd-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
