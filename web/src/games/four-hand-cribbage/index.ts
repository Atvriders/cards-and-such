...
const hint = (state: FourHandCribbageState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const fourHandCribbagePlugin: GamePlugin<FourHandCribbageState, FourHandCribbageAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: FourHandCribbageGame,
};
