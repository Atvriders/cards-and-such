...
const DiceShootGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceShootGame as unknown as React.ComponentType<unknown> })));
...
export const diceShootPlugin: GamePlugin<DiceShootState, DiceShootAction, typeof settings> = {
  ...
  reducer,isTerminal,
    hint: (state: DiceShootState) => {
      if (state.phase === "done") return null;
      return { selector: '[data-testid="hint-target-dice-shoot-action"]', pulses: 3 };
    },
  component:DiceShootGame,
};
