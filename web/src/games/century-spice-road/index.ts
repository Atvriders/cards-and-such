...
const CenturySpiceRoadGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CenturySpiceRoadGame as unknown as React.ComponentType<unknown> })));
...
export const centurySpiceRoadPlugin: GamePlugin<CenturySpiceRoadState, CenturySpiceRoadAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: CenturySpiceRoadState): HintTarget | null => (state.phase === "choosing" ? { selector: '[data-testid="hint-target-century-spice-road-primary"]', pulses: 3 } : null),
