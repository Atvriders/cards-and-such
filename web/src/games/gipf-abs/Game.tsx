    ...
    <div className="gpf-wrap">
      ...
      <div className="gpf-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as GipfAbsAction)}><span className="gpf-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
