...
const CardEclipseGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardEclipseGame as unknown as React.ComponentType<unknown> })));
...
export const cardEclipsePlugin: GamePlugin<CardEclipseState, CardEclipseAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-eclipse-primary"]', pulses: 3 }), component:CardEclipseGame,
};
