...
export interface RebuyTournamentSettings { dummy: boolean; }
export interface RebuyTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type RebuyTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: RebuyTournamentSettings): RebuyTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: RebuyTournamentState, action: RebuyTournamentAction): RebuyTournamentState {
...
export function isTerminal(state: RebuyTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
