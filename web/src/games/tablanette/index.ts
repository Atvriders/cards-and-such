...
import { TablanetteGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: TablanetteState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const tablanettePlugin: GamePlugin<TablanetteState, TablanetteAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: TablanetteGame,
};
