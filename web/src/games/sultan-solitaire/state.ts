...
export interface SultanSolitaireSettings { dummy: boolean; }

export interface SultanSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type SultanSolitaireAction =
  | { type: "keep" }
...
export function reducer(state: SultanSolitaireState, action: SultanSolitaireAction): SultanSolitaireState {
...
export function isTerminal(state: SultanSolitaireState): { score: number } | null {
