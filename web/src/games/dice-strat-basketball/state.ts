...
export type DiceStratBasketballStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceStratBasketballState, action: DiceStratBasketballStateAction): DiceStratBasketballState {
