...
const AustraliaCultureQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AustraliaCultureQuizGame as unknown as React.ComponentType<unknown> })));
...
export const australiaCultureQuizPlugin: GamePlugin<AustraliaCultureQuizState, AustraliaCultureQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: AustraliaCultureQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:AustraliaCultureQuizGame,
};
