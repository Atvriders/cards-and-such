...
const TokaidoCrossroadsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TokaidoCrossroadsGame as unknown as React.ComponentType<unknown> })));
...
export const tokaidoCrossroadsPlugin: GamePlugin<TokaidoCrossroadsState, TokaidoCrossroadsAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TokaidoCrossroadsState): HintTarget | null => {
    const sel = tileHintSelector(state, "tokc-grid");
