...
const CarBrandsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CarBrandsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const carBrandsQuizPlugin: GamePlugin<CarBrandsQuizState, CarBrandsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CarBrandsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CarBrandsQuizGame,
};
