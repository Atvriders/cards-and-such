...
const CybersecQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CybersecQuizGame as unknown as React.ComponentType<unknown> })));
...
export const cybersecQuizPlugin: GamePlugin<CybersecQuizState, CybersecQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CybersecQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CybersecQuizGame,
};
