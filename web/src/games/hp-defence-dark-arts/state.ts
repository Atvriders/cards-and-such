...
export interface HpDefenceDarkArtsSettings { dummy: boolean; }
export interface HpDefenceDarkArtsState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type HpDefenceDarkArtsAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: HpDefenceDarkArtsSettings): HpDefenceDarkArtsState {
