...
export type DiceFantasyBasketballDraftStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceFantasyBasketballDraftState, action: DiceFantasyBasketballDraftStateAction): DiceFantasyBasketballDraftState {
