...
type RollingRealmsMiniSettingsT = RollingRealmsMiniState["" extends "" ? "rngSeed" : never];

export function RollingRealmsMini({ state, dispatch, onGameOver }: GameProps<RollingRealmsMiniState, { rounds: "10" }>): JSX.Element {
