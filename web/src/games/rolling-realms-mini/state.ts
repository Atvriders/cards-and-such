...
export interface RollingRealmsMiniSettings { rounds: "10"; }

export interface RollingRealmsMiniState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type RollingRealmsMiniAction = { type: "roll" } | { type: "next" };
...
export function initialState(seed: number, _settings: RollingRealmsMiniSettings): RollingRealmsMiniState {
  return {
    rngSeed: seed >>> 0,
    score: 0,
    round: 1,
...
export function reducer(state: RollingRealmsMiniState, action: RollingRealmsMiniAction): RollingRealmsMiniState {
...
export function isTerminal(state: RollingRealmsMiniState): { score: number } | null {
