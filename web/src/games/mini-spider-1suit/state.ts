...
export interface MiniSpider1suitSettings { dummy: boolean; }

export interface MiniSpider1suitState {
  rngSeed: number;
...
export type MiniSpider1suitAction = { type: "remove"; index: number } | { type: "noop" };
...
export function initialState(seed: number, _settings: MiniSpider1suitSettings): MiniSpider1suitState {
...
export function reducer(state: MiniSpider1suitState, action: MiniSpider1suitAction): MiniSpider1suitState {
...
export function isTerminal(state: MiniSpider1suitState): { score: number } | null {
