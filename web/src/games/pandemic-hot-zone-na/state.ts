...
export interface PandemicHotZoneNaSettings { dummy: boolean; }
export interface PandemicHotZoneNaState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type PandemicHotZoneNaAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: PandemicHotZoneNaSettings): PandemicHotZoneNaState {
