...
const GrandOthelloMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GrandOthelloMiniGame as unknown as React.ComponentType<unknown> })));
...
export const grandOthelloMiniPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".goh-board")) ? { selector: ".goh-board", pulses: 3 } : null,
