...
const TerraformingMarsPreludeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TerraformingMarsPreludeGame as unknown as React.ComponentType<unknown> })));
