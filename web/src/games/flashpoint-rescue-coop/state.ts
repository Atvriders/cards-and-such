...
export interface FlashpointRescueCoopSettings { dummy: boolean; }
export interface FlashpointRescueCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type FlashpointRescueCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: FlashpointRescueCoopSettings): FlashpointRescueCoopState {
