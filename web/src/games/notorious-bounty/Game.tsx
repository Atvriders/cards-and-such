...
export function NotoriousBountyGame({ state, dispatch, onGameOver }: GameProps<NotoriousBountyState, NotoriousBountySettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="nbn-wrap"><div className="nbn-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
