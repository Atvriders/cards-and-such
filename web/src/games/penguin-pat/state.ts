...
export interface PenguinPatSettings { dummy: boolean; }

export interface PenguinPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: PenguinPatSettings): PenguinPatState {
...
export function reducer(state: PenguinPatState, action: PenguinPatAction): PenguinPatState {
...
export function isTerminal(state: PenguinPatState): { score: number } | null {
