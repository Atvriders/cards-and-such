...
const TILE_COLORS = ["#e91e63","#c0392b","#3498db","#f1c40f","#27ae60"];
const TILE_LABELS = ["P","D","F","M","K"];
      ...
      <div className="tp-grid" style={{ gridTemplateColumns: `repeat(${GRID_SIZE}, 40px)` }}>
        {state.cells.map((v, i) => (
          <button
            ...
            onClick={() => v < 0 && dispatch({ type: "place", index: i } as CarcassonnePrincessDragonAction)}
            disabled={v >= 0}
