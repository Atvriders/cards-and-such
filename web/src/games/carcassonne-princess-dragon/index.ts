...
const CarcassonnePrincessDragonGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CarcassonnePrincessDragonGame as unknown as React.ComponentType<unknown> })));
...
export const carcassonnePrincessDragonPlugin: GamePlugin<CarcassonnePrincessDragonState, CarcassonnePrincessDragonAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: CarcassonnePrincessDragonState): HintTarget | null => {
    const sel = tileHintSelector(state, "carcpd-grid");
