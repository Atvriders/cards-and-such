...
const BoxingLegendsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BoxingLegendsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const boxingLegendsQuizPlugin: GamePlugin<BoxingLegendsQuizState, BoxingLegendsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BoxingLegendsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BoxingLegendsQuizGame,
};
