...
export interface CalculationSolitaireSettings { dummy: boolean; }

export interface CalculationSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type CalculationSolitaireAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: CalculationSolitaireSettings): CalculationSolitaireState {
...
export function reducer(state: CalculationSolitaireState, action: CalculationSolitaireAction): CalculationSolitaireState {
...
export function isTerminal(state: CalculationSolitaireState): { score: number } | null {
