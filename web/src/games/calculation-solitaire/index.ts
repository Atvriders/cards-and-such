...
const CalculationSolitaireGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CalculationSolitaireGame as unknown as React.ComponentType<unknown> })));
...
export const calculationSolitairePlugin: GamePlugin<CalculationSolitaireState, CalculationSolitaireAction, typeof settings> = {
  ...
  reducer,isTerminal,component:CalculationSolitaireGame,
