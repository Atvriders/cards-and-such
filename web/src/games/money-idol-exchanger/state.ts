...
export interface MoneyIdolExchangerSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface MoneyIdolExchangerState {
  rngSeed: number;
  grid: Grid;
...
export type MoneyIdolExchangerAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: MoneyIdolExchangerSettings): MoneyIdolExchangerState {
...
export function reducer(state: MoneyIdolExchangerState, action: MoneyIdolExchangerAction): MoneyIdolExchangerState {
...
export function isTerminal(state: MoneyIdolExchangerState): { score: number } | null {
