...
export interface SpanishPatienceSettings { dummy: boolean; }

export interface SpanishPatienceState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type SpanishPatienceAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: SpanishPatienceSettings): SpanishPatienceState {
...
export function reducer(state: SpanishPatienceState, action: SpanishPatienceAction): SpanishPatienceState {
...
export function isTerminal(state: SpanishPatienceState): { score: number } | null {
