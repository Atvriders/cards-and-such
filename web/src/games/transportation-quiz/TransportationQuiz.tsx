...
import type { TransportationQuizState, TransportationQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./TransportationQuiz.css";
export function TransportationQuiz({ state, dispatch, onGameOver }: GameProps<TransportationQuizState, TransportationQuizSettings>): JSX.Element {
