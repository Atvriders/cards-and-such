...
export type ShoveHapennyAction = { type: "throw" } | { type: "next" };

export function initialState(seed: number, _s: ShoveHapennySettings): ShoveHapennyState {
...
export function isTerminal(s: ShoveHapennyState): { score: number } | null { return s.phase === "done" ? { score: s.score } : null; }
