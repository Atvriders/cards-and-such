...
export interface GanzCleverSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: GanzCleverSettings): GanzCleverState {
  return {
    rngSeed: seed >>> 0,
