...
export interface BountyTournamentSettings { dummy: boolean; }
export interface BountyTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type BountyTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: BountyTournamentSettings): BountyTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: BountyTournamentState, action: BountyTournamentAction): BountyTournamentState {
...
export function isTerminal(state: BountyTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
