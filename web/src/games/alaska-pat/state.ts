...
export interface AlaskaPatSettings { dummy: boolean; }

export interface AlaskaPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: AlaskaPatState, action: AlaskaPatAction): AlaskaPatState {
...
export function isTerminal(state: AlaskaPatState): { score: number } | null {
