...
const AlaskaPatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AlaskaPatGame as unknown as React.ComponentType<unknown> })));
import { canMove } from "../../engines/tableau/moves.js";
const settings = { _dummy: { kind: "boolean" as const, label: "_", default: false } } as const;
type S = SettingsOf<typeof settings>;
export const alaskaPatPlugin: GamePlugin<AlaskaPatState, AlaskaPatAction, typeof settings> = {
  id: "alaska-pat",
  title: "Alaska Patience",
  category: "solitaire",
