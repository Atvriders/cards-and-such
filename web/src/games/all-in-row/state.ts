...
export interface AllInRowSettings { dummy: boolean; }

export interface AllInRowState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: AllInRowSettings): AllInRowState {
...
export function reducer(state: AllInRowState, action: AllInRowAction): AllInRowState {
...
export function isTerminal(state: AllInRowState): { score: number } | null {
