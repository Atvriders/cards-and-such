...
export interface CrewDeepSeaCoopSettings { dummy: boolean; }
export interface CrewDeepSeaCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type CrewDeepSeaCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: CrewDeepSeaCoopSettings): CrewDeepSeaCoopState {
