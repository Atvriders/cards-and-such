...
export const PUZZLES: Puzzle[] = [
  { prompt: "From CAT", choices: ["DOG", "BAT", "FISH", "BIRD"], correctIndex: 1 },
  { prompt: "From STAR", choices: ["MOON", "STAB", "PLAY", "BREAD"], correctIndex: 1 },
  { prompt: "From SHIP", choices: ["BOAT", "SHOP", "HOUSE", "TRAIN"], correctIndex: 1 },
  { prompt: "From MILK", choices: ["BREAD", "MILD", "JUICE", "WATER"], correctIndex: 1 },
  { prompt: "From WARM", choices: ["COLD", "WARN", "HOT", "ICE"], correctIndex: 1 },
  { prompt: "From COLD", choices: ["HEAT", "COLT", "FIRE", "ICE"], correctIndex: 1 },
  { prompt: "From BIRD", choices: ["FROG", "BIRT", "FISH", "WOLF"], correctIndex: 1 },
  { prompt: "From WORD", choices: ["BOOK", "WORE", "PAGE", "PEN"], correctIndex: 1 },
  { prompt: "From LOVE", choices: ["HATE", "DOVE", "LIKE", "WANT"], correctIndex: 1 },
  { prompt: "From DOOR", choices: ["WALL", "DEER", "DOOM", "HOLE"], correctIndex: 2 },
];
