...
export interface StalactitesSettings { dummy: boolean; }

export interface StalactitesState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: StalactitesState, action: StalactitesAction): StalactitesState {
...
export function isTerminal(state: StalactitesState): { score: number } | null {
