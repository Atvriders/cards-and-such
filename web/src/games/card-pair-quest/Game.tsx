...
import "./Game.css";
export function CardPairQuestGame({ state, dispatch, onGameOver }: GameProps<CardPairQuestState, CardPairQuestSettings>): JSX.Element {
  ...
  return (
    <div className="cm-wrap">
      ...
      <button data-testid="hint-target-card-pair-quest-primary" className="cm-btn" onClick={() => dispatch({ type:"draw" } as CardPairQuestAction)}>Draw</button>
    </div>
  );
}
