...
import type { HairstylesQuizState, HairstylesQuizAction, HairstylesQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./Game.css";

export function HairstylesQuiz({
  state,
  dispatch,
  onGameOver,
}: GameProps<HairstylesQuizState, HairstylesQuizSettings>): JSX.Element {
    ...
    <div className="qz-wrap">
      ...
      {!state.done && entry ? (
        <>
            ...
            {entry.choices.map((choice, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => dispatch({ type: "select", index: i } as HairstylesQuizAction)}
                >
                  {choice}
                </button>
              );
          ...
          {state.selected !== null && (
            <button className="qz-next" onClick={() => dispatch({ type: "next" } as HairstylesQuizAction)}>
