...
const DvonnAbsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DvonnAbsGame as unknown as React.ComponentType<unknown> })));
...
export const dvonnAbsPlugin: GamePlugin<DvonnAbsState, DvonnAbsAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: DvonnAbsState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-dvonn-abs-answer-0"]', pulses: 3 } : null, component:DvonnAbsGame,
};
