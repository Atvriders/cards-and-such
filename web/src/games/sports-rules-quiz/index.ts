...
const SportsRulesQuiz = /* @__PURE__ */ lazy(() => import("./SportsRulesQuiz.js").then((mod) => ({ default: mod.SportsRulesQuiz as unknown as React.ComponentType<unknown> })));
...
export const sportsRulesQuizPlugin: GamePlugin<SportsRulesQuizState, SportsRulesQuizAction, typeof sportsRulesQuizSettings> = {
  ...
  reducer, isTerminal,
  hint: (state: SportsRulesQuizState): HintTarget | null => !state.done ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component: SportsRulesQuiz,
};
