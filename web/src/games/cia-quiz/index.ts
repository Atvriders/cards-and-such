...
const CiaQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CiaQuizGame as unknown as React.ComponentType<unknown> })));
...
export const ciaQuizPlugin: GamePlugin<CiaQuizState, CiaQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CiaQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CiaQuizGame,
};
