...
export interface SorcererCityBuildSettings { dummy: boolean; }
export interface SorcererCityBuildState {
  rngSeed: number;
  round: number;
  hand: number[];
  lastPts: number;
...
export type SorcererCityBuildAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: SorcererCityBuildSettings): SorcererCityBuildState {
