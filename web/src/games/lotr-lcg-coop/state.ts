...
export interface LotrLcgCoopSettings { dummy: boolean; }
export interface LotrLcgCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type LotrLcgCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: LotrLcgCoopSettings): LotrLcgCoopState {
