...
import { LotrLcgCoop_CFG, initialState, reducer, isTerminal } from "./state.js";
import { coopHintSelector } from "../_shared/coop-engine.js";
const LotrLcgCoopGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LotrLcgCoopGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const lotrLcgCoopPlugin: GamePlugin<LotrLcgCoopState, LotrLcgCoopAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: LotrLcgCoopState): HintTarget | null => {
    const sel = coopHintSelector(state, LotrLcgCoop_CFG);
