...
export interface BlackjackSwitchCasState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type BlackjackSwitchCasAction = { type: "play" } | { type: "next" };
