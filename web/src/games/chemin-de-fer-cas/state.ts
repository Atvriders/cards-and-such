...
export interface CheminDeFerCasSettings { dummy: boolean; }
export interface CheminDeFerCasState { rngSeed: number; round: number; you: number[]; cpu: number[]; phase: "see" | "scored" | "done"; score: number; pts: number; result: string; }
export type CheminDeFerCasAction = { type: "play" } | { type: "fold" } | { type: "next" };
...
export function initialState(seed: number, _s: CheminDeFerCasSettings): CheminDeFerCasState {
...
export function reducer(state: CheminDeFerCasState, action: CheminDeFerCasAction): CheminDeFerCasState {
...
export function isTerminal(state: CheminDeFerCasState): { score: number } | null {
