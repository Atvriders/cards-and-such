...
export interface MariaSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: MariaSettings): MariaState {
...
export function reducer(state: MariaState, action: MariaAction): MariaState {
...
export function isTerminal(state: MariaState): { score: number } | null {
