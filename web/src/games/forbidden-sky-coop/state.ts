...
export interface ForbiddenSkyCoopSettings { dummy: boolean; }
export interface ForbiddenSkyCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type ForbiddenSkyCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: ForbiddenSkyCoopSettings): ForbiddenSkyCoopState {
