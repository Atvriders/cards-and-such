...
const KingdominoBaseGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KingdominoBaseGame as unknown as React.ComponentType<unknown> })));
