...
export function SevenTwentySevenShedGame({ state, dispatch, onGameOver }: GameProps<SevenTwentySevenShedState, SevenTwentySevenShedSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="dm-wrap"><h3>Seven-Twenty-Seven</h3><div className="dm-done"><h2>Done!</h2><div>W: {state.wins} L: {state.losses}</div><div className="dm-final">{state.score} pts</div></div></div>;
  return (
