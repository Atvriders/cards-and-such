...
export interface FridayIslandSurvivalSettings { dummy: boolean; }
export interface FridayIslandSurvivalState {
  rngSeed: number;
  round: number;
  you: number[];
  foe: number[];
...
export type FridayIslandSurvivalAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: FridayIslandSurvivalSettings): FridayIslandSurvivalState {
...
export function reducer(state: FridayIslandSurvivalState, action: FridayIslandSurvivalAction): FridayIslandSurvivalState {
...
export function isTerminal(state: FridayIslandSurvivalState): { score: number } | null {
