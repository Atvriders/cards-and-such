...
const PrinceQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PrinceQuizGame as unknown as React.ComponentType<unknown> })));
...
export const princeQuizPlugin: GamePlugin<PrinceQuizState, PrinceQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: PrinceQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:PrinceQuizGame,
};
