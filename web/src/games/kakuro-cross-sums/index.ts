...
const KakuroCrossSumsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KakuroCrossSumsGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
export const kakuroCrossSumsPlugin: GamePlugin<KakuroCrossSumsState, KakuroCrossSumsAction, typeof settings> = {
