...
const ReptileCareQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ReptileCareQuizGame as unknown as React.ComponentType<unknown> })));
...
export const reptileCareQuizPlugin: GamePlugin<ReptileCareQuizState, ReptileCareQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ReptileCareQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ReptileCareQuizGame,
};
