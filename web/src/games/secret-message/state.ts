...
export const PUZZLES: Puzzle[] = [
  { prompt: "IFMMP (shift +1)", choices: ["HELLO", "WORLD", "BREAD", "MAGIC"], correctIndex: 0 },
  { prompt: "XPSME (shift +1)", choices: ["HELLO", "WORLD", "BREAD", "MAGIC"], correctIndex: 1 },
  { prompt: "DBU (shift +1)", choices: ["DOG", "CAT", "RAT", "BAT"], correctIndex: 1 },
  { prompt: "TVO (shift +1)", choices: ["MOON", "SUN", "SKY", "STAR"], correctIndex: 1 },
  { prompt: "MJWF (shift +1)", choices: ["LIVE", "LOVE", "LIKE", "LATE"], correctIndex: 0 },
  { prompt: "QFBDF (shift +1)", choices: ["PIZZA", "PEACE", "PRESS", "PRIZE"], correctIndex: 1 },
  { prompt: "CSBWF (shift +1)", choices: ["BRAVO", "BRAVE", "BREAK", "BRACE"], correctIndex: 1 },
  { prompt: "GBTU (shift +1)", choices: ["FAST", "FATE", "FACT", "FAME"], correctIndex: 0 },
  { prompt: "TLZ (shift +1)", choices: ["SUN", "SKY", "STO", "SOS"], correctIndex: 1 },
  { prompt: "QMBZ (shift +1)", choices: ["PLAY", "PLOT", "PROP", "POLL"], correctIndex: 0 },
];
