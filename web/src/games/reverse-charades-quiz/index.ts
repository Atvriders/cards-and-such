...
const ReverseCharadesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ReverseCharadesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const reverseCharadesQuizPlugin: GamePlugin<ReverseCharadesQuizState, ReverseCharadesQuizAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: ReverseCharadesQuizState): HintTarget | null => state.phase === "ask" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
