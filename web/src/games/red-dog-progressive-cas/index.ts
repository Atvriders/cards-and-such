...
const hint = (state: RedDogProgressiveCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-red-dog-progressive-cas-primary"]', pulses: 3 } : null);
export const redDogProgressiveCasPlugin: GamePlugin<RedDogProgressiveCasState, RedDogProgressiveCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: RedDogProgressiveCasGame,
};
