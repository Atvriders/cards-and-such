...
export type CirullaState = HuTrickState;
export type CirullaAction = HuTrickAction;
export interface CirullaSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: CirullaSettings): CirullaState => engine.initialState(seed);
