...
const CirullaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CirullaGame as unknown as React.ComponentType<unknown> })));
...
export const cirullaPlugin: GamePlugin<CirullaState, CirullaAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: CirullaState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-cirullc-${pick.id}"]`, pulses: 3 };
    }
