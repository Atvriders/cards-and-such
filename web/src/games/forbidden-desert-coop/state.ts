...
export interface ForbiddenDesertCoopSettings { dummy: boolean; }
export interface ForbiddenDesertCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type ForbiddenDesertCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: ForbiddenDesertCoopSettings): ForbiddenDesertCoopState {
