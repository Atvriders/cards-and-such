...
const TzaarStonesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TzaarStonesGame as unknown as React.ComponentType<unknown> })));
...
export const tzaarStonesPlugin: GamePlugin<TzaarStonesState, TzaarStonesAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: TzaarStonesState): HintTarget | null => ((state.phase === "playing" && state.turn === "P") ? { selector: ".ab-cell:not(.p):not(.c)", pulses: 3 } : null), component: TzaarStonesGame,
};
