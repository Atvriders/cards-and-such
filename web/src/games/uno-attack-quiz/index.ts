...
const UnoAttackQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.UnoAttackQuizGame as unknown as React.ComponentType<unknown> })));
...
export const unoAttackQuizPlugin: GamePlugin<UnoAttackQuizState, UnoAttackQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: UnoAttackQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:UnoAttackQuizGame,
};
