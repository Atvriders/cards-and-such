...
const BrazilianDraughtsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BrazilianDraughtsGame as unknown as React.ComponentType<unknown> })));
...
export const brazilianDraughtsPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".bdg-board")) ? { selector: ".bdg-board", pulses: 3 } : null,
