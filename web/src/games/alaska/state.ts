...
export interface AlaskaSolSettings { dummy: boolean; }

export interface AlaskaSolState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: AlaskaSolSettings): AlaskaSolState {
...
export function reducer(state: AlaskaSolState, action: AlaskaSolAction): AlaskaSolState {
...
export function isTerminal(state: AlaskaSolState): { score: number } | null {
