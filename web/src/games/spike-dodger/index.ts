...
const SpikeDodgerGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SpikeDodgerGame as unknown as React.ComponentType<unknown> })));
...
export const spikeDodgerPlugin: GamePlugin<SpikeDodgerState, SpikeDodgerAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: SpikeDodgerState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-spike-dodger-primary"]', pulses: 3 } : null,component:SpikeDodgerGame,
};
