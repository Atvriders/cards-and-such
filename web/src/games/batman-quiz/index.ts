...
const BatmanQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BatmanQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. From the Adam West TV show to The Dark Knight Trilogy, see if you're truly the World's Greatest Detective.`,
  ...
  reducer,isTerminal,
  hint: (state: BatmanQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BatmanQuizGame,
};
