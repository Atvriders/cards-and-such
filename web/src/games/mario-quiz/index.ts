...
const MarioQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MarioQuizGame as unknown as React.ComponentType<unknown> })));
...
export const marioQuizPlugin: GamePlugin<MarioState, MarioAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MarioState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MarioQuizGame,
};
