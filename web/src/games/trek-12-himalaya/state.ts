...
export interface Trek12HimalayaSettings { dummy: boolean; }
export interface Trek12HimalayaState {
  rngSeed: number;
  cells: boolean[];
...
export type Trek12HimalayaAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: Trek12HimalayaSettings): Trek12HimalayaState {
  return {
    rngSeed: seed,
...
export function reducer(state: Trek12HimalayaState, action: Trek12HimalayaAction): Trek12HimalayaState {
...
export function isTerminal(state: Trek12HimalayaState): { score: number } | null {
