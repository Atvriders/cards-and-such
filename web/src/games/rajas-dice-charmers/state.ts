...
export interface RajasDiceCharmersSettings { dummy: boolean; }
...
export type RajasDiceCharmersAction =
  | { type: "roll" }
...
export function initialState(seed: number, _s: RajasDiceCharmersSettings): RajasDiceCharmersState {
  return {
    rngSeed: seed >>> 0,
