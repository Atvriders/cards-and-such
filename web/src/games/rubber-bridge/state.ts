...
export type RubberBridgeState = HuTrickState;
export type RubberBridgeAction = HuTrickAction;
...
export const initialState = (seed: number, _s: RubberBridgeSettings): RubberBridgeState => engine.initialState(seed);
