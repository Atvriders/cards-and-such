...
export interface AlaskaSolitaireSettings { dummy: boolean; }

export interface AlaskaSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type AlaskaSolitaireAction =
  | { type: "keep" }
...
export function reducer(state: AlaskaSolitaireState, action: AlaskaSolitaireAction): AlaskaSolitaireState {
...
export function isTerminal(state: AlaskaSolitaireState): { score: number } | null {
