...
const AlaskaSolitaireGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AlaskaSolitaireGame as unknown as React.ComponentType<unknown> })));
...
export const alaskaSolitairePlugin: GamePlugin<AlaskaSolitaireState, AlaskaSolitaireAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as AlaskaSolitaireSettings),
  reducer,
  isTerminal,
  hint: (state: AlaskaSolitaireState): HintTarget | null => {
