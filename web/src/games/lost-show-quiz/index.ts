...
const LostShowQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LostShowQuizGame as unknown as React.ComponentType<unknown> })));
...
export const lostShowQuizPlugin: GamePlugin<LostShowState, LostShowAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: LostShowState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:LostShowQuizGame,
};
