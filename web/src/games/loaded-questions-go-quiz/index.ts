...
export const loaded_questions_go_quiz_plugin: GamePlugin<LoadedQuestionsGoQuizState, LoadedQuestionsGoQuizAction, typeof settings> = {
...
export default loaded_questions_go_quiz_plugin;
