...
export interface MidnightOilSettings { dummy: boolean; }

export interface MidnightOilState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: MidnightOilSettings): MidnightOilState {
...
export function reducer(state: MidnightOilState, action: MidnightOilAction): MidnightOilState {
...
export function isTerminal(state: MidnightOilState): { score: number } | null {
