...
const MiniEmperorGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MiniEmperorGame as unknown as React.ComponentType<unknown> })));
...
export const miniEmperorPlugin: GamePlugin<MiniEmperorState, MiniEmperorAction, typeof settings> = {
  ...
  hint: (state: MiniEmperorState): HintTarget | null => {
    ...
    const TABLEAU_IDS = ["t1","t2","t3","t4","t5"];
