...
const ApiaryBeesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ApiaryBeesGame as unknown as React.ComponentType<unknown> })));
