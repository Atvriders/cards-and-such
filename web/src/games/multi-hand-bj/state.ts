...
export interface MultiHandBjSettings { dummy: boolean; }
export interface MultiHandBjState { rngSeed: number; round: number; you: number[]; dealer: number[]; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; yourTotal: number; dealerTotal: number; }
export type MultiHandBjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: MultiHandBjSettings): MultiHandBjState {
...
export function reducer(state: MultiHandBjState, action: MultiHandBjAction): MultiHandBjState {
...
export function isTerminal(state: MultiHandBjState): { score: number } | null {
