...
export interface StarshipCaptainsRollSettings { rounds: "10"; }

export interface StarshipCaptainsRollState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type StarshipCaptainsRollAction = { type: "roll" } | { type: "next" };
...
export function initialState(seed: number, _settings: StarshipCaptainsRollSettings): StarshipCaptainsRollState {
  return {
    rngSeed: seed >>> 0,
    score: 0,
    round: 1,
...
export function reducer(state: StarshipCaptainsRollState, action: StarshipCaptainsRollAction): StarshipCaptainsRollState {
...
export function isTerminal(state: StarshipCaptainsRollState): { score: number } | null {
