...
type StarshipCaptainsRollSettingsT = StarshipCaptainsRollState["" extends "" ? "rngSeed" : never];

export function StarshipCaptainsRoll({ state, dispatch, onGameOver }: GameProps<StarshipCaptainsRollState, { rounds: "10" }>): JSX.Element {
