...
export interface WindokuPlusMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: WindokuPlusMiniSettings;
}

export type WindokuPlusMiniAction =
...
export function initialState(seed: number, settings: WindokuPlusMiniSettings): WindokuPlusMiniState {
...
export function reducer(state: WindokuPlusMiniState, action: WindokuPlusMiniAction): WindokuPlusMiniState {
