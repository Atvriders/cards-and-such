...
const TridokuMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TridokuMiniGame as unknown as React.ComponentType<unknown> })));
...
export const tridokuMiniPlugin: GamePlugin<TridokuMiniState, TridokuMiniStateAction, typeof settings> = {
  ...
  hint: (state: TridokuMiniState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-tridoku-mini-answer-0"]', pulses: 3 } : null,component: TridokuMiniGame,
};
