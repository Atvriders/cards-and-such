...
const WingspanEuropeanDraftGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WingspanEuropeanDraftGame as unknown as React.ComponentType<unknown> })));
