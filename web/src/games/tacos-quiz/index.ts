...
const TacosQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TacosQuizGame as unknown as React.ComponentType<unknown> })));
...
export const tacosQuizPlugin: GamePlugin<TacosQuizState, TacosQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TacosQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TacosQuizGame,
};
