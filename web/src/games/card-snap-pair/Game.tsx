...
export function CardSnapPairGame({ state, dispatch, onGameOver }: GameProps<CardSnapPairState, CardSnapPairSettings>): JSX.Element {
  ...
  return (
    <div className="cm-wrap">
      ...
      {state.phase === "waiting" && <><p>Snap two cards — if they match rank, score 20! Otherwise 5.</p><button data-testid="hint-target-card-snap-pair-primary" className="cm-btn" onClick={() => dispatch({ type:"snap" } as CardSnapPairAction)}>Snap!</button></>}
