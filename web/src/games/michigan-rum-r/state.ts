...
export interface MichiganRumRSettings { dummy: boolean; }
export interface MichiganRumRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type MichiganRumRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: MichiganRumRSettings): MichiganRumRState {
...
export function reducer(state: MichiganRumRState, action: MichiganRumRAction): MichiganRumRState {
...
export function isTerminal(state: MichiganRumRState): { score: number } | null {
