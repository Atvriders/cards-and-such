...
const SecretNumber = /* @__PURE__ */ lazy(() => import("./SecretNumber.js").then((mod) => ({ default: mod.SecretNumber as unknown as React.ComponentType<unknown> })));
...
Scoring: win score = (remaining attempts + 1) × 100. Failure scores 0.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".sn-submit", pulses: 3 }; },
