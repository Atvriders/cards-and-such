...
export interface MarvelChampionsHeroSettings { dummy: boolean; }
export interface MarvelChampionsHeroState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type MarvelChampionsHeroAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: MarvelChampionsHeroSettings): MarvelChampionsHeroState {
