...
const FigureSkatingQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FigureSkatingQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. Glide your way to a high score and impress your inner ice ice baby!`,
  ...
  reducer,isTerminal,
  hint: (state: FigureSkatingQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:FigureSkatingQuizGame,
};
