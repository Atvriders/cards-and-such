...
export interface ZodiacSettings { dummy: boolean; }
...
export function reducer(state: ZodiacState, action: ZodiacAction): ZodiacState {
...
export function isTerminal(state: ZodiacState): { score: number } | null {
