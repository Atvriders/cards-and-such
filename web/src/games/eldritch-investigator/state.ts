...
export interface EldritchInvestigatorSettings { dummy: boolean; }
export interface EldritchInvestigatorState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type EldritchInvestigatorAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: EldritchInvestigatorSettings): EldritchInvestigatorState {
