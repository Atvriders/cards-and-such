...
export interface SirTommySettings { dummy: boolean; }

export interface SirTommyState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: SirTommySettings): SirTommyState {
...
export function reducer(state: SirTommyState, action: SirTommyAction): SirTommyState {
...
export function isTerminal(state: SirTommyState): { score: number } | null {
