...
export function ForTheCrownSagaGame({ state, dispatch, onGameOver }: GameProps<ForTheCrownSagaState, ForTheCrownSagaSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="ftc-wrap"><div className="ftc-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
