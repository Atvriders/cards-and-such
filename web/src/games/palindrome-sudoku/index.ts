...
const PalindromeSudokuGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PalindromeSudokuGame as unknown as React.ComponentType<unknown> })));
...
export const palindromeSudokuPlugin: GamePlugin<PalindromeSudokuState, PalindromeSudokuAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".palindromemirror-num", pulses: 3 }; },
