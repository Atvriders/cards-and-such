...
export interface PalindromeSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: PalindromeSudokuSettings;
}

export type PalindromeSudokuAction =
...
export function initialState(seed: number, settings: PalindromeSudokuSettings): PalindromeSudokuState {
