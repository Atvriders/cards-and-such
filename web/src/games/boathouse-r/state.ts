...
export interface BoathouseRSettings { dummy: boolean; }
export interface BoathouseRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type BoathouseRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: BoathouseRSettings): BoathouseRState {
...
export function reducer(state: BoathouseRState, action: BoathouseRAction): BoathouseRState {
...
export function isTerminal(state: BoathouseRState): { score: number } | null {
