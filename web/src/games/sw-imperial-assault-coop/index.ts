...
const swImperialAssaultCoopGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.swImperialAssaultCoopGame as unknown as React.ComponentType<unknown> })));
...
export const swImperialAssaultCoopPlugin: GamePlugin<swImperialAssaultCoopState, swImperialAssaultCoopAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: swImperialAssaultCoopState): HintTarget | null => ((state.phase === "ready" || state.phase === "rolled") ? { selector: ".coop-btn", pulses: 3 } : null), component: swImperialAssaultCoopGame,
};
