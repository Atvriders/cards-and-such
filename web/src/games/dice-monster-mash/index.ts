...
const DiceMonsterMashGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceMonsterMashGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind:"boolean" as const, label:"dummy", default:false } } as const;
type S = SettingsOf<typeof settings>;
export const diceMonsterMashPlugin: GamePlugin<DiceMonsterMashState, DiceMonsterMashAction, typeof settings> = {
  id:"dice-monster-mash", title:"Dice Monster Mash", category:"dice",
  players:{ min:1, max:1, multiplayer:false },
  description:"Battle monsters. Doubles deal extra damage.",
