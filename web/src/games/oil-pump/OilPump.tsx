...
import type { OilPumpState, OilPumpSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./OilPump.css";
export function OilPump({ state, dispatch, onGameOver }:GameProps<OilPumpState,OilPumpSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-oil-pump-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
