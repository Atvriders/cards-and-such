...
export const PUZZLES: Puzzle[] = [
  { prompt: "Fragment 'CA' — safe letter?", choices: ["T", "P", "R", "X"], correctIndex: 3 },
  { prompt: "Fragment 'BR' — safe letter?", choices: ["A", "I", "E", "Z"], correctIndex: 3 },
  { prompt: "Fragment 'PL' — safe letter?", choices: ["A", "Y", "U", "Q"], correctIndex: 3 },
  { prompt: "Fragment 'TH' — safe letter?", choices: ["E", "I", "A", "X"], correctIndex: 3 },
  { prompt: "Fragment 'ST' — safe letter?", choices: ["A", "E", "I", "X"], correctIndex: 3 },
  { prompt: "Fragment 'CR' — safe letter?", choices: ["A", "E", "I", "Z"], correctIndex: 3 },
  { prompt: "Fragment 'GR' — safe letter?", choices: ["A", "E", "I", "X"], correctIndex: 3 },
  { prompt: "Fragment 'TR' — safe letter?", choices: ["A", "Y", "U", "Q"], correctIndex: 3 },
  { prompt: "Fragment 'CL' — safe letter?", choices: ["A", "U", "O", "X"], correctIndex: 3 },
  { prompt: "Fragment 'SP' — safe letter?", choices: ["I", "A", "Y", "Z"], correctIndex: 3 },
];
