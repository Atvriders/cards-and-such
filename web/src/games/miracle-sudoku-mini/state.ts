...
export interface MiracleSudokuMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: MiracleSudokuMiniSettings;
}

export type MiracleSudokuMiniAction =
...
export function initialState(seed: number, settings: MiracleSudokuMiniSettings): MiracleSudokuMiniState {
