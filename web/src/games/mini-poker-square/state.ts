...
export const INITIAL_FLIP = 25;
export const MAX_CLICKS = 30;

export interface MiniPokerSquareSettings { dummy: boolean; }

export interface MiniPokerSquareState {
  rngSeed: number;
...
export type MiniPokerSquareAction = { type: "remove"; index: number } | { type: "noop" };
...
export function initialState(seed: number, _settings: MiniPokerSquareSettings): MiniPokerSquareState {
...
export function reducer(state: MiniPokerSquareState, action: MiniPokerSquareAction): MiniPokerSquareState {
...
export function isTerminal(state: MiniPokerSquareState): { score: number } | null {
