...
export function QuillGothicLettersGame({ state, dispatch, onGameOver }: GameProps<QuillGothicLettersState, QuillGothicLettersSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="qlg-wrap"><div className="qlg-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
