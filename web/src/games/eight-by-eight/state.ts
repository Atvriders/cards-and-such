...
export interface EightByEightSettings { dummy: boolean; }

export interface EightByEightState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type EightByEightAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: EightByEightSettings): EightByEightState {
...
export function reducer(state: EightByEightState, action: EightByEightAction): EightByEightState {
...
export function isTerminal(state: EightByEightState): { score: number } | null {
