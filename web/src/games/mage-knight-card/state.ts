...
export interface MageKnightCardSettings { dummy: boolean; }
export interface MageKnightCardState {
  rngSeed: number;
  round: number;
  hand: number[];
  lastPts: number;
...
export type MageKnightCardAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: MageKnightCardSettings): MageKnightCardState {
