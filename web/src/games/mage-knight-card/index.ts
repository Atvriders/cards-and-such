...
import { MageKnightCard_CFG, initialState, reducer, isTerminal } from "./state.js";
import { coopHintSelector } from "../_shared/coop-engine.js";
const MageKnightCardGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MageKnightCardGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const mageKnightCardPlugin: GamePlugin<MageKnightCardState, MageKnightCardAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: MageKnightCardState): HintTarget | null => {
    const sel = coopHintSelector(state, MageKnightCard_CFG);
