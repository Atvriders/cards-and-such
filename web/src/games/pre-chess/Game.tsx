    ...
    <div className="prech-wrap">
      ...
      <div className="prech-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as PreChessAction)}><span className="prech-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
