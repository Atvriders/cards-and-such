...
const BreakingBadQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BreakingBadQuizGame as unknown as React.ComponentType<unknown> })));
...
export const breakingBadQuizPlugin: GamePlugin<BreakingBadState, BreakingBadAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BreakingBadState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BreakingBadQuizGame,
};
