...
export type VoliMariasState = HuTrickState;
export type VoliMariasAction = HuTrickAction;
export interface VoliMariasSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: VoliMariasSettings): VoliMariasState => engine.initialState(seed);
