...
import type { ReligionsSymbolsQuizState, ReligionsSymbolsQuizAction, ReligionsSymbolsQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./Game.css";

export function ReligionsSymbolsQuiz({
  state,
  dispatch,
  onGameOver,
}: GameProps<ReligionsSymbolsQuizState, ReligionsSymbolsQuizSettings>): JSX.Element {
    ...
    <div className="qz-wrap">
      ...
      {!state.done && entry ? (
        <>
          ...
          {state.selected !== null && (
            <button className="qz-next" onClick={() => dispatch({ type: "next" } as ReligionsSymbolsQuizAction)}>
