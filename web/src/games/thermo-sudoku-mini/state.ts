...
export interface ThermoSudokuMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: ThermoSudokuMiniSettings;
}

export type ThermoSudokuMiniAction =
...
export function initialState(seed: number, settings: ThermoSudokuMiniSettings): ThermoSudokuMiniState {
