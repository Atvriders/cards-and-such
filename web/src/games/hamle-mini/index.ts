...
const HamleMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HamleMiniGame as unknown as React.ComponentType<unknown> })));
...
export const hamleMiniPlugin: GamePlugin<HamleMiniState, HamleMiniAction, typeof settings> = {
  ...
  hint: (state: HamleMiniState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-hamle-mini-answer-0"]', pulses: 3 } : null,component: HamleMiniGame,
};
