    ...
    <div className="cylch-wrap">
      ...
      <div className="cylch-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as CylinderChessAction)}><span className="cylch-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
