...
import type { LeafRakeState, LeafRakeSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./LeafRake.css";
export function LeafRake({ state, dispatch, onGameOver }:GameProps<LeafRakeState,LeafRakeSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-leaf-rake-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
