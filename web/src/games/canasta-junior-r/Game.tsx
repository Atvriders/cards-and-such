...
import "./Game.css";
export function CanastaJuniorRGame({ state, dispatch, onGameOver }: GameProps<GState, object>): JSX.Element {
  const t = isTerminal(state); useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  if (state.phase === "done") return <div className="cjrr-wrap"><div className="cjrr-done"><h2>Done!</h2><div className="cjrr-final">{state.score} pts</div></div></div>;
  return (
    <div className="cjrr-wrap">
