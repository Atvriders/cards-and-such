...
export type SchieberJassState = HuTrickState;
export type SchieberJassAction = HuTrickAction;
export interface SchieberJassSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: SchieberJassSettings): SchieberJassState => engine.initialState(seed);
