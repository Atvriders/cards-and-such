...
export const japaneseSnapPlugin: GamePlugin<JapaneseSnapState, JapaneseSnapAction, typeof settings> = {
  id:"japanese-snap-quiz", title:"Japanese Snap Quiz", category:"board",
  players:{ min:1, max:1, multiplayer:false },
  description:"Test your knowledge of the Japanese card-snap game similar to Speed.",
  howToPlay:"Japanese Snap is a fast-paced Japanese card game similar to Speed and Slapjack. Players race to slap matching cards as they appear, with the fastest hand winning the cards. It is a popular party game across all ages.\n\nThis is a 10-question multiple-choice quiz. Each question gives you 15 seconds to answer. Tap one of the four choices, then press Submit to lock in your answer. You earn 100 base points for every correct answer plus 10 points for each second remaining on the clock — quick correct answers are worth far more than slow ones. Wrong answers earn nothing.\n\nAfter you submit, the correct answer is revealed: green for correct, red for wrong. Press Next to continue. The game ends after all 10 questions.",
  settings,
  initialState:(seed:number,s:S)=>initialState(seed,s as JapaneseSnapSettings),
  reducer,isTerminal,
  hint: (state: JapaneseSnapState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:JapaneseSnapGame,
};
