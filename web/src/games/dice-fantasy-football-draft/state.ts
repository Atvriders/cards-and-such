...
export type DiceFantasyFootballDraftStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceFantasyFootballDraftState, action: DiceFantasyFootballDraftStateAction): DiceFantasyFootballDraftState {
