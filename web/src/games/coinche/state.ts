...
export type CoincheState = HuTrickState;
export type CoincheAction = HuTrickAction;
export interface CoincheSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: CoincheSettings): CoincheState => engine.initialState(seed);
