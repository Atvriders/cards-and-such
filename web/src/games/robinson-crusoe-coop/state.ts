...
export interface RobinsonCrusoeCoopSettings { dummy: boolean; }
export interface RobinsonCrusoeCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type RobinsonCrusoeCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: RobinsonCrusoeCoopSettings): RobinsonCrusoeCoopState {
