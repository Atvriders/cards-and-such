...
const StonewallGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.StonewallGame as unknown as React.ComponentType<unknown> })));
...
export const stonewallPlugin: GamePlugin<StonewallState, StonewallAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as StonewallSettings),
  reducer,
  isTerminal,
  hint: (state: StonewallState): HintTarget | null => {
