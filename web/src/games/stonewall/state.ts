...
export interface StonewallSettings { dummy: boolean; }
...
export function reducer(state: StonewallState, action: StonewallAction): StonewallState {
...
export function isTerminal(state: StonewallState): { score: number } | null {
