...
const TaiwaneseMahjongGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TaiwaneseMahjongGame as unknown as React.ComponentType<unknown> })));
...
export const taiwaneseMahjongPlugin: GamePlugin<TaiwaneseMahjongState, TaiwaneseMahjongAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: TaiwaneseMahjongState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TaiwaneseMahjongGame,
};
