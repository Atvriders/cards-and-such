...
export type DiceStratHockeyAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceStratHockeyState, action: DiceStratHockeyAction): DiceStratHockeyState {
  ...
  if (action.type === "roll") {
    ...
    let pts = 0;
    let logEntry = "";
    let extra: Partial<DiceStratHockeyState> = {};
