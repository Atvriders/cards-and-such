    ...
    <div className="cm-wrap">
      ...
      {state.phase === "betting" ? (
        <div className="cm-bid-row">
          ...
          <button data-testid="hint-target-card-deck-bet-primary" className="cm-btn" onClick={() => dispatch({ type:"bet", amount:bid, dir:"higher" } as CardDeckBetAction)}>Higher</button>
