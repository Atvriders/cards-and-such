...
const CardFanGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardFanGame as unknown as React.ComponentType<unknown> })));
...
export const cardFanPlugin: GamePlugin<CardFanState, CardFanAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-fan-primary"]', pulses: 3 }), component:CardFanGame,
};
