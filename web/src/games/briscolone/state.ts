...
export type BriscoloneState = HuTrickState;
export type BriscoloneAction = HuTrickAction;
export interface BriscoloneSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: BriscoloneSettings): BriscoloneState => engine.initialState(seed);
