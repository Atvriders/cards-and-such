...
export interface CanfieldChameleonSettings { dummy: boolean; }

export interface CanfieldChameleonState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type CanfieldChameleonAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: CanfieldChameleonSettings): CanfieldChameleonState {
...
export function reducer(state: CanfieldChameleonState, action: CanfieldChameleonAction): CanfieldChameleonState {
...
export function isTerminal(state: CanfieldChameleonState): { score: number } | null {
