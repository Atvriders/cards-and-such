...
import type { SnacksQuizState, SnacksQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./SnacksQuiz.css";

export function SnacksQuiz({ state, dispatch, onGameOver }: GameProps<SnacksQuizState, SnacksQuizSettings>): JSX.Element {
