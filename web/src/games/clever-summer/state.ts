...
export interface CleverSummerSettings { dummy: boolean; }
export interface CleverSummerState {
  rngSeed: number;
...
export type CleverSummerAction =
  | { type: "roll" }
...
export function initialState(seed: number, _s: CleverSummerSettings): CleverSummerState {
  return {
    rngSeed: seed >>> 0,
...
export function reducer(state: CleverSummerState, action: CleverSummerAction): CleverSummerState {
...
export function isTerminal(state: CleverSummerState): { score: number } | null {
