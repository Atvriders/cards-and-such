...
export interface HerringBoneSettings { dummy: boolean; }

export interface HerringBoneState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: HerringBoneSettings): HerringBoneState {
...
export function reducer(state: HerringBoneState, action: HerringBoneAction): HerringBoneState {
...
export function isTerminal(state: HerringBoneState): { score: number } | null {
