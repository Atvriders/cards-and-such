...
export type DiceCurlingStonesStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceCurlingStonesState, action: DiceCurlingStonesStateAction): DiceCurlingStonesState {
