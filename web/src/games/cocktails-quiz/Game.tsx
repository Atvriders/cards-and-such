...
import type { CocktailsQuizState, CocktailsQuizAction, CocktailsQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./Game.css";

export function CocktailsQuiz({
  state,
  dispatch,
  onGameOver,
}: GameProps<CocktailsQuizState, CocktailsQuizSettings>): JSX.Element {
    ...
    <div className="qz-wrap">
      ...
      {!state.done && entry ? (
        <>
            ...
            {entry.choices.map((choice, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => dispatch({ type: "select", index: i } as CocktailsQuizAction)}
                >
                  {choice}
                </button>
              );
          ...
          {state.selected !== null && (
            <button className="qz-next" onClick={() => dispatch({ type: "next" } as CocktailsQuizAction)}>
