...
export function DraftosaurusMini({ state, dispatch, onGameOver }: GameProps<DraftosaurusMiniState, { mode: "easy" }>): JSX.Element {
      ...
      <div className="g-grid">
        {state.board.map((c, i) => (
          <div
            ...
            onClick={() => c === "" && dispatch({ type: "play", index: i } as DraftosaurusMiniAction)}
          >
            {c}
          </div>
        ))}
