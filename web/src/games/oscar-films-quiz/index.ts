...
const OscarFilmsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OscarFilmsQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10, 20, or 30 questions in Settings. Whether you're a casual moviegoer or a dedicated cinephile, lights, camera, action!`,
  ...
  reducer,isTerminal,
  hint: (state: OscarFilmsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:OscarFilmsQuizGame,
};
