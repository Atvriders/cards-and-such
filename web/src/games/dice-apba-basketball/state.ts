...
export type DiceApbaBasketballStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceApbaBasketballState, action: DiceApbaBasketballStateAction): DiceApbaBasketballState {
