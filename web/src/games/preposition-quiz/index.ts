...
const PrepositionQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PrepositionQuizGame as unknown as React.ComponentType<unknown> })));
...
export const prepositionQuizPlugin: GamePlugin<PrepositionQuizState, PrepositionQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: PrepositionQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:PrepositionQuizGame,
};
