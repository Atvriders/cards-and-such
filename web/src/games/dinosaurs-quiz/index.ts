...
const DinosaursQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DinosaursQuizGame as unknown as React.ComponentType<unknown> })));
...
export const dinosaursQuizPlugin: GamePlugin<DinosaursQuizState, DinosaursQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: DinosaursQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:DinosaursQuizGame,
};
