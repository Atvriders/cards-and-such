...
const CardTempleGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardTempleGame as unknown as React.ComponentType<unknown> })));
...
export const cardTemplePlugin: GamePlugin<CardTempleState, CardTempleAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-temple-primary"]', pulses: 3 }), component:CardTempleGame,
};
