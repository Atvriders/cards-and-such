...
const CruiseShipsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CruiseShipsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const cruiseShipsQuizPlugin: GamePlugin<CruiseShipsQuizState, CruiseShipsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CruiseShipsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CruiseShipsQuizGame,
};
