...
You play White; the bot plays Black. Easy = depth 2, Medium = depth 3, Hard = depth 4.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".suicide-promotion-btn", pulses: 3 }; },
