...
const PursuitMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PursuitMiniGame as unknown as React.ComponentType<unknown> })));
...
There is no fail state — the game always finishes. Aim to think before answering. Most questions are common-sense practical philosophy rather than trick questions.`,
  ...
  reducer,
  isTerminal, hint: (state: PursuitState): HintTarget | null => (state.phase === "rolling" ? { selector: '[data-testid="hint-target-pursuit-mini-primary"]', pulses: 3 } : null),
