...
export interface ConsecutivePairsSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: ConsecutivePairsSudokuSettings;
}

export type ConsecutivePairsSudokuAction =
...
export function initialState(seed: number, settings: ConsecutivePairsSudokuSettings): ConsecutivePairsSudokuState {
