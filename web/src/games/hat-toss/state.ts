...
export type HatTossAction = { type: "catch"; id: number } | { type: "tick" } | { type: "spawn" };

export function initialState(seed: number, settings: HatTossSettings): HatTossState {
...
export function reducer(state: HatTossState, action: HatTossAction): HatTossState {
...
export function isTerminal(state: HatTossState): { score: number } | null {
