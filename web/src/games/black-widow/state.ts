...
export interface BlackWidowSettings { dummy: boolean; }

export interface BlackWidowState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: BlackWidowState, action: BlackWidowAction): BlackWidowState {
...
export function isTerminal(state: BlackWidowState): { score: number } | null {
