...
const CardPharmacyMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardPharmacyMiniGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind:"boolean" as const, label:"dummy", default:false } } as const;
type S = SettingsOf<typeof settings>;
export const cardPharmacyMiniPlugin: GamePlugin<CardPharmacyMiniState, CardPharmacyMiniAction, typeof settings> = {
  id:"card-pharmacy-mini", title:"Card Pharmacy Mini", category:"cards",
  players:{ min:1, max:1, multiplayer:false },
  description:"Mini pharmacy game. Same-suit prescriptions score bonuses.",
