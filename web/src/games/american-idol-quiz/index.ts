...
const AmericanIdolQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AmericanIdolQuizGame as unknown as React.ComponentType<unknown> })));
...
export const americanIdolQuizPlugin: GamePlugin<AmericanIdolQuizState, AmericanIdolQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: AmericanIdolQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:AmericanIdolQuizGame,
};
