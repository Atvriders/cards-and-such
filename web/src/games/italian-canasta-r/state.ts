...
export interface ItalianCanastaRSettings { dummy: boolean; }
export interface ItalianCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type ItalianCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: ItalianCanastaRSettings): ItalianCanastaRState {
...
export function reducer(state: ItalianCanastaRState, action: ItalianCanastaRAction): ItalianCanastaRState {
...
export function isTerminal(state: ItalianCanastaRState): { score: number } | null {
