...
const TinyEpicWesternGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TinyEpicWesternGame as unknown as React.ComponentType<unknown> })));
...
export const tinyEpicWesternPlugin: GamePlugin<TinyEpicWesternState, TinyEpicWesternAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TinyEpicWesternState): HintTarget | null => (state.phase === "choosing" ? { selector: '[data-testid="hint-target-tiny-epic-western-mini-primary"]', pulses: 3 } : null),
