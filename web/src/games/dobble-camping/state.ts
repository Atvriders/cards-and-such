...
export function reducer(state: DobbleCampingState, action: DobbleCampingAction): DobbleCampingState {
...
export function isTerminal(state: DobbleCampingState): { score: number } | null {
