...
const CoffeeBrewingQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CoffeeBrewingQuizGame as unknown as React.ComponentType<unknown> })));
...
export const coffeeBrewingQuizPlugin: GamePlugin<CoffeeBrewingQuizState, CoffeeBrewingQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CoffeeBrewingQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CoffeeBrewingQuizGame,
};
