...
export type PinochleState = HuTrickState;
export type PinochleAction = HuTrickAction;
export interface PinochleSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: PinochleSettings): PinochleState => engine.initialState(seed);
