...
export interface TriPeaksSolitaireSettings { dummy: boolean; }

export interface TriPeaksSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type TriPeaksSolitaireAction =
  | { type: "keep" }
...
export function reducer(state: TriPeaksSolitaireState, action: TriPeaksSolitaireAction): TriPeaksSolitaireState {
...
export function isTerminal(state: TriPeaksSolitaireState): { score: number } | null {
