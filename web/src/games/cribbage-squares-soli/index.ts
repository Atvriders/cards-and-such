...
import { CribbageSquaresSoliGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: CribbageSquaresSoliState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const cribbageSquaresSoliPlugin: GamePlugin<CribbageSquaresSoliState, CribbageSquaresSoliAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: CribbageSquaresSoliGame,
};
