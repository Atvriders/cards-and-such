...
const ProgressiveChessGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ProgressiveChessGame as unknown as React.ComponentType<unknown> })));
...
The series dots in the UI track your progress through each series. Green dots = moves made, grey = remaining. You play White; the bot plays Black.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".pg-promo-btn", pulses: 3 }; },
