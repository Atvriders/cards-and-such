...
import type { OlympicEventsQuizState, OlympicEventsQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./OlympicEventsQuiz.css";
export function OlympicEventsQuiz({ state, dispatch, onGameOver }: GameProps<OlympicEventsQuizState, OlympicEventsQuizSettings>): JSX.Element {
