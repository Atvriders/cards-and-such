...
const OmokGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OmokGame as unknown as React.ComponentType<unknown> })));
...
export const omokPlugin: GamePlugin<OmokState, OmokAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: OmokState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:OmokGame,
};
