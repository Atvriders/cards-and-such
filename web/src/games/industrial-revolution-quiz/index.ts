...
const IndustrialRevolutionQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.IndustrialRevolutionQuizGame as unknown as React.ComponentType<unknown> })));
