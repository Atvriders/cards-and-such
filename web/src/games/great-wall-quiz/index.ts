...
const GreatWallQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GreatWallQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. Climb to the top of the leaderboard!`,
  ...
  reducer,isTerminal,
  hint: (state: GreatWallQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:GreatWallQuizGame,
};
