...
export interface NumberTenSettings { dummy: boolean; }

export interface NumberTenState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: NumberTenSettings): NumberTenState {
...
export function reducer(state: NumberTenState, action: NumberTenAction): NumberTenState {
...
export function isTerminal(state: NumberTenState): { score: number } | null {
