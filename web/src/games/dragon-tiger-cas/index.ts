...
const hint = (state: DragonTigerCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-dragon-tiger-cas-primary"]', pulses: 3 } : null);
export const dragonTigerCasPlugin: GamePlugin<DragonTigerCasState, DragonTigerCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: DragonTigerCasGame,
};
