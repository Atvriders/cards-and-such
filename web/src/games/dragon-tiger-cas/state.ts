...
export interface DragonTigerCasSettings { dummy: boolean; }
export interface DragonTigerCasState { rngSeed: number; round: number; left: number | null; right: number | null; middle: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type DragonTigerCasAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: DragonTigerCasSettings): DragonTigerCasState {
  return { rngSeed: seed, round: 1, left: null, right: null, middle: null, phase: "ready", score: 0, pts: 0, result: "" };
}
export function reducer(state: DragonTigerCasState, action: DragonTigerCasAction): DragonTigerCasState {
...
export function isTerminal(state: DragonTigerCasState): { score: number } | null {
