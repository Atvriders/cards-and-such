...
const ALL_QUESTIONS: QuizQuestion[] = [
  ...
  { question: "Author of the Declaration of Independence?", choices: ["Adams", "Madison", "Jefferson", "Franklin"], correct: 2 },
  ...
  { question: "Truman authorized atomic bombs on?", choices: ["Pearl Harbor", "Tokyo & Kyoto", "Hiroshima & Nagasaki", "Berlin & Hamburg"], correct: 2 },
  ...
  { question: "JFK's Vice President?", choices: ["Humphrey", "LBJ", "Carter", "Mondale"], correct: 1 },
  ...
  { question: "Washington's home was?", choices: ["Monticello", "Mount Vernon", "Hyde Park", "Hermitage"], correct: 1 },
  { question: "Jefferson's home was?", choices: ["Mount Vernon", "Monticello", "Hyde Park", "Hermitage"], correct: 1 },
  { question: "Andrew Jackson's nickname?", choices: ["Old Hickory", "Old Rough", "Honest Abe", "Tippecanoe"], correct: 0 },
  { question: "Wilson led US into?", choices: ["WWI", "WWII", "Korea", "Vietnam"], correct: 0 },
  ...
  { question: "Only president to resign?", choices: ["Ford", "Nixon", "Johnson", "Carter"], correct: 1 },
  { question: "Only unmarried president?", choices: ["Buchanan", "Polk", "Pierce", "Tyler"], correct: 0 },
  { question: "Roosevelt's New Deal addressed?", choices: ["Cold War", "Great Depression", "Civil Rights", "WWI"], correct: 1 },
  { question: "Truman Doctrine aimed to contain?", choices: ["Fascism", "Communism", "Imperialism", "Terrorism"], correct: 1 },
];
