    ...
    return (
      <div className={`${P}-wrap`}>
        <div className={`${P}-final`}>
          <h2 className={`${P}-final-title`}>Apples to Apples Quiz — Complete</h2>
    ...
    <div className={`${P}-wrap`}>
      ...
      {state.phase === "feedback" && (
        <>
          ...
          <button className={`${P}-next`} type="button" onClick={() => dispatch({ type: "next" } as ApplesToApplesQuizAction)}>
