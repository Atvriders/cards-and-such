...
export interface MultiHandVpTenSettings { dummy: boolean; }
export interface MultiHandVpTenState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type MultiHandVpTenAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: MultiHandVpTenSettings): MultiHandVpTenState {
  return { rngSeed: seed, round: 1, cardA: null, cardB: null, cardC: null, phase: "ready", score: 0, pts: 0, result: "" };
}
export function reducer(state: MultiHandVpTenState, action: MultiHandVpTenAction): MultiHandVpTenState {
...
export function isTerminal(state: MultiHandVpTenState): { score: number } | null {
