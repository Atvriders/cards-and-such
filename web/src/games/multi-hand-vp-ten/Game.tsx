...
import "./Game.css";
export function MultiHandVpTenGame({ state, dispatch, onGameOver }: GameProps<MultiHandVpTenState, MultiHandVpTenSettings>): JSX.Element {
  const t = isTerminal(state); useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  if (state.phase === "done") return <div className="dm-wrap"><h3>Multi-Hand Video Poker (10)</h3><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  return (
    <div className="dm-wrap">
      <h3>Multi-Hand Video Poker (10)</h3>
