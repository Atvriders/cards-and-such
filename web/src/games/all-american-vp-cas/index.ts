...
const hint = (state: AllAmericanVpCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-all-american-vp-cas-primary"]', pulses: 3 } : null);
export const allAmericanVpCasPlugin: GamePlugin<AllAmericanVpCasState, AllAmericanVpCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: AllAmericanVpCasGame,
};
