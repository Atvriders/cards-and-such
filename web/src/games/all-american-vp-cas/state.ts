...
export interface AllAmericanVpCasSettings { dummy: boolean; }
export interface AllAmericanVpCasState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type AllAmericanVpCasAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: AllAmericanVpCasSettings): AllAmericanVpCasState {
  return { rngSeed: seed, round: 1, cardA: null, cardB: null, cardC: null, phase: "ready", score: 0, pts: 0, result: "" };
}
export function reducer(state: AllAmericanVpCasState, action: AllAmericanVpCasAction): AllAmericanVpCasState {
...
export function isTerminal(state: AllAmericanVpCasState): { score: number } | null {
