...
const SawSnapGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SawSnapGame as unknown as React.ComponentType<unknown> })));
