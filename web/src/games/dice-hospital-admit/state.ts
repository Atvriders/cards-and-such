...
export interface DiceHospitalAdmitSettings { rounds: "10"; }

export interface DiceHospitalAdmitState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type DiceHospitalAdmitAction = { type: "roll" } | { type: "next" };
...
export function initialState(seed: number, _settings: DiceHospitalAdmitSettings): DiceHospitalAdmitState {
  return {
    rngSeed: seed >>> 0,
    score: 0,
    round: 1,
...
export function reducer(state: DiceHospitalAdmitState, action: DiceHospitalAdmitAction): DiceHospitalAdmitState {
...
export function isTerminal(state: DiceHospitalAdmitState): { score: number } | null {
