...
const cartographersRollPlayerGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.cartographersRollPlayerGame as unknown as React.ComponentType<unknown> })));
