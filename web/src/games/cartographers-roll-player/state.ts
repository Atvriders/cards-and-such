...
export interface cartographersRollPlayerSettings { dummy: boolean; }
export interface cartographersRollPlayerState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type cartographersRollPlayerAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: cartographersRollPlayerSettings): cartographersRollPlayerState {
  return {
    rngSeed: seed,
...
export function reducer(state: cartographersRollPlayerState, action: cartographersRollPlayerAction): cartographersRollPlayerState {
...
export function isTerminal(state: cartographersRollPlayerState): { score: number } | null {
