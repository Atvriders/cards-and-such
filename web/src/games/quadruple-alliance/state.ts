...
export interface QuadrupleAllianceSettings { dummy: boolean; }

export interface QuadrupleAllianceState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type QuadrupleAllianceAction =
  | { type: "keep" }
...
export function reducer(state: QuadrupleAllianceState, action: QuadrupleAllianceAction): QuadrupleAllianceState {
...
export function isTerminal(state: QuadrupleAllianceState): { score: number } | null {
