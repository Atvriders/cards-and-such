...
const SixShootGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SixShootGame as unknown as React.ComponentType<unknown> })));
...
export const sixShootPlugin: GamePlugin<SixShootState, SixShootAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-six-shoot-primary"]', pulses: 3 }),
  component:SixShootGame,
};
