...
const ChordProgressionsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ChordProgressionsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const chordProgressionsQuizPlugin: GamePlugin<ChordProgressionsQuizState, ChordProgressionsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: ChordProgressionsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ChordProgressionsQuizGame,
};
