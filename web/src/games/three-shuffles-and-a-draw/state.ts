...
export interface ThreeShufflesAndADrawSettings { dummy: boolean; }

export interface ThreeShufflesAndADrawState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type ThreeShufflesAndADrawAction =
  | { type: "keep" }
...
export function reducer(state: ThreeShufflesAndADrawState, action: ThreeShufflesAndADrawAction): ThreeShufflesAndADrawState {
...
export function isTerminal(state: ThreeShufflesAndADrawState): { score: number } | null {
