    ...
    <div className="marsch-wrap">
      ...
      <div className="marsch-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as MarseillaisChessAction)}><span className="marsch-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
