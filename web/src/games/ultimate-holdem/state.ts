...
export interface UltimateHoldemSettings { dummy: boolean; }
export interface UltimateHoldemState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type UltimateHoldemAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: UltimateHoldemSettings): UltimateHoldemState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: UltimateHoldemState, action: UltimateHoldemAction): UltimateHoldemState {
...
export function isTerminal(state: UltimateHoldemState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
