    ...
    <div className="marschq-wrap">
      ...
      <div className="marschq-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as MarseillaisQuizAction)}><span className="marschq-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
