...
export const spyfallMiniPlugin: GamePlugin<GameState, GameAction, typeof settings> = {
  id: "spyfall-mini",
  title: "Spyfall Mini",
  category: "board",
  players: { min: 1, max: 1, multiplayer: false },
  description: "Find the spy by spotting the odd-one-out clue.",
  howToPlay: "Spyfall Mini is a multiple-choice puzzle game inspired by the Spyfall location-deduction party game. Each round shows you a prompt or clue, and you must choose the correct answer from four candidate options.\n\nRead the prompt at the top of the screen carefully. The four answer buttons each show a candidate response, but only one of them satisfies the prompt. Tap the option you believe is correct so it highlights in blue, then press Submit to lock in your guess.\n\nCorrect answers earn 100 points and turn the chosen button green. Wrong answers turn red, while the true answer is always revealed so you can learn from each round. Press Next to advance through the bank of puzzles drawn for your session.\n\nEach prompt names a location and four player clues; the spy is the one whose clue does NOT match the location. Pick the spy. In Settings you can choose how many rounds to play in a single session: 5 for a quick warm-up, 8 for a steady challenge, or 10 for a full sprint through the puzzle bank. Puzzle order is seeded for repeatable runs.",
  settings,
