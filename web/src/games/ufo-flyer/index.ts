...
const UfoFlyerGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.UfoFlyerGame as unknown as React.ComponentType<unknown> })));
...
export const ufoFlyerPlugin: GamePlugin<UfoFlyerState, UfoFlyerAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: UfoFlyerState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-ufo-flyer-primary"]', pulses: 3 } : null,component:UfoFlyerGame,
};
