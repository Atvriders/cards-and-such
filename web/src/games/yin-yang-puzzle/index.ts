...
export const yinYangPuzzlePlugin: GamePlugin<YinYangPuzzleState, YinYangPuzzleAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".yinyangzen-num", pulses: 3 }; },
