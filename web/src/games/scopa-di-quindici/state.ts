...
export type ScopaDiQuindiciState = HuTrickState;
export type ScopaDiQuindiciAction = HuTrickAction;
export interface ScopaDiQuindiciSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: ScopaDiQuindiciSettings): ScopaDiQuindiciState => engine.initialState(seed);
