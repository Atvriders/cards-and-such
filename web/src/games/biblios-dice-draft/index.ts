...
const BibliosDiceDraftGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BibliosDiceDraftGame as unknown as React.ComponentType<unknown> })));
