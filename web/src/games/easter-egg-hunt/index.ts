...
const EasterEggHuntGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EasterEggHuntGame as unknown as React.ComponentType<unknown> })));
const settings = {
  eggs: {
    kind: "enum" as const,
    label: "Eggs",
...
Settings let you choose 5, 8, or 12 hidden eggs. Fewer eggs means a harder hunt (fewer targets in the same field); more eggs gives you more chances to score.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-easter-egg-hunt-action"]', pulses: 3 }; },
