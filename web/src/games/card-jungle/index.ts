...
const CardJungleGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardJungleGame as unknown as React.ComponentType<unknown> })));
...
export const cardJunglePlugin: GamePlugin<CardJungleState, CardJungleAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-jungle-primary"]', pulses: 3 }), component:CardJungleGame,
};
