...
const SneakerBrandsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SneakerBrandsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const sneakerBrandsQuizPlugin: GamePlugin<SneakerBrandsQuizState, SneakerBrandsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SneakerBrandsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SneakerBrandsQuizGame,
};
