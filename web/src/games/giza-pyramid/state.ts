...
export interface GizaPyramidSettings { dummy: boolean; }

export interface GizaPyramidState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function reducer(state: GizaPyramidState, action: GizaPyramidAction): GizaPyramidState {
...
export function isTerminal(state: GizaPyramidState): { score: number } | null {
