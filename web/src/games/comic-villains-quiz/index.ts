...
const ComicVillainsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ComicVillainsQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. The world's villains await — see if you can name them all without losing your soul.`,
  ...
  reducer,isTerminal,
  hint: (state: ComicVillainsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ComicVillainsQuizGame,
};
