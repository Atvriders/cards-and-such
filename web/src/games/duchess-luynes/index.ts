...
const DuchessLuynesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DuchessLuynesGame as unknown as React.ComponentType<unknown> })));
...
export const duchessLuynesPlugin: GamePlugin<DuchessLuynesState, DuchessLuynesAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as DuchessLuynesSettings),
  reducer,
  isTerminal,
  hint: (state: DuchessLuynesState): HintTarget | null => {
