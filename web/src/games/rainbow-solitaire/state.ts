...
export interface RainbowSolitaireSettings { dummy: boolean; }

export interface RainbowSolitaireState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type RainbowSolitaireAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: RainbowSolitaireSettings): RainbowSolitaireState {
...
export function reducer(state: RainbowSolitaireState, action: RainbowSolitaireAction): RainbowSolitaireState {
...
export function isTerminal(state: RainbowSolitaireState): { score: number } | null {
