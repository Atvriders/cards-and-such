...
export interface LucasSettings { dummy: boolean; }
...
export function initialState(seed: number, _s: LucasSettings): LucasState {
...
export function reducer(state: LucasState, action: LucasAction): LucasState {
...
export function isTerminal(state: LucasState): { score: number } | null {
