...
export const PUZZLES: Puzzle[] = [
  { prompt: "Boot-shaped peninsula in Europe", answer: "ITALY", distractors: ["FRANCE","SPAIN","GREECE"] },
  { prompt: "Country of cherry blossoms", answer: "JAPAN", distractors: ["CHINA","KOREA","VIETNAM"] },
  { prompt: "Land of pyramids", answer: "EGYPT", distractors: ["LIBYA","SUDAN","MOROCCO"] },
  { prompt: "Largest country by area", answer: "RUSSIA", distractors: ["CANADA","USA","CHINA"] },
  { prompt: "Home of the Eiffel Tower", answer: "FRANCE", distractors: ["ITALY","SPAIN","GERMANY"] },
  { prompt: "Birthplace of soccer", answer: "ENGLAND", distractors: ["BRAZIL","FRANCE","ITALY"] },
  { prompt: "Land of kangaroos", answer: "AUSTRALIA", distractors: ["NEW ZEALAND","FIJI","INDONESIA"] },
  { prompt: "Home of the Pharaohs of Khufu", answer: "EGYPT", distractors: ["GREECE","TURKEY","IRAN"] },
  { prompt: "Land of fjords", answer: "NORWAY", distractors: ["SWEDEN","ICELAND","FINLAND"] },
  { prompt: "Country of the Great Wall", answer: "CHINA", distractors: ["MONGOLIA","KOREA","JAPAN"] },
];

export interface WorldleCountrySettings { rounds: "5" | "8" | "10"; }
