...
const BibliosMonasteryGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BibliosMonasteryGame as unknown as React.ComponentType<unknown> })));
