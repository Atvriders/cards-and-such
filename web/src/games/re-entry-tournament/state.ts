...
export interface ReEntryTournamentSettings { rounds: "10"; }

export interface ReEntryTournamentState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export function initialState(seed: number, _s: ReEntryTournamentSettings): ReEntryTournamentState {
...
export function isTerminal(state: ReEntryTournamentState): { score: number } | null {
