...
export interface SomersetPatSettings { dummy: boolean; }

export interface SomersetPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: SomersetPatSettings): SomersetPatState {
...
export function reducer(state: SomersetPatState, action: SomersetPatAction): SomersetPatState {
...
export function isTerminal(state: SomersetPatState): { score: number } | null {
