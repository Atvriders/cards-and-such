...
const FluxxRulesGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FluxxRulesGame as unknown as React.ComponentType<unknown> })));
...
export const fluxxRulesPlugin: GamePlugin<FluxxRulesState, FluxxRulesAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: FluxxRulesState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-fluxx-rules-answer-0"]', pulses: 3 } : null, component: FluxxRulesGame,
};
