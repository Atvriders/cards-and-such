...
const NobelLaureatesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.NobelLaureatesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const nobelLaureatesQuizPlugin: GamePlugin<NobelLaureatesQuizState, NobelLaureatesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: NobelLaureatesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:NobelLaureatesQuizGame,
};
