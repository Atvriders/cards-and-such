...
const SeotdaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SeotdaGame as unknown as React.ComponentType<unknown> })));
...
export const seotdaPlugin: GamePlugin<SeotdaState, SeotdaAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SeotdaState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SeotdaGame,
};
