...
const AzulSummerPavilionGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AzulSummerPavilionGame as unknown as React.ComponentType<unknown> })));
...
export const azulSummerPavilionPlugin: GamePlugin<AzulSummerPavilionState, AzulSummerPavilionAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: AzulSummerPavilionState): HintTarget | null => {
    const sel = tileHintSelector(state, "azulsp-grid");
