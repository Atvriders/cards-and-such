...
const CardTowerFallGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardTowerFallGame as unknown as React.ComponentType<unknown> })));
...
export const cardTowerFallPlugin: GamePlugin<CardTowerFallState, CardTowerFallAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: CardTowerFallState): HintTarget | null => ((state.phase === "predict" || state.phase === "result") ? { selector: ".rg-btn", pulses: 3 } : null), component:CardTowerFallGame,
};
