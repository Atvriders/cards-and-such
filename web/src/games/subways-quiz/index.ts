...
const SubwaysQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SubwaysQuizGame as unknown as React.ComponentType<unknown> })));
...
export const subwaysQuizPlugin: GamePlugin<SubwaysQuizState, SubwaysQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SubwaysQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SubwaysQuizGame,
};
