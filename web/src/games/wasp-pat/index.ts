...
const WaspPatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WaspPatGame as unknown as React.ComponentType<unknown> })));
...
export const waspPatPlugin: GamePlugin<WaspPatState, WaspPatAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as WaspPatSettings),
  reducer,
  isTerminal,
  hint: (state: WaspPatState): HintTarget | null => {
