...
import type { IceSkaterState, IceSkaterSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./IceSkater.css";
export function IceSkater({ state, dispatch, onGameOver }:GameProps<IceSkaterState,IceSkaterSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <div className="arc-target">Tap {state.target} times to complete a spin!</div>
        ...
        <button data-testid="hint-target-ice-skater-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
