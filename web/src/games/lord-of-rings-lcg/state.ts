...
export interface LordOfRingsLcgSettings { dummy: boolean; }
export interface LordOfRingsLcgState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type LordOfRingsLcgAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: LordOfRingsLcgSettings): LordOfRingsLcgState {
