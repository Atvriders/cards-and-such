...
export type DiceBoxingKoStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceBoxingKoState, action: DiceBoxingKoStateAction): DiceBoxingKoState {
