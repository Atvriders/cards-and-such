...
export interface AddictionSoliSettings { dummy: boolean; }

export interface AddictionSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type AddictionSoliAction =
  | { type: "keep" }
...
export function reducer(state: AddictionSoliState, action: AddictionSoliAction): AddictionSoliState {
...
export function isTerminal(state: AddictionSoliState): { score: number } | null {
