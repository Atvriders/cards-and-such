...
const TILE_COLORS = ["#8b4513","#fff","#d35400","#9b59b6","#27ae60","#2c3e50"];
const TILE_LABELS = ["W","C","G","B","T","M"];
      ...
      <div className="tp-grid" style={{ gridTemplateColumns: `repeat(${GRID_SIZE}, 40px)` }}>
        {state.cells.map((v, i) => (
          <button
            ...
            onClick={() => v < 0 && dispatch({ type: "place", index: i } as CarcassonneTradersBuildersAction)}
            disabled={v >= 0}
