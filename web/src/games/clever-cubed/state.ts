...
export interface CleverCubedSettings { rounds: "10"; }
...
export type CleverCubedAction = { type: "roll" } | { type: "next" };
...
export function initialState(seed: number, _settings: CleverCubedSettings): CleverCubedState {
  return {
    rngSeed: seed >>> 0,
    score: 0,
    round: 1,
