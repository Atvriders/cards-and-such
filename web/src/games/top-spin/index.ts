...
const TopSpinGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TopSpinGame as unknown as React.ComponentType<unknown> })));
...
export const topSpinPlugin: GamePlugin<TopSpinState, TopSpinAction, typeof settings> = {
  ...
  reducer, isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-top-spin-action"]', pulses: 3 }; },
  component: TopSpinGame,
};
