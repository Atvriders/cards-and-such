...
export function AncientEgyptQuizGame({ state, dispatch, onGameOver }: GameProps<AncientEgyptQuizState, AncientEgyptQuizSettings>): JSX.Element {
    ...
    <div className="hq-wrap">
      ...
      {!state.done && entry ? (
        <>
          ...
          {state.selected !== null && (
            <button className="hq-next" onClick={() => dispatch({ type: "next" } as AncientEgyptQuizAction)}>
