...
const Agon = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Agon as unknown as React.ComponentType<unknown> })));
...
Scoring: win = 20 points; loss = 0.`,
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".agon-svg")) ? { selector: ".agon-svg", pulses: 3 } : null,
  component: Agon,
};
