...
const ArtMovementsQuiz = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ArtMovementsQuiz as unknown as React.ComponentType<unknown> })));
const settings = {
...
Whether you are an art student, a museum regular, or simply curious about why those Monet paintings look blurry, this quiz will sharpen your eye for art history!`,
  ...
  reducer,
  isTerminal,
  hint: (state: ArtMovementsState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
