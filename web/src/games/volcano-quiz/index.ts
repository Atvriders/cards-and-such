...
const VolcanoQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.VolcanoQuizGame as unknown as React.ComponentType<unknown> })));
...
export const volcanoQuizPlugin: GamePlugin<VolcanoQuizState, VolcanoQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: VolcanoQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:VolcanoQuizGame,
};
