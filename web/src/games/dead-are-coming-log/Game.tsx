...
export function DeadAreComingLogGame({ state, dispatch, onGameOver }: GameProps<DeadAreComingLogState, DeadAreComingLogSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="dac-wrap"><div className="dac-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
