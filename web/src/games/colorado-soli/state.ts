...
export interface ColoradoSoliSettings { dummy: boolean; }

export interface ColoradoSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type ColoradoSoliAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: ColoradoSoliSettings): ColoradoSoliState {
...
export function reducer(state: ColoradoSoliState, action: ColoradoSoliAction): ColoradoSoliState {
...
export function isTerminal(state: ColoradoSoliState): { score: number } | null {
