...
import { SpeedCribbageGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: SpeedCribbageState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const speedCribbagePlugin: GamePlugin<SpeedCribbageState, SpeedCribbageAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: SpeedCribbageGame,
};
