...
export interface AccordionSolitaireSettings { dummy: boolean; }
...
export type AccordionSolitaireAction =
  | { type: "keep" }
...
export function isTerminal(state: AccordionSolitaireState): { score: number } | null {
