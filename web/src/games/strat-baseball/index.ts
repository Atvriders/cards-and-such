...
const StratBaseballGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.StratBaseballGame as unknown as React.ComponentType<unknown> })));
...
export const stratBaseballPlugin: GamePlugin<StratBaseballState, StratBaseballAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-strat-baseball-action"]', pulses: 3 }; },
