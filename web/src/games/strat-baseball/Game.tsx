  ...
  if (state.phase === "done") {
    return (
      <div className="strbas-wrap">
        <div className="strbas-done bounce-in">
          <h2>Inning</h2>
  ...
  return (
    <div className="strbas-wrap fade-in">
      ...
      <div className="strbas-actions">
        {state.phase === "rolling" && (
          <button data-testid="hint-target-strat-baseball-action" className="strbas-btn primary" onClick={() => dispatch({ type: "roll" } as StratBaseballAction)}>Roll</button>
        )}
        {state.phase === "rolled" && (
