...
// Match-3 Triangle Mini: 6x6 match-3, swap adjacent gems, 3+ in row clears, gravity, score, 60s timer.
...
export interface Match3TriangleMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface Match3TriangleMiniState {
  rngSeed: number;
  grid: Grid;
...
export type Match3TriangleMiniAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: Match3TriangleMiniSettings): Match3TriangleMiniState {
...
export function reducer(state: Match3TriangleMiniState, action: Match3TriangleMiniAction): Match3TriangleMiniState {
...
export function isTerminal(state: Match3TriangleMiniState): { score: number } | null {
