...
export interface NertsSoliSettings { dummy: boolean; }

export interface NertsSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: NertsSoliSettings): NertsSoliState {
...
export function reducer(state: NertsSoliState, action: NertsSoliAction): NertsSoliState {
...
export function isTerminal(state: NertsSoliState): { score: number } | null {
