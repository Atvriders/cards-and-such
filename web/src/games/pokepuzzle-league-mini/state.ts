...
export interface PokepuzzleLeagueMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface PokepuzzleLeagueMiniState {
  rngSeed: number;
  grid: Grid;
...
export type PokepuzzleLeagueMiniAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: PokepuzzleLeagueMiniSettings): PokepuzzleLeagueMiniState {
...
export function reducer(state: PokepuzzleLeagueMiniState, action: PokepuzzleLeagueMiniAction): PokepuzzleLeagueMiniState {
...
export function isTerminal(state: PokepuzzleLeagueMiniState): { score: number } | null {
