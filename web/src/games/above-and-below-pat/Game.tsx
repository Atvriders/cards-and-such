...
export function SoliGame({ state, dispatch, onGameOver }: GameProps<SoliState, SoliSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    ...
    return <div className="sol-wrap aabp-wrap"><div className="sol-done"><h2>Done!</h2><div className="sol-final">{state.score} pts</div><div>{rating}</div></div></div>;
  }
  return (
    <div className="sol-wrap aabp-wrap">
