    ...
    <div className="seirchq-wrap">
      ...
      <div className="seirchq-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type:"select", choice:i } as SeirawanChessQuizAction)}><span className="seirchq-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
