...
export interface SatelliteTournamentSettings { dummy: boolean; }
export interface SatelliteTournamentState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type SatelliteTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: SatelliteTournamentSettings): SatelliteTournamentState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: SatelliteTournamentState, action: SatelliteTournamentAction): SatelliteTournamentState {
...
export function isTerminal(state: SatelliteTournamentState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
