...
const OrbitArcadeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OrbitArcadeGame as unknown as React.ComponentType<unknown> })));
...
export const orbitArcadePlugin: GamePlugin<OrbitArcadeState, OrbitArcadeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: OrbitArcadeState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-orbit-arcade-primary"]', pulses: 3 } : null,component:OrbitArcadeGame,
};
