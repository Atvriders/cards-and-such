...
import "./Game.css";
export function DealsRummyRGame({ state, dispatch, onGameOver }: GameProps<GState, object>): JSX.Element {
  const t = isTerminal(state); useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  if (state.phase === "done") return <div className="dlsr-wrap"><div className="dlsr-done"><h2>Done!</h2><div className="dlsr-final">{state.score} pts</div></div></div>;
  return (
    <div className="dlsr-wrap">
