...
export interface NapoleonAtStHelenaSettings { dummy: boolean; }

export interface NapoleonAtStHelenaState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type NapoleonAtStHelenaAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: NapoleonAtStHelenaSettings): NapoleonAtStHelenaState {
...
export function reducer(state: NapoleonAtStHelenaState, action: NapoleonAtStHelenaAction): NapoleonAtStHelenaState {
...
export function isTerminal(state: NapoleonAtStHelenaState): { score: number } | null {
