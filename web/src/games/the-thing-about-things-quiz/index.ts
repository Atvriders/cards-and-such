...
const TheThingAboutThingsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TheThingAboutThingsQuizGame as unknown as React.ComponentType<unknown> })));
