    ...
    <div className="onomatopoeiaquiz-wrap">
      ...
      <div className="onomatopoeiaquiz-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type: "select", choice: i } as OnomatopoeiaQuizAction)}><span className="onomatopoeiaquiz-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
