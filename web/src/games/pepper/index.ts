...
const PepperGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PepperGame as unknown as React.ComponentType<unknown> })));
...
export const pepperPlugin: GamePlugin<PepperState, PepperAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: PepperState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-pepperc-${pick.id}"]`, pulses: 3 };
    }
