...
const hint = (state: QuiddlerCardsState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const quiddlerCardsPlugin: GamePlugin<QuiddlerCardsState, QuiddlerCardsAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: QuiddlerCardsGame,
};
