...
export interface SambaCanastaRSettings { dummy: boolean; }
export interface SambaCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type SambaCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: SambaCanastaRSettings): SambaCanastaRState {
...
export function reducer(state: SambaCanastaRState, action: SambaCanastaRAction): SambaCanastaRState {
...
export function isTerminal(state: SambaCanastaRState): { score: number } | null {
