...
const ParallelsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ParallelsGame as unknown as React.ComponentType<unknown> })));
...
export const parallelsSolPlugin: GamePlugin<ParallelsState, ParallelsAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as ParallelsSettings),
  reducer,
  isTerminal,
