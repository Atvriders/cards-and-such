...
export interface ParallelsSolSettings { dummy: boolean; }

export interface ParallelsSolState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type ParallelsSolAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: ParallelsSolSettings): ParallelsSolState {
...
export function reducer(state: ParallelsSolState, action: ParallelsSolAction): ParallelsSolState {
...
export function isTerminal(state: ParallelsSolState): { score: number } | null {
