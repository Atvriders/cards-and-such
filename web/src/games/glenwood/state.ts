...
export interface GlenwoodSettings { dummy: boolean; }

export interface GlenwoodState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: GlenwoodSettings): GlenwoodState {
...
export function reducer(state: GlenwoodState, action: GlenwoodAction): GlenwoodState {
...
export function isTerminal(state: GlenwoodState): { score: number } | null {
