...
export interface HoldemFixedLimitSettings { dummy: boolean; }
export interface HoldemFixedLimitState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type HoldemFixedLimitAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: HoldemFixedLimitSettings): HoldemFixedLimitState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: HoldemFixedLimitState, action: HoldemFixedLimitAction): HoldemFixedLimitState {
...
export function isTerminal(state: HoldemFixedLimitState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
