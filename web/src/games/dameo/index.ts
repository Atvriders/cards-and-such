...
const DameoGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DameoGame as unknown as React.ComponentType<unknown> })));
...
export const dameoPlugin: GamePlugin<DameoState, DameoAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: DameoState): HintTarget | null => state.phase === "playing" ? { selector: '.dm-board', pulses: 3 } : null, component:DameoGame,
};
