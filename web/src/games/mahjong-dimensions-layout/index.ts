...
const MahjongDimensionsLayoutGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MahjongDimensionsLayoutGame as unknown as React.ComponentType<unknown> })));
