...
export interface SpiritIslandCoopSettings { dummy: boolean; }
export interface SpiritIslandCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type SpiritIslandCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: SpiritIslandCoopSettings): SpiritIslandCoopState {
