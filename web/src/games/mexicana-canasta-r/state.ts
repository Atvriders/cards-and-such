...
export interface MexicanaCanastaRSettings { dummy: boolean; }
export interface MexicanaCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type MexicanaCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: MexicanaCanastaRSettings): MexicanaCanastaRState {
...
export function reducer(state: MexicanaCanastaRState, action: MexicanaCanastaRAction): MexicanaCanastaRState {
...
export function isTerminal(state: MexicanaCanastaRState): { score: number } | null {
