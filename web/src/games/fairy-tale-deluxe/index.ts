...
const FairyTaleDeluxeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.FairyTaleDeluxeGame as unknown as React.ComponentType<unknown> })));
