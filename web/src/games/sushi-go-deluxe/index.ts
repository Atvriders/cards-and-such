...
const SushiGoDeluxeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SushiGoDeluxeGame as unknown as React.ComponentType<unknown> })));
