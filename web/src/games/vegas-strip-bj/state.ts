...
export interface VegasStripBjSettings { dummy: boolean; }
export interface VegasStripBjState { rngSeed: number; round: number; hand: number[]; total: number; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; }
export type VegasStripBjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: VegasStripBjSettings): VegasStripBjState {
...
export function reducer(state: VegasStripBjState, action: VegasStripBjAction): VegasStripBjState {
...
export function isTerminal(state: VegasStripBjState): { score: number } | null {
