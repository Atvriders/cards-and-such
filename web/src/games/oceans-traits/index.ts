...
const OceansTraitsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OceansTraitsGame as unknown as React.ComponentType<unknown> })));
