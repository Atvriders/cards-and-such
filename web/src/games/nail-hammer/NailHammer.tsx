...
import type { NailHammerState, NailHammerSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./NailHammer.css";
export function NailHammer({ state, dispatch, onGameOver }:GameProps<NailHammerState,NailHammerSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-nail-hammer-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
