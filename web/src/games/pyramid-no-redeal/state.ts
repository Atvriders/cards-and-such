...
export interface PyramidNoRedealSettings { dummy: boolean; }

export interface PyramidNoRedealState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type PyramidNoRedealAction =
  | { type: "keep" }
...
export function reducer(state: PyramidNoRedealState, action: PyramidNoRedealAction): PyramidNoRedealState {
...
export function isTerminal(state: PyramidNoRedealState): { score: number } | null {
