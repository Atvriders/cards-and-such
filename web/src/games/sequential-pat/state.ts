...
export interface SequentialPatSettings { dummy: boolean; }

export interface SequentialPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type SequentialPatAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: SequentialPatSettings): SequentialPatState {
...
export function reducer(state: SequentialPatState, action: SequentialPatAction): SequentialPatState {
...
export function isTerminal(state: SequentialPatState): { score: number } | null {
