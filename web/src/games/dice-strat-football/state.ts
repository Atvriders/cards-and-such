...
export type DiceStratFootballStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceStratFootballState, action: DiceStratFootballStateAction): DiceStratFootballState {
