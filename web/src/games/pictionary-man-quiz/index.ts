...
export const pictionary_man_quiz_plugin: GamePlugin<PictionaryManQuizState, PictionaryManQuizAction, typeof settings> = {
...
export default pictionary_man_quiz_plugin;
