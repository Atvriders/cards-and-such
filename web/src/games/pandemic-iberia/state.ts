...
export interface PandemicIberiaSettings { dummy: boolean; }
export interface PandemicIberiaState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type PandemicIberiaAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: PandemicIberiaSettings): PandemicIberiaState {
