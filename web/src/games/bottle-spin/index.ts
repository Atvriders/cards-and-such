...
const BottleSpin = /* @__PURE__ */ lazy(() => import("./BottleSpin.js").then((mod) => ({ default: mod.BottleSpin as unknown as React.ComponentType<unknown> })));
...
Watch the pointer carefully, anticipate the sweep rate, and time your stop decisively. Perfect scores require both patience and sharp reactions!`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-bottle-spin-action"]', pulses: 3 }; },
