...
const MusicNotationQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MusicNotationQuizGame as unknown as React.ComponentType<unknown> })));
...
export const musicNotationQuizPlugin: GamePlugin<MusicNotationQuizState, MusicNotationQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: MusicNotationQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:MusicNotationQuizGame,
};
