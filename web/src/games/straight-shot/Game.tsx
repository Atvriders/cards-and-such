...
export function StraightShotGame({ state, dispatch, onGameOver }: GameProps<StraightShotState, StraightShotSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    return <div className="dm-wrap straight-shot-theme"><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="dm-wrap straight-shot-theme">
