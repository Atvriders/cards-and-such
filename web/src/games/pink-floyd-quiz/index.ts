...
const PinkFloydQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PinkFloydQuizGame as unknown as React.ComponentType<unknown> })));
...
export const pinkFloydQuizPlugin: GamePlugin<PinkFloydQuizState, PinkFloydQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: PinkFloydQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:PinkFloydQuizGame,
};
