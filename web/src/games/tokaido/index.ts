...
const TokaidoGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TokaidoGame as unknown as React.ComponentType<unknown> })));
...
export const tokaidoPlugin: GamePlugin<TokaidoState, TokaidoAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TokaidoState): HintTarget | null => {
    const sel = tileHintSelector(state, "tok-grid");
