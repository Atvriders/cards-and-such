...
const SushiGoConveyorGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SushiGoConveyorGame as unknown as React.ComponentType<unknown> })));
