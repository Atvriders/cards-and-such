...
const CardHourglassGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardHourglassGame as unknown as React.ComponentType<unknown> })));
...
export const cardHourglassPlugin: GamePlugin<CardHourglassState, CardHourglassAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-hourglass-primary"]', pulses: 3 }), component:CardHourglassGame,
};
