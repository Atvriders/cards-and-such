...
const GirandolaSudokuGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GirandolaSudokuGame as unknown as React.ComponentType<unknown> })));
...
export const girandolaSudokuPlugin: GamePlugin<GirandolaSudokuState, GirandolaSudokuStateAction, typeof settings> = {
  ...
  hint: (state: GirandolaSudokuState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-girandola-sudoku-answer-0"]', pulses: 3 } : null,component: GirandolaSudokuGame,
};
