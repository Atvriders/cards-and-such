...
export interface Spanish21CasState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type Spanish21CasAction = { type: "play" } | { type: "next" };
