...
const hint = (state: Spanish21CasState): HintTarget | null => (state.phase === "play" ? { selector: '[data-testid="hint-target-spanish-21-cas-primary"]', pulses: 3 } : null);
export const spanish21CasPlugin: GamePlugin<Spanish21CasState, Spanish21CasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: Spanish21CasGame,
};
