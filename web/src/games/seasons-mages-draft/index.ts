...
const SeasonsMagesDraftGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SeasonsMagesDraftGame as unknown as React.ComponentType<unknown> })));
