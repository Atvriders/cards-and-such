...
export interface UnderwaterCitiesRwSettings { rounds: "10"; }

export interface UnderwaterCitiesRwState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type UnderwaterCitiesRwAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: UnderwaterCitiesRwSettings): UnderwaterCitiesRwState {
  return { rngSeed: seed >>> 0, score: 0, round: 1, maxRounds: 10, hand: [], lastGain: 0, phase: "ready" };
}

export function reducer(state: UnderwaterCitiesRwState, action: UnderwaterCitiesRwAction): UnderwaterCitiesRwState {
...
export function isTerminal(state: UnderwaterCitiesRwState): { score: number } | null {
