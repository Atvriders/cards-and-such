...
import { initialState, reducer, isTerminal, scoreCardBakery, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardBakery", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardBakery([])).toBeGreaterThanOrEqual(0); });
