...
const CurryQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CurryQuizGame as unknown as React.ComponentType<unknown> })));
...
export const curryQuizPlugin: GamePlugin<CurryQuizState, CurryQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: CurryQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:CurryQuizGame,
};
