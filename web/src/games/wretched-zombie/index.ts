...
export const wretchedZombiePlugin: GamePlugin<WretchedZombieState, WretchedZombieAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: WretchedZombieState): HintTarget | null => (state.phase === "choose" ? { selector: '[data-testid="hint-target-wretched-zombie-primary"]', pulses: 3 } : null), component: WretchedZombieGame,
};
