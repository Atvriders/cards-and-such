...
export function WretchedZombieGame({ state, dispatch, onGameOver }: GameProps<WretchedZombieState, WretchedZombieSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="wrz-wrap"><div className="wrz-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
