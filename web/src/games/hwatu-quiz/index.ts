...
const HwatuGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HwatuGame as unknown as React.ComponentType<unknown> })));
...
export const hwatuPlugin: GamePlugin<HwatuState, HwatuAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HwatuState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HwatuGame,
};
