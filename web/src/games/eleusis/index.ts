...
const EleusisGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EleusisGame as unknown as React.ComponentType<unknown> })));
...
export const eleusisPlugin: GamePlugin<EleusisState, EleusisAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: EleusisState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-eleusis-primary"]', pulses: 3 } : null), component: EleusisGame,
};
