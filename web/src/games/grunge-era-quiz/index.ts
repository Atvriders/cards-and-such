...
const GrungeEraQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GrungeEraQuizGame as unknown as React.ComponentType<unknown> })));
...
export const grungeEraQuizPlugin: GamePlugin<GrungeEraQuizState, GrungeEraQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: GrungeEraQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:GrungeEraQuizGame,
};
