...
export const blokusPlugin: GamePlugin<BlokusState, BlokusAction, typeof settings> = {
  ...
  description: "Polyomino corner-touch placement; cover the most board.",
  howToPlay: `Blokus is a single-player tile-placement puzzle. Polyomino corner-touch placement; cover the most board. Tiles draw from a randomized queue, and your job is to place each one onto a small grid in a way that maximises end-of-game scoring.

How it works: Place 18 tiles on a 5x5 grid. Each tile pays +1; diagonal same-type adjacencies pay +2 (corner-touch rule); orthogonal same-type adjacencies cost -1 (forbidden in classic).
