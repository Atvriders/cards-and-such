...
const DicePyramidRoll = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DicePyramidRoll as unknown as React.ComponentType<unknown> })));
...
Play 3 or 5 levels (set in Settings). Maximum score on a 3-level game is around 50 pts if you ace each level. It gets harder to top each level as the required minimum rises!`,
  ...
  hint: (state) => {
    ...
    if (phase === "rolling") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "rolling-dice") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "preRoll") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "ready") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "playerRoll") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "roll") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "play") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "playing") return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
    if (phase === "roundOver") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "result") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "settled") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "banked") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "done") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "farkled") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    if (phase === "busted") return { selector: '[data-testid="hint-target-dice-pyramid-roll-next"]', pulses: 3 };
    return { selector: '[data-testid="hint-target-dice-pyramid-roll-roll"]', pulses: 3 };
  },
