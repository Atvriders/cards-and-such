...
const DartsKillerClassicGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DartsKillerClassicGame as unknown as React.ComponentType<unknown> })));
...
export const dartsKillerClassicPlugin: GamePlugin<DartsKillerClassicState, DartsKillerClassicAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-darts-killer-classic-action"]', pulses: 3 }; },
