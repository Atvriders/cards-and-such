...
export type GemGrabAction = { type: "catch"; id: number } | { type: "tick" } | { type: "spawn" };

export function initialState(seed: number, settings: GemGrabSettings): GemGrabState {
...
export function reducer(state: GemGrabState, action: GemGrabAction): GemGrabState {
...
export function isTerminal(state: GemGrabState): { score: number } | null {
