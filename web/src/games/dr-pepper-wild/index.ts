...
const hint = (state: DrPepperWildState): HintTarget | null => ((state.phase === "ready" || state.phase === "dealt") ? { selector: ".g-btn", pulses: 3 } : null);
...
export const drPepperWildPlugin: GamePlugin<DrPepperWildState, DrPepperWildAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: DrPepperWild,
};
