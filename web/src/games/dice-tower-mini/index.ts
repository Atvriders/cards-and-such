...
const DiceTowerMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DiceTowerMiniGame as unknown as React.ComponentType<unknown> })));
...
export const diceTowerMiniPlugin: GamePlugin<DiceTowerMiniState, DiceTowerMiniAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state): HintTarget | null => (state.phase === "done" ? null : { selector: '[data-testid="hint-target-dice-tower-mini-primary"]', pulses: 3 }), component:DiceTowerMiniGame,
};
