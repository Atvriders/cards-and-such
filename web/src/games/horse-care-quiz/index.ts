...
const HorseCareQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HorseCareQuizGame as unknown as React.ComponentType<unknown> })));
...
export const horseCareQuizPlugin: GamePlugin<HorseCareQuizState, HorseCareQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HorseCareQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HorseCareQuizGame,
};
