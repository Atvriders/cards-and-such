...
export interface AgnesBernauerSettings { dummy: boolean; }
...
export type AgnesBernauerAction =
  | { type: "keep" }
...
export function reducer(state: AgnesBernauerState, action: AgnesBernauerAction): AgnesBernauerState {
...
export function isTerminal(state: AgnesBernauerState): { score: number } | null {
