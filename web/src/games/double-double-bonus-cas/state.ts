...
export interface DoubleDoubleBonusCasSettings { dummy: boolean; }
export interface DoubleDoubleBonusCasState { rngSeed: number; round: number; cardA: number | null; cardB: number | null; cardC: number | null; phase: "ready" | "scored" | "done"; score: number; pts: number; result: string; }
export type DoubleDoubleBonusCasAction = { type: "play" } | { type: "next" };
...
export function initialState(seed: number, _s: DoubleDoubleBonusCasSettings): DoubleDoubleBonusCasState {
  return { rngSeed: seed, round: 1, cardA: null, cardB: null, cardC: null, phase: "ready", score: 0, pts: 0, result: "" };
}
export function reducer(state: DoubleDoubleBonusCasState, action: DoubleDoubleBonusCasAction): DoubleDoubleBonusCasState {
...
export function isTerminal(state: DoubleDoubleBonusCasState): { score: number } | null {
