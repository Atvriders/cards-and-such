...
const hint = (state: DoubleDoubleBonusCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-double-double-bonus-cas-primary"]', pulses: 3 } : null);
export const doubleDoubleBonusCasPlugin: GamePlugin<DoubleDoubleBonusCasState, DoubleDoubleBonusCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: DoubleDoubleBonusCasGame,
};
