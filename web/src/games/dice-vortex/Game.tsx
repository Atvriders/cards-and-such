...
export function DiceVortexGame({ state, dispatch, onGameOver }: GameProps<DiceVortexState, DiceVortexSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    return <div className="dm-wrap dice-vortex-theme"><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="dm-wrap dice-vortex-theme">
