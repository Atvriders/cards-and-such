...
export const PUZZLES: Puzzle[] = [
  { prompt: "COLD -> ? -> WARM (cord step)", choices: ["CORD", "COLT", "BOLD", "WORD"], correctIndex: 0 },
  { prompt: "HEAD -> ? -> TAIL", choices: ["HEAL", "HEAR", "HEAT", "READ"], correctIndex: 0 },
  { prompt: "WARM -> ? -> WORM", choices: ["WARD", "WARE", "WORD", "WARN"], correctIndex: 2 },
  { prompt: "FOOL -> ? -> WISE", choices: ["FOOT", "POOL", "TOOL", "FOLD"], correctIndex: 1 },
  { prompt: "LOVE -> ? -> HATE", choices: ["LIVE", "LANE", "LATE", "DOVE"], correctIndex: 2 },
  { prompt: "MILK -> ? -> COW (silk step)", choices: ["SILK", "MILD", "MILE", "BILK"], correctIndex: 0 },
  { prompt: "WHEAT -> ? -> BREAD", choices: ["CHEAT", "WHEAL", "HEAVE", "WREAK"], correctIndex: 0 },
  { prompt: "SHIP -> ? -> DOCK", choices: ["SHOP", "SLIP", "WHIP", "SHIN"], correctIndex: 0 },
  { prompt: "BLUE -> ? -> PINK", choices: ["GLUE", "BLUR", "FLUE", "BLUM"], correctIndex: 0 },
  { prompt: "MOON -> ? -> STAR", choices: ["NOON", "MOOR", "MOOD", "BOON"], correctIndex: 1 },
];
