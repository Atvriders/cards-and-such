...
import type { MelonSmashState, MelonSmashSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./MelonSmash.css";
export function MelonSmash({ state, dispatch, onGameOver }:GameProps<MelonSmashState,MelonSmashSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-melon-smash-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
