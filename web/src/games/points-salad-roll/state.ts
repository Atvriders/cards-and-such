...
export interface PointsSaladRollSettings { dummy: boolean; }
export interface PointsSaladRollState {
  rngSeed: number;
  cells: boolean[];
...
export type PointsSaladRollAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: PointsSaladRollSettings): PointsSaladRollState {
  return {
    rngSeed: seed,
...
export function reducer(state: PointsSaladRollState, action: PointsSaladRollAction): PointsSaladRollState {
...
export function isTerminal(state: PointsSaladRollState): { score: number } | null {
