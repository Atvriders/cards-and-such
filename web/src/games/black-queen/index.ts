...
const BlackQueenGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BlackQueenGame as unknown as React.ComponentType<unknown> })));
...
export const blackQueenPlugin: GamePlugin<BlackQueenState, BlackQueenAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-black-queen-primary"]', pulses: 3 }), component:BlackQueenGame,
};
