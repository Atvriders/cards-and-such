...
export interface CubanCanastaRSettings { dummy: boolean; }
export interface CubanCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type CubanCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: CubanCanastaRSettings): CubanCanastaRState {
...
export function reducer(state: CubanCanastaRState, action: CubanCanastaRAction): CubanCanastaRState {
...
export function isTerminal(state: CubanCanastaRState): { score: number } | null {
