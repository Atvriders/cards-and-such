...
const hint = (state: InBetweenCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-in-between-cas-primary"]', pulses: 3 } : null);
export const inBetweenCasPlugin: GamePlugin<InBetweenCasState, InBetweenCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: InBetweenCasGame,
};
