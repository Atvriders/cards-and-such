...
export const PUZZLES: Puzzle[] = [
  { prompt: "ABCAPPLEXY", choices: ["APPLE", "GRAPE", "PLUM", "PEAR"], correctIndex: 0 },
  { prompt: "QQTIGERMNB", choices: ["LION", "TIGER", "BEAR", "WOLF"], correctIndex: 1 },
  { prompt: "ZZRIVERPLM", choices: ["LAKE", "POND", "RIVER", "OCEAN"], correctIndex: 2 },
  { prompt: "WERPLANEXX", choices: ["TRAIN", "PLANE", "BOAT", "TRUCK"], correctIndex: 1 },
  { prompt: "AAGUITARBB", choices: ["DRUM", "FLUTE", "GUITAR", "PIANO"], correctIndex: 2 },
  { prompt: "PPSILVERTT", choices: ["SILVER", "GOLDEN", "BRONZE", "COPPER"], correctIndex: 0 },
  { prompt: "FFCOMETZZX", choices: ["PLANET", "COMET", "GALAXY", "STAR"], correctIndex: 1 },
  { prompt: "BBEAGLEYYZ", choices: ["POODLE", "BEAGLE", "BOXER", "HUSKY"], correctIndex: 1 },
  { prompt: "CASTLEXXBB", choices: ["TOWER", "CABIN", "CASTLE", "MANOR"], correctIndex: 2 },
  { prompt: "AARABBITXX", choices: ["RABBIT", "RACCOON", "BADGER", "FERRET"], correctIndex: 0 },
];
