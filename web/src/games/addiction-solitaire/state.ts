...
export interface AddictionSolSettings { dummy: boolean; }

export interface AddictionSolState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type AddictionSolAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: AddictionSolSettings): AddictionSolState {
...
export function reducer(state: AddictionSolState, action: AddictionSolAction): AddictionSolState {
...
export function isTerminal(state: AddictionSolState): { score: number } | null {
