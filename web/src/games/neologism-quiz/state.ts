...
const ALL_QUESTIONS: QuizQuestion[] = [
  {
    "question": "GHOSTING means?",
    "choices": [
      "abruptly cutting contact",
      "seeing ghosts",
      "posting online",
      "drinking coffee"
    ],
  ...
  {
    "question": "TWEET (verb) means?",
    "choices": [
      "post short message online",
      "sing",
      "whistle",
      "yell"
    ],
  ...
  {
    "question": "BROMANCE means?",
    "choices": [
      "close non-romantic male friendship",
      "romance novel",
      "family bond",
      "old grudge"
    ],
  ...
  {
    "question": "YOLO is short for?",
    "choices": [
      "You Only Live Once",
      "Your Own Long Order",
      "You Owe Lots Of",
      "Year Of Long Outcomes"
    ],
    "correct": 0
  }
] as QuizQuestion[];
