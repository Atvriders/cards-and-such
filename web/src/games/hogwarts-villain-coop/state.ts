...
export interface HogwartsVillainCoopSettings { dummy: boolean; }
export interface HogwartsVillainCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type HogwartsVillainCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: HogwartsVillainCoopSettings): HogwartsVillainCoopState {
