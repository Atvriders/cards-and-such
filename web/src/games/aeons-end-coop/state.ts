...
export interface AeonsEndCoopSettings { dummy: boolean; }
export interface AeonsEndCoopState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type AeonsEndCoopAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: AeonsEndCoopSettings): AeonsEndCoopState {
