    ...
    <div className="dm-wrap">
      ...
      {state.phase === "bet" && <>
        ...
        <div className="dm-row">
          <button className="dm-btn" onClick={() => dispatch({ type: "bet", side: "player" } as EzBaccaratCasAction)}>Player</button>
          <button className="dm-btn" onClick={() => dispatch({ type: "bet", side: "banker" } as EzBaccaratCasAction)}>Banker</button>
          <button className="dm-btn alt" onClick={() => dispatch({ type: "bet", side: "tie" } as EzBaccaratCasAction)}>Tie</button>
        </div>
      </>}
      {state.phase === "scored" && <>
        ...
        <button className="dm-btn alt" onClick={() => dispatch({ type: "next" } as EzBaccaratCasAction)}>Next</button>
      </>}
    </div>
  );
}
