...
const hint = (state: EzBaccaratCasState): HintTarget | null => (state.phase === "bet" ? { selector: '[data-testid="hint-target-ez-baccarat-cas-primary"]', pulses: 3 } : null);
export const ezBaccaratCasPlugin: GamePlugin<EzBaccaratCasState, EzBaccaratCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: EzBaccaratCasGame,
};
