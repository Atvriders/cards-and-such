...
const WordamentMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WordamentMiniGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
export const wordamentMiniPlugin: GamePlugin<WordamentMiniState, WordamentMiniAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: WordamentMiniState): HintTarget | null => {
