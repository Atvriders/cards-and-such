...
export interface RussianSoliSettings { dummy: boolean; }

export interface RussianSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: RussianSoliSettings): RussianSoliState {
...
export function reducer(state: RussianSoliState, action: RussianSoliAction): RussianSoliState {
...
export function isTerminal(state: RussianSoliState): { score: number } | null {
