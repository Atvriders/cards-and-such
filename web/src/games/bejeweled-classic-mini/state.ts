...
// Bejeweled Classic Mini: 6x6 match-3, swap adjacent gems, 3+ in row clears, gravity, score, 60s timer.
...
export interface BejeweledClassicMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface BejeweledClassicMiniState {
  rngSeed: number;
  grid: Grid;
...
export type BejeweledClassicMiniAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: BejeweledClassicMiniSettings): BejeweledClassicMiniState {
...
export function reducer(state: BejeweledClassicMiniState, action: BejeweledClassicMiniAction): BejeweledClassicMiniState {
...
export function isTerminal(state: BejeweledClassicMiniState): { score: number } | null {
