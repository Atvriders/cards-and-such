...
export type BridgeContractState = HuTrickState;
export type BridgeContractAction = HuTrickAction;
...
export const initialState = (seed: number, _s: BridgeContractSettings): BridgeContractState => engine.initialState(seed);
