...
export interface DeucesSoliSettings { dummy: boolean; }

export interface DeucesSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: DeucesSoliSettings): DeucesSoliState {
...
export function reducer(state: DeucesSoliState, action: DeucesSoliAction): DeucesSoliState {
...
export function isTerminal(state: DeucesSoliState): { score: number } | null {
