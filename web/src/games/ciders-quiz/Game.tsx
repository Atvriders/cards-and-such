...
import type { CidersQuizState, CidersQuizAction, CidersQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./Game.css";

export function CidersQuiz({
  state,
  dispatch,
  onGameOver,
}: GameProps<CidersQuizState, CidersQuizSettings>): JSX.Element {
    ...
    <div className="qz-wrap">
      ...
      {!state.done && entry ? (
        <>
            ...
            {entry.choices.map((choice, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => dispatch({ type: "select", index: i } as CidersQuizAction)}
                >
                  {choice}
                </button>
              );
          ...
          {state.selected !== null && (
            <button className="qz-next" onClick={() => dispatch({ type: "next" } as CidersQuizAction)}>
