...
export interface DiavoloSettings { dummy: boolean; }

export interface DiavoloState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: DiavoloSettings): DiavoloState {
...
export function reducer(state: DiavoloState, action: DiavoloAction): DiavoloState {
...
export function isTerminal(state: DiavoloState): { score: number } | null {
