...
export interface TriPeaksContinuousSettings { dummy: boolean; }

export interface TriPeaksContinuousState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type TriPeaksContinuousAction =
  | { type: "keep" }
...
export function reducer(state: TriPeaksContinuousState, action: TriPeaksContinuousAction): TriPeaksContinuousState {
...
export function isTerminal(state: TriPeaksContinuousState): { score: number } | null {
