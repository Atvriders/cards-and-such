...
const TwoThousandsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TwoThousandsQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 15 questions in Settings. Test your memory of the era, learn something along the way, and aim for a high score!`,
  ...
  reducer,isTerminal,
  hint: (state: TwoThousandsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:TwoThousandsQuizGame,
};
