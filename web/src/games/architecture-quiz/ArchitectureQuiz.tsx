...
import type { ArchitectureQuizState, ArchitectureQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./ArchitectureQuiz.css";
export function ArchitectureQuiz({ state, dispatch, onGameOver }: GameProps<ArchitectureQuizState, ArchitectureQuizSettings>): JSX.Element {
