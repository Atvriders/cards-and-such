...
export interface SultanSoliSettings { dummy: boolean; }

export interface SultanSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: SultanSoliSettings): SultanSoliState {
...
export function reducer(state: SultanSoliState, action: SultanSoliAction): SultanSoliState {
...
export function isTerminal(state: SultanSoliState): { score: number } | null {
