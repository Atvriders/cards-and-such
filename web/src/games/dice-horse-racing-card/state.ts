...
export type DiceHorseRacingCardStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceHorseRacingCardState, action: DiceHorseRacingCardStateAction): DiceHorseRacingCardState {
