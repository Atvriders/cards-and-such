...
const WeeklyChess960Game = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WeeklyChess960Game as unknown as React.ComponentType<unknown> })));
...
export const weeklyChess960Plugin: GamePlugin<WeeklyChess960State, WeeklyChess960Action, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: WeeklyChess960State): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-weekly-chess960-answer-0"]', pulses: 3 } : null, component: WeeklyChess960Game,
};
