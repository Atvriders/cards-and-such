...
const UnoFlipQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.UnoFlipQuizGame as unknown as React.ComponentType<unknown> })));
...
export const unoFlipQuizPlugin: GamePlugin<UnoFlipQuizState, UnoFlipQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: UnoFlipQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:UnoFlipQuizGame,
};
