...
export type GeierState = HuTrickState;
export type GeierAction = HuTrickAction;
export interface GeierSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: GeierSettings): GeierState => engine.initialState(seed);
