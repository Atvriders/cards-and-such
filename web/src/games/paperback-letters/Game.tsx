...
export function PaperbackLettersGame({ state, dispatch, onGameOver }: GameProps<PaperbackLettersState, PaperbackLettersSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    return <div className="cm-wrap pbk-scope"><div className="cm-done"><h2>📚 Done!</h2><div className="cm-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="cm-wrap pbk-scope">
