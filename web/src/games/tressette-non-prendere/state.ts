...
export type TressetteNonPrendereState = HuTrickState;
export type TressetteNonPrendereAction = HuTrickAction;
export interface TressetteNonPrendereSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: TressetteNonPrendereSettings): TressetteNonPrendereState => engine.initialState(seed);
