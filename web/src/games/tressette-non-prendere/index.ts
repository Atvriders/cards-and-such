...
const TressetteNonPrendereGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TressetteNonPrendereGame as unknown as React.ComponentType<unknown> })));
...
export const tressetteNonPrenderePlugin: GamePlugin<TressetteNonPrendereState, TressetteNonPrendereAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: TressetteNonPrendereState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-trenpc-${pick.id}"]`, pulses: 3 };
    }
