...
const MiniRailsRwGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MiniRailsRwGame as unknown as React.ComponentType<unknown> })));
...
export const miniRailsRwPlugin: GamePlugin<MiniRailsRwState, MiniRailsRwAction, typeof settings> = {
  ...
  hint: (state: any) => {
    ...
    if ((state as any).phase === "rolling") return { selector: '[data-testid="hint-target-mini-rails-rw-roll"]', pulses: 3 };
    return { selector: '[data-testid="hint-target-mini-rails-rw-skip"]', pulses: 3 };
  },
