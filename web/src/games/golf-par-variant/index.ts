...
const GolfParVariantGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.GolfParVariantGame as unknown as React.ComponentType<unknown> })));
...
export const golfParVariantPlugin: GamePlugin<GolfParVariantState, GolfParVariantAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as GolfParVariantSettings),
