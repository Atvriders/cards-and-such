...
const MokshaPatamGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MokshaPatamGame as unknown as React.ComponentType<unknown> })));
const settings = { questions: { kind:"enum" as const, label:"Questions", options:["10"] as const, default:"10" as const } } as const;
type S = SettingsOf<typeof settings>;
export const mokshaPatamPlugin: GamePlugin<MokshaPatamState, MokshaPatamAction, typeof settings> = {
  id:"moksha-patam-quiz", title:"Moksha Patam Quiz", category:"board",
  players:{ min:1, max:1, multiplayer:false },
  description:"Test your knowledge of the Indian moral race game Moksha Patam.",
