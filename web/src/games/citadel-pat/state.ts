...
export interface CitadelPatSettings { dummy: boolean; }

export interface CitadelPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: CitadelPatSettings): CitadelPatState {
...
export function reducer(state: CitadelPatState, action: CitadelPatAction): CitadelPatState {
...
export function isTerminal(state: CitadelPatState): { score: number } | null {
