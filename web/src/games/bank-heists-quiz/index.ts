...
const BankHeistsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BankHeistsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const bankHeistsQuizPlugin: GamePlugin<BankHeistsQuizState, BankHeistsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: BankHeistsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:BankHeistsQuizGame,
};
