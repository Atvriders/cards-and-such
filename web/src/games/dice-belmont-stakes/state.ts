...
export type DiceBelmontStakesStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceBelmontStakesState, action: DiceBelmontStakesStateAction): DiceBelmontStakesState {
