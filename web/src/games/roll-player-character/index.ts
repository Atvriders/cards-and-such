...
const RollPlayerCharacterGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.RollPlayerCharacterGame as unknown as React.ComponentType<unknown> })));
...
export const rollPlayerCharacterPlugin: GamePlugin<RollPlayerCharacterState, RollPlayerCharacterAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: hint, component:RollPlayerCharacterGame,
};
