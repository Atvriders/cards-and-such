...
export interface RollPlayerCharacterSettings { dummy: boolean; }
export interface RollPlayerCharacterState {
  rngSeed: number;
  round: number;
  rolls: number[];
  bonus: number;
...
export type RollPlayerCharacterAction = { type: "roll" } | { type: "next" };
export function initialState(seed: number, _s: RollPlayerCharacterSettings): RollPlayerCharacterState {
...
export function reducer(state: RollPlayerCharacterState, action: RollPlayerCharacterAction): RollPlayerCharacterState {
...
export function isTerminal(state: RollPlayerCharacterState): { score: number } | null {
