...
export function DiceRouletteGame({ state, dispatch, onGameOver }: GameProps<DiceRouletteState, DiceRouletteSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    return <div className="dm-wrap dice-roulette-theme"><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="dm-wrap dice-roulette-theme">
