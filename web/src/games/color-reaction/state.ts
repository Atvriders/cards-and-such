...
// Color Reaction: stimuli appear; react when condition is met.
...
export interface ColorReactionSettings { dummy: boolean; }
...
export type ColorReactionAction =
  | { type: "tick" }
  | { type: "react" };

export function initialState(seed: number, _settings: ColorReactionSettings): ColorReactionState {
...
export function reducer(state: ColorReactionState, action: ColorReactionAction): ColorReactionState {
...
export function isTerminal(state: ColorReactionState): { score: number } | null {
