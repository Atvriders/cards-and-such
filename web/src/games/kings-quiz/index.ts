...
const KingsQuiz = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KingsQuiz as unknown as React.ComponentType<unknown> })));
...
From Henry VIII's six marriages to Shaka Zulu's military reforms, this quiz tests both familiar history and fascinating facts about the men who wore the crown!`,
  ...
  reducer, isTerminal, 
  hint: (state: KingsState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component: KingsQuiz,
};
