...
import type { MoosehideYukonState, MoosehideYukonAction, MoosehideYukonSettings } from "./state.js";
import { initialState, reducer, isTerminal, ruleset } from "./state.js";
const MoosehideYukonGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MoosehideYukonGame as unknown as React.ComponentType<unknown> })));
import { canMove } from "../../engines/tableau/moves.js";
const settings = { _dummy: { kind: "boolean" as const, label: "_", default: false } } as const;
type S = SettingsOf<typeof settings>;
export const moosehideYukonPlugin: GamePlugin<MoosehideYukonState, MoosehideYukonAction, typeof settings> = {
  id: "moosehide-yukon",
  title: "Moosehide Yukon",
  category: "solitaire",
