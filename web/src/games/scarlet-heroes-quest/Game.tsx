...
export function ScarletHeroesQuestGame({ state, dispatch, onGameOver }: GameProps<ScarletHeroesQuestState, ScarletHeroesQuestSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="shq-wrap"><div className="shq-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
