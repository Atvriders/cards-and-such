...
export interface AtlanticCityBjSettings { dummy: boolean; }
export interface AtlanticCityBjState { rngSeed: number; round: number; you: number[]; dealer: number[]; phase: "play" | "scored" | "done"; score: number; pts: number; result: string; yourTotal: number; dealerTotal: number; }
export type AtlanticCityBjAction = { type: "hit" } | { type: "stand" } | { type: "next" };
...
export function initialState(seed: number, _s: AtlanticCityBjSettings): AtlanticCityBjState {
...
export function reducer(state: AtlanticCityBjState, action: AtlanticCityBjAction): AtlanticCityBjState {
...
export function isTerminal(state: AtlanticCityBjState): { score: number } | null {
