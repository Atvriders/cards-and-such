...
export interface BristolSettings { dummy: boolean; }

export interface BristolState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: BristolSettings): BristolState {
...
export function reducer(state: BristolState, action: BristolAction): BristolState {
...
export function isTerminal(state: BristolState): { score: number } | null {
