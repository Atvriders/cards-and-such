...
export function WanderhomeJourneyGame({ state, dispatch, onGameOver }: GameProps<WanderhomeJourneyState, WanderhomeJourneySettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="whj-wrap"><div className="whj-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
