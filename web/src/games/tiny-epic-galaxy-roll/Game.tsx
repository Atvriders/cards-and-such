...
type TinyEpicGalaxyRollSettingsT = TinyEpicGalaxyRollState["" extends "" ? "rngSeed" : never];

export function TinyEpicGalaxyRoll({ state, dispatch, onGameOver }: GameProps<TinyEpicGalaxyRollState, { rounds: "10" }>): JSX.Element {
