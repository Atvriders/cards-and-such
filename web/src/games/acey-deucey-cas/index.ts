...
const hint = (state: AceyDeuceyCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-acey-deucey-cas-primary"]', pulses: 3 } : null);
export const aceyDeuceyCasPlugin: GamePlugin<AceyDeuceyCasState, AceyDeuceyCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: AceyDeuceyCasGame,
};
