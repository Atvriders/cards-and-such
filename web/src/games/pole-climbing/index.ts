...
Reaching the top wins the round. Your score is based on how few falls you had: a perfect climb with zero falls scores 100 points. Each fall deducts 10 points.`,
  ...
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-pole-climbing-action"]', pulses: 3 }; },
