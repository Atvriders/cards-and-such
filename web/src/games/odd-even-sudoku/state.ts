...
export interface OddEvenSudokuState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: OddEvenSudokuSettings;
}

export type OddEvenSudokuAction =
...
export function initialState(seed: number, settings: OddEvenSudokuSettings): OddEvenSudokuState {
