...
export interface CassetteAgnesBernauerSettings { dummy: boolean; }

export interface CassetteAgnesBernauerState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type CassetteAgnesBernauerAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: CassetteAgnesBernauerSettings): CassetteAgnesBernauerState {
...
export function reducer(state: CassetteAgnesBernauerState, action: CassetteAgnesBernauerAction): CassetteAgnesBernauerState {
...
export function isTerminal(state: CassetteAgnesBernauerState): { score: number } | null {
