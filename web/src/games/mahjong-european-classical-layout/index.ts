...
const MahjongEuropeanClassicalLayoutGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MahjongEuropeanClassicalLayoutGame as unknown as React.ComponentType<unknown> })));
