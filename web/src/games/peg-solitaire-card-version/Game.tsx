  ...
  return (
    <div className="sol-wrap">
      ...
      <div className="sol-actions">
        <button data-testid="hint-target-peg-solitaire-card-version-primary" className="sol-btn sol-btn-keep" onClick={() => dispatch({ type: "keep" } as PegSolitaireCardVersionAction)}>Keep & Score</button>
