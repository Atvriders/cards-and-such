...
const OfficersSkatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.OfficersSkatGame as unknown as React.ComponentType<unknown> })));
...
export const officersSkatPlugin: GamePlugin<OfficersSkatState, OfficersSkatAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: OfficersSkatState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-off-s-${pick.id}"]`, pulses: 3 };
    }
