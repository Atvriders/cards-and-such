...
const KonigrufenGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KonigrufenGame as unknown as React.ComponentType<unknown> })));
...
export const konigrufenPlugin: GamePlugin<KonigrufenState, KonigrufenAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: KonigrufenState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-konigc-${pick.id}"]`, pulses: 3 };
    }
