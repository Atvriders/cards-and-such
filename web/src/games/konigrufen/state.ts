...
export type KonigrufenState = HuTrickState;
export type KonigrufenAction = HuTrickAction;
...
export const initialState = (seed: number, _s: KonigrufenSettings): KonigrufenState => engine.initialState(seed);
