...
export interface MapMemorySettings { dummy: boolean; }

const PAIRS: [string, string][] = [["Paris","France"],["Tokyo","Japan"],["Rome","Italy"],["Berlin","Germany"],["Madrid","Spain"],["Cairo","Egypt"],["Lima","Peru"],["Oslo","Norway"],["Athens","Greece"],["Hanoi","Vietnam"],["Helsinki","Finland"],["Lisbon","Portugal"],["Vienna","Austria"],["Budapest","Hungary"],["Dublin","Ireland"],["Bangkok","Thailand"],["Cape Town","South Africa"],["Ottawa","Canada"]];
const PROMPT_PREFIX = "Which country contains";
const PROMPT_SUFFIX = "?";
...
export interface MapMemoryState {
  rounds: MapMemoryRound[];
  currentIndex: number;
...
function genRounds(rng: () => number): MapMemoryRound[] {
  const out: MapMemoryRound[] = [];
...
export function initialState(seed: number, _s: MapMemorySettings): MapMemoryState {
...
export function reducer(state: MapMemoryState, action: MapMemoryAction): MapMemoryState {
...
export function isTerminal(state: MapMemoryState): { score: number } | null {
