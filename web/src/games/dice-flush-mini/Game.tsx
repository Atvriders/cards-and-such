...
export function DiceFlushMiniGame({ state, dispatch, onGameOver }: GameProps<DiceFlushMiniState, DiceFlushMiniSettings>): JSX.Element {
  ...
  if (state.phase === "done") {
    return <div className="dm-wrap dice-flush-mini-theme"><div className="dm-done bounce-in"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  }
  return (
    <div className="dm-wrap dice-flush-mini-theme fade-in">
