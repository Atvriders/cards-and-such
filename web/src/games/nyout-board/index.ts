...
const NyoutBoardGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.NyoutBoardGame as unknown as React.ComponentType<unknown> })));
...
export const nyoutBoardPlugin: GamePlugin<NyoutBoardState, NyoutBoardAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: NyoutBoardState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-nyout-board-answer-0"]', pulses: 3 } : null, component:NyoutBoardGame,
};
