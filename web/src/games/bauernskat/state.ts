...
export type BauernSkatState = HuTrickState;
export type BauernSkatAction = HuTrickAction;
export interface BauernSkatSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: BauernSkatSettings): BauernSkatState => engine.initialState(seed);
