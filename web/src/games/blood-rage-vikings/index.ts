...
const BloodRageVikingsGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BloodRageVikingsGame as unknown as React.ComponentType<unknown> })));
