...
export interface PotLimitBadugiSettings { dummy: boolean; }
export interface PotLimitBadugiState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type PotLimitBadugiAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: PotLimitBadugiSettings): PotLimitBadugiState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: PotLimitBadugiState, action: PotLimitBadugiAction): PotLimitBadugiState {
...
export function isTerminal(state: PotLimitBadugiState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
