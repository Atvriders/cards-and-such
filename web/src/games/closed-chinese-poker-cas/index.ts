...
import { ClosedChinesePokerCasGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: ClosedChinesePokerCasState): HintTarget | null => (state.phase === "see" ? { selector: '[data-testid="hint-target-closed-chinese-poker-cas-primary"]', pulses: 3 } : null);
export const closedChinesePokerCasPlugin: GamePlugin<ClosedChinesePokerCasState, ClosedChinesePokerCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: ClosedChinesePokerCasGame,
};
