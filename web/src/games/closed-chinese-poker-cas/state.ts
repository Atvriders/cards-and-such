...
export interface ClosedChinesePokerCasSettings { dummy: boolean; }
export interface ClosedChinesePokerCasState { rngSeed: number; round: number; you: number[]; cpu: number[]; phase: "see" | "scored" | "done"; score: number; pts: number; result: string; }
export type ClosedChinesePokerCasAction = { type: "play" } | { type: "fold" } | { type: "next" };
...
export function initialState(seed: number, _s: ClosedChinesePokerCasSettings): ClosedChinesePokerCasState {
...
export function reducer(state: ClosedChinesePokerCasState, action: ClosedChinesePokerCasAction): ClosedChinesePokerCasState {
...
export function isTerminal(state: ClosedChinesePokerCasState): { score: number } | null {
