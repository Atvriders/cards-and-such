...
const BaghChal = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BaghChal as unknown as React.ComponentType<unknown> })));
...
Scoring: Goats win = 25; Tigers win = 0.`,
  ...
  reducer,
  isTerminal,
  hint: (): HintTarget | null => (typeof document !== "undefined" && document.querySelector(".baghchal-svg")) ? { selector: ".baghchal-svg", pulses: 3 } : null,
  component: BaghChal,
};
