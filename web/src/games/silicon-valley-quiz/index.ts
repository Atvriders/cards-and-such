...
const SiliconValleyQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SiliconValleyQuizGame as unknown as React.ComponentType<unknown> })));
...
export const siliconValleyQuizPlugin: GamePlugin<SiliconValleyQuizState, SiliconValleyQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SiliconValleyQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SiliconValleyQuizGame,
};
