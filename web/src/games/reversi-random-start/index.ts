...
const ReversiRandomStartGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ReversiRandomStartGame as unknown as React.ComponentType<unknown> })));
const settings = {
...
Scoring: win = 100 + (your discs − opponent discs) × 5; draw = 50; loss = max(0, your discs − 10).`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".revrand-pass", pulses: 3 }; },
