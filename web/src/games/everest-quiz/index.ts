...
const EverestQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EverestQuizGame as unknown as React.ComponentType<unknown> })));
...
export const everestQuizPlugin: GamePlugin<EverestQuizState, EverestQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: EverestQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:EverestQuizGame,
};
