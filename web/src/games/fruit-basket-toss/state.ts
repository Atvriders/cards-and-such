...
export interface FruitBasketTossSettings { dummy: boolean; }
export interface FruitBasketTossState { rngSeed: number; targets: number[]; roundIndex: number; score: number; phase: "aiming" | "result" | "done"; power: number; lastDiff: number; lastPts: number; }
export type FruitBasketTossAction = { type: "setPower"; value: number } | { type: "throw" } | { type: "next" };

export function initialState(seed: number, _settings: FruitBasketTossSettings): FruitBasketTossState {
...
export function reducer(state: FruitBasketTossState, action: FruitBasketTossAction): FruitBasketTossState {
...
export function isTerminal(state: FruitBasketTossState): { score: number } | null {
