...
import { initialState, reducer, isTerminal, scoreCardGrocery, TOTAL_ROUNDS } from "./state.js";
const S = { dummy: false };
describe("CardGrocery", () => {
  ...
  it("score function is non-negative for empty hand", () => { expect(scoreCardGrocery([])).toBeGreaterThanOrEqual(0); });
