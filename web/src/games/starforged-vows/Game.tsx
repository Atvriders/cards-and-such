...
export function StarforgedVowsGame({ state, dispatch, onGameOver }: GameProps<StarforgedVowsState, StarforgedVowsSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="sfv-wrap"><div className="sfv-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
