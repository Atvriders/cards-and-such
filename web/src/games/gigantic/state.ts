...
export interface GiganticSettings { dummy: boolean; }

export interface GiganticState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: GiganticSettings): GiganticState {
...
export function reducer(state: GiganticState, action: GiganticAction): GiganticState {
...
export function isTerminal(state: GiganticState): { score: number } | null {
