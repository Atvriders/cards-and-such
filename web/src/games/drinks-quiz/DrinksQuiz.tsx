...
import type { DrinksQuizState, DrinksQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./DrinksQuiz.css";

export function DrinksQuiz({ state, dispatch, onGameOver }: GameProps<DrinksQuizState, DrinksQuizSettings>): JSX.Element {
