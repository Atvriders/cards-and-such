...
export interface WindmillPatSettings { dummy: boolean; }

export interface WindmillPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: WindmillPatSettings): WindmillPatState {
...
export function reducer(state: WindmillPatState, action: WindmillPatAction): WindmillPatState {
...
export function isTerminal(state: WindmillPatState): { score: number } | null {
