...
const CartaExplorerGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CartaExplorerGame as unknown as React.ComponentType<unknown> })));
...
export const cartaExplorerPlugin: GamePlugin<CartaExplorerState, CartaExplorerAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: CartaExplorerState): HintTarget | null => (state.phase === "choose" ? { selector: '[data-testid="hint-target-carta-explorer-primary"]', pulses: 3 } : null), component: CartaExplorerGame,
};
