  ...
  return (
    <div className="barreljumper-game">
      ...
      <div className="barreljumper-controls">
        <button data-testid="hint-target-donkey-kong-like-action" title="Move left" onClick={() => dispatch({ type: "move-left" } as BarrelJumperAction)}>◀</button>
        <button onClick={() => dispatch({ type: "jump" } as BarrelJumperAction)}>Jump</button>
        <button title="Move right" onClick={() => dispatch({ type: "move-right" } as BarrelJumperAction)}>▶</button>
