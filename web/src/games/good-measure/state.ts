...
export interface GoodMeasureSettings { dummy: boolean; }

export interface GoodMeasureState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: GoodMeasureSettings): GoodMeasureState {
...
export function reducer(state: GoodMeasureState, action: GoodMeasureAction): GoodMeasureState {
...
export function isTerminal(state: GoodMeasureState): { score: number } | null {
