...
// Shariki: 6x6 match-3 with 60s timer.
...
export interface SharikiSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface SharikiState {
  rngSeed: number;
  grid: Grid;
...
export function initialState(seed: number, _settings: SharikiSettings): SharikiState {
...
export function reducer(state: SharikiState, action: SharikiAction): SharikiState {
...
export function isTerminal(state: SharikiState): { score: number } | null {
