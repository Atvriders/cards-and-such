...
const MonopolyMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MonopolyMiniGame as unknown as React.ComponentType<unknown> })));
...
Score = (your cash + property value) − (CPU cash + property value) + 500, plus a 500 bonus for outright winning.`,
  ...
  reducer,
  isTerminal,
  hint: (s: any) => { const p = (s as any).phase; if (p === "done" || p === "gameover" || p === "ended" || p === "finished" || (s as any).gameOver || (s as any).won || (s as any).complete || (s as any).isComplete) return null; return { selector: ".monopolymini-btn", pulses: 3 }; },
