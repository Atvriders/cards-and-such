...
export type ChibreState = HuTrickState;
export type ChibreAction = HuTrickAction;
export interface ChibreSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: ChibreSettings): ChibreState => engine.initialState(seed);
