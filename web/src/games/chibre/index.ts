...
const ChibreGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ChibreGame as unknown as React.ComponentType<unknown> })));
...
export const chibrePlugin: GamePlugin<ChibreState, ChibreAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: ChibreState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-chibrc-${pick.id}"]`, pulses: 3 };
    }
