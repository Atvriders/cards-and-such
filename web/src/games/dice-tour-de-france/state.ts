...
export type DiceTourDeFranceStateAction = { type: "roll" } | { type: "next" };
...
export function reducer(state: DiceTourDeFranceState, action: DiceTourDeFranceStateAction): DiceTourDeFranceState {
