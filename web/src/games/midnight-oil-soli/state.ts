...
export interface MidnightOilSoliSettings { dummy: boolean; }

export interface MidnightOilSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type MidnightOilSoliAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: MidnightOilSoliSettings): MidnightOilSoliState {
...
export function reducer(state: MidnightOilSoliState, action: MidnightOilSoliAction): MidnightOilSoliState {
...
export function isTerminal(state: MidnightOilSoliState): { score: number } | null {
