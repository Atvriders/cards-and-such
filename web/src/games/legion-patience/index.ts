...
const LegionPatienceGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.LegionPatienceGame as unknown as React.ComponentType<unknown> })));
...
export const legionPatiencePlugin: GamePlugin<LegionPatienceState, LegionPatienceAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as LegionPatienceSettings),
  reducer,
  isTerminal,
