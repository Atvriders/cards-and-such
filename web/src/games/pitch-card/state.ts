...
export type PitchState = HuTrickState;
export type PitchAction = HuTrickAction;
export interface PitchSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: PitchSettings): PitchState => engine.initialState(seed);
