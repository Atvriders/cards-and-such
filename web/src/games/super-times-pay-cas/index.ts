...
import { SuperTimesPayCasGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: SuperTimesPayCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-super-times-pay-cas-primary"]', pulses: 3 } : null);
export const superTimesPayCasPlugin: GamePlugin<SuperTimesPayCasState, SuperTimesPayCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: SuperTimesPayCasGame,
};
