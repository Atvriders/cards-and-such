...
export type SoloSchafkopfState = HuTrickState;
export type SoloSchafkopfAction = HuTrickAction;
export interface SoloSchafkopfSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: SoloSchafkopfSettings): SoloSchafkopfState => engine.initialState(seed);
