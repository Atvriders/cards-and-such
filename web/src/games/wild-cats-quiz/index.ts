...
const WildCatsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WildCatsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const wildCatsQuizPlugin: GamePlugin<WildCatsQuizState, WildCatsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: WildCatsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:WildCatsQuizGame,
};
