...
const hint = (state: RedDogCasState): HintTarget | null => (state.phase === "ready" ? { selector: '[data-testid="hint-target-red-dog-cas-primary"]', pulses: 3 } : null);
export const redDogCasPlugin: GamePlugin<RedDogCasState, RedDogCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: RedDogCasGame,
};
