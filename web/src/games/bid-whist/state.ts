...
export type BidWhistState = HuTrickState;
export type BidWhistAction = HuTrickAction;
export interface BidWhistSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: BidWhistSettings): BidWhistState => engine.initialState(seed);
