...
const BidWhistGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BidWhistGame as unknown as React.ComponentType<unknown> })));
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;

export const bidWhistPlugin: GamePlugin<BidWhistState, BidWhistAction, typeof settings> = {
  id: "bid-whist",
  title: "Bid Whist",
  category: "cards",
  ...
  reducer,
  isTerminal,
  hint: (state: BidWhistState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-bidwh-${pick.id}"]`, pulses: 3 };
    }
