...
export interface LiverpoolRSettings { dummy: boolean; }
export interface LiverpoolRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type LiverpoolRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: LiverpoolRSettings): LiverpoolRState {
...
export function reducer(state: LiverpoolRState, action: LiverpoolRAction): LiverpoolRState {
...
export function isTerminal(state: LiverpoolRState): { score: number } | null {
