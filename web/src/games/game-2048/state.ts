...
// 2048: 4x4 sliding tiles. Arrow keys slide+merge tiles. Reach 2048 to win.

export const SIZE = 4;
export const TARGET = 2048;

export interface Game2048Settings { dummy: boolean; }
...
export type Game2048Action = { type: "slide"; dir: Direction };
...
export function initialState(seed: number, _settings: Game2048Settings): Game2048State {
...
export function reducer(state: Game2048State, action: Game2048Action): Game2048State {
...
export function isTerminal(state: Game2048State): { score: number } | null {
