...
export interface XSudokuMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: XSudokuMiniSettings;
}

export type XSudokuMiniAction =
...
export function initialState(seed: number, settings: XSudokuMiniSettings): XSudokuMiniState {
