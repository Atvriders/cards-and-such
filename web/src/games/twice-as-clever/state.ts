...
export interface TwiceAsCleverSettings { dummy: boolean; }
...
export type TwiceAsCleverAction =
  | { type: "roll" }
...
export function initialState(seed: number, _s: TwiceAsCleverSettings): TwiceAsCleverState {
  return {
    rngSeed: seed >>> 0,
