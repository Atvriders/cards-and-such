...
const XmenQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.XmenQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10 or 20 questions in Settings. Are you ready, mutant-maniac? It's time to step into the Danger Room.`,
  ...
  reducer,isTerminal,
  hint: (state: XmenQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:XmenQuizGame,
};
