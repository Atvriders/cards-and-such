...
export interface SixCardStudCasSettings { dummy: boolean; }
export interface SixCardStudCasState { rngSeed: number; round: number; you: number[]; cpu: number[]; phase: "see" | "scored" | "done"; score: number; pts: number; result: string; }
export type SixCardStudCasAction = { type: "play" } | { type: "fold" } | { type: "next" };
...
export function initialState(seed: number, _s: SixCardStudCasSettings): SixCardStudCasState {
...
export function reducer(state: SixCardStudCasState, action: SixCardStudCasAction): SixCardStudCasState {
...
export function isTerminal(state: SixCardStudCasState): { score: number } | null {
