...
const hint = (state: SixCardStudCasState): HintTarget | null => (state.phase === "see" ? { selector: '[data-testid="hint-target-six-card-stud-cas-primary"]', pulses: 3 } : null);
export const sixCardStudCasPlugin: GamePlugin<SixCardStudCasState, SixCardStudCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: SixCardStudCasGame,
};
