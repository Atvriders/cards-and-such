...
const KlaskMagneticGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KlaskMagneticGame as unknown as React.ComponentType<unknown> })));
...
export const klaskMagneticPlugin: GamePlugin<KlaskMagneticState, KlaskMagneticAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: KlaskMagneticState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-klask-magnetic-answer-0"]', pulses: 3 } : null, component: KlaskMagneticGame,
};
