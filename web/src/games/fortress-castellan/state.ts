...
export interface FortressCastellanSettings { dummy: boolean; }

export interface FortressCastellanState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type FortressCastellanAction =
  | { type: "keep" }
...
export function reducer(state: FortressCastellanState, action: FortressCastellanAction): FortressCastellanState {
...
export function isTerminal(state: FortressCastellanState): { score: number } | null {
