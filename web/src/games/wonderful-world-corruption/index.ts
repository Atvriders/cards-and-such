...
const WonderfulWorldCorruptionGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WonderfulWorldCorruptionGame as unknown as React.ComponentType<unknown> })));
