...
const CarcassonneHillsSheepGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CarcassonneHillsSheepGame as unknown as React.ComponentType<unknown> })));
...
export const carcassonneHillsSheepPlugin: GamePlugin<CarcassonneHillsSheepState, CarcassonneHillsSheepAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: CarcassonneHillsSheepState): HintTarget | null => {
    const sel = tileHintSelector(state, "carchs-grid");
