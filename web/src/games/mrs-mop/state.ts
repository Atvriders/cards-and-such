...
export interface MrsMopSettings { dummy: boolean; }

export interface MrsMopState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: MrsMopSettings): MrsMopState {
...
export function reducer(state: MrsMopState, action: MrsMopAction): MrsMopState {
...
export function isTerminal(state: MrsMopState): { score: number } | null {
