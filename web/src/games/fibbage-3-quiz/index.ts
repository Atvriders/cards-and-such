...
const Fibbage3QuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.Fibbage3QuizGame as unknown as React.ComponentType<unknown> })));
...
export const fibbage3QuizPlugin: GamePlugin<Fibbage3QuizState, Fibbage3QuizAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: Fibbage3QuizState): HintTarget | null => state.phase === "ask" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
