...
const MightyGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MightyGame as unknown as React.ComponentType<unknown> })));
...
export const mightyPlugin: GamePlugin<MightyState, MightyAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: MightyState): HintTarget | null => {
    ...
    if (trick.length === 0) {
      ...
      return { selector: `[data-testid="hint-target-mightyc-${pick.id}"]`, pulses: 3 };
    }
