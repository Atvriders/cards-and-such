...
const MusicDecadeQuiz = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.MusicDecadeQuiz as unknown as React.ComponentType<unknown> })));
const settings = {
...
Use Settings to play 10 or 20 questions. Questions are randomly selected and choices are shuffled each game for replayability. Whether you grew up in the 70s or discovered music through streaming, this quiz will take you on a tour through the decades!`,
  ...
  reducer,
  isTerminal,
  hint: (state: MusicDecadeQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
