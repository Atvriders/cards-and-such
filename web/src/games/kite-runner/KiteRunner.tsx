...
import type { KiteRunnerState, KiteRunnerSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./KiteRunner.css";
export function KiteRunner({ state, dispatch, onGameOver }:GameProps<KiteRunnerState,KiteRunnerSettings>):JSX.Element {
  ...
  return (
    <div className="arc-wrap">
      ...
      {!terminal?(<>
        ...
        <button data-testid="hint-target-kite-runner-action" className="arc-btn" onClick={()=>dispatch({type:"tap"})}>Tap!</button>
