...
export function FreecellTwoDeckGame({ state, dispatch, onGameOver }: GameProps<FreecellTwoDeckState, FreecellTwoDeckSettings>): JSX.Element {
  ...
  return (
    <div className="sol-wrap">
      ...
      <div className="sol-board">
        {state.hand.map((c, i) => (
          <button key={i} className="sol-card" onClick={() => dispatch({ type: "swap", index: i } as FreecellTwoDeckAction)}>
            {cardName(c)}
          </button>
        ))}
      </div>
