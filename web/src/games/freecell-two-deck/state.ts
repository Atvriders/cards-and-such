...
export interface FreecellTwoDeckSettings { dummy: boolean; }

export interface FreecellTwoDeckState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type FreecellTwoDeckAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: FreecellTwoDeckSettings): FreecellTwoDeckState {
...
export function reducer(state: FreecellTwoDeckState, action: FreecellTwoDeckAction): FreecellTwoDeckState {
...
export function isTerminal(state: FreecellTwoDeckState): { score: number } | null {
