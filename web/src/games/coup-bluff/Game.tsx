  ...
  return (
    <div className="bluff-wrap">
      ...
      <div className="bluff-claim">
        ...
        <div className="bluff-claim-text">"I act as {r.cpuClaim}"</div>
      ...
      {!state.resolved && (
        <div className="bluff-actions">
          <button className="bluff-btn trust" onClick={() => dispatch({ type: "decide", decision: "trust" } as CoupBluffAction)}>Trust</button>
          <button className="bluff-btn call" onClick={() => dispatch({ type: "decide", decision: "callBluff" } as CoupBluffAction)}>Call Bluff!</button>
        </div>
      )}
      {state.resolved && (
        <div className="bluff-result">
          ...
          <button className="bluff-btn next" onClick={() => dispatch({ type: "next" } as CoupBluffAction)}>
