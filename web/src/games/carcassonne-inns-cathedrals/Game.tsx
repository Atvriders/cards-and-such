...
const TILE_COLORS = ["#3498db","#e74c3c","#2ecc71","#f39c12","#9b59b6"];
const TILE_LABELS = ["R","C","F","I","T"];
      ...
      <div className="tp-grid" style={{ gridTemplateColumns: `repeat(${GRID_SIZE}, 40px)` }}>
        {state.cells.map((v, i) => (
          <button
            ...
            onClick={() => v < 0 && dispatch({ type: "place", index: i } as CarcassonneInnsCathedralsAction)}
            disabled={v >= 0}
