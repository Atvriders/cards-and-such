...
export interface HyperSudokuMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: HyperSudokuMiniSettings;
}

export type HyperSudokuMiniAction =
...
export function initialState(seed: number, settings: HyperSudokuMiniSettings): HyperSudokuMiniState {
