    ...
    return (
      <div className={`${P}-wrap fade-in`}>
        <div className={`${P}-final bounce-in`}>
          <h2 className={`${P}-final-title`}>Telestrations: After Dark Quiz — Complete</h2>
    ...
    <div className={`${P}-wrap fade-in`}>
      ...
      {state.phase === "feedback" && (
        <>
          ...
          <button className={`${P}-next`} type="button" onClick={() => dispatch({ type: "next" } as TelestrationsAfterDarkQuizAction)}>
