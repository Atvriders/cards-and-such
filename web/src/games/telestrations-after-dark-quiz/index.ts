...
const TelestrationsAfterDarkQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.TelestrationsAfterDarkQuizGame as unknown as React.ComponentType<unknown> })));
