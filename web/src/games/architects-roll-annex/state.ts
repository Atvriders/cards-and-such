...
export interface ArchitectsRollAnnexSettings { dummy: boolean; }
export interface ArchitectsRollAnnexState {
  rngSeed: number;
  cells: boolean[];
  cellValues: number[];
  rolls: number;
...
export type ArchitectsRollAnnexAction =
  | { type: "roll" }
  | { type: "mark"; index: number }
  | { type: "skip" };

export function initialState(seed: number, _s: ArchitectsRollAnnexSettings): ArchitectsRollAnnexState {
  return {
    rngSeed: seed,
...
export function reducer(state: ArchitectsRollAnnexState, action: ArchitectsRollAnnexAction): ArchitectsRollAnnexState {
...
export function isTerminal(state: ArchitectsRollAnnexState): { score: number } | null {
