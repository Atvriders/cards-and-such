...
const CardSpikeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CardSpikeGame as unknown as React.ComponentType<unknown> })));
...
export const cardSpikePlugin: GamePlugin<CardSpikeState, CardSpikeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state) => isTerminal(state) ? null : ({ selector: '[data-testid="hint-target-card-spike-primary"]', pulses: 3 }), component:CardSpikeGame,
};
