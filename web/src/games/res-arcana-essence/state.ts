...
export interface ResArcanaEssenceSettings { dummy: boolean; }
export interface ResArcanaEssenceState {
  rngSeed: number;
  round: number;
  hand: number[];
  lastPts: number;
...
export type ResArcanaEssenceAction = { type: "draw" } | { type: "next" };
export function initialState(seed: number, _s: ResArcanaEssenceSettings): ResArcanaEssenceState {
...
export function reducer(state: ResArcanaEssenceState, action: ResArcanaEssenceAction): ResArcanaEssenceState {
...
export function isTerminal(state: ResArcanaEssenceState): { score: number } | null {
