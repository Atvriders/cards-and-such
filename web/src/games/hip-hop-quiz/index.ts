...
const HipHopQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HipHopQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10, 20, or 30 questions in Settings. Heads up — bars, beats, and history all in play!`,
  ...
  reducer,isTerminal,
  hint: (state: HipHopQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HipHopQuizGame,
};
