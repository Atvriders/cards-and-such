...
import { MiniBaccaratMiniGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: MiniBaccaratMiniState): HintTarget | null => (state.phase === "ready" ? { selector: ".dm-btn", pulses: 3 } : null);
...
export const miniBaccaratMiniPlugin: GamePlugin<MiniBaccaratMiniState, MiniBaccaratMiniAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: MiniBaccaratMiniGame,
};
