...
const HachiHachiGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HachiHachiGame as unknown as React.ComponentType<unknown> })));
...
export const hachiHachiQuizPlugin: GamePlugin<HachiHachiState, HachiHachiAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HachiHachiState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
