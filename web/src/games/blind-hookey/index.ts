...
const BlindHookeyGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BlindHookeyGame as unknown as React.ComponentType<unknown> })));
...
export const blindHookeyPlugin: GamePlugin<BlindHookeyState, BlindHookeyAction, typeof settings> = {
  ...
  reducer,isTerminal,component:BlindHookeyGame,
