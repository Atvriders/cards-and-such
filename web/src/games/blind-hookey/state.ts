...
export interface BlindHookeySettings { dummy: boolean; }

export interface BlindHookeyState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: BlindHookeySettings): BlindHookeyState {
...
export function reducer(state: BlindHookeyState, action: BlindHookeyAction): BlindHookeyState {
...
export function isTerminal(state: BlindHookeyState): { score: number } | null {
