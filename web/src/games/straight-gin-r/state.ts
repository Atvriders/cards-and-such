...
export interface StraightGinRSettings { dummy: boolean; }
export interface StraightGinRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type StraightGinRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: StraightGinRSettings): StraightGinRState {
...
export function reducer(state: StraightGinRState, action: StraightGinRAction): StraightGinRState {
...
export function isTerminal(state: StraightGinRState): { score: number } | null {
