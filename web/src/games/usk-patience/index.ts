...
const UskPatienceGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.UskPatienceGame as unknown as React.ComponentType<unknown> })));
...
export const uskPatiencePlugin: GamePlugin<UskPatienceState, UskPatienceAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as UskPatienceSettings),
  reducer,
  isTerminal,
  hint: (state: UskPatienceState): HintTarget | null => {
