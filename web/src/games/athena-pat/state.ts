...
export interface AthenaPatSettings { dummy: boolean; }

export interface AthenaPatState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: AthenaPatSettings): AthenaPatState {
...
export function reducer(state: AthenaPatState, action: AthenaPatAction): AthenaPatState {
...
export function isTerminal(state: AthenaPatState): { score: number } | null {
