...
export interface BakersKlondikeSettings { dummy: boolean; }

export interface BakersKlondikeState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type BakersKlondikeAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: BakersKlondikeSettings): BakersKlondikeState {
...
export function reducer(state: BakersKlondikeState, action: BakersKlondikeAction): BakersKlondikeState {
...
export function isTerminal(state: BakersKlondikeState): { score: number } | null {
