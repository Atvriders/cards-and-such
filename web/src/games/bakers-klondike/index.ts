...
const BakersKlondikeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BakersKlondikeGame as unknown as React.ComponentType<unknown> })));
...
export const bakersKlondikePlugin: GamePlugin<BakersKlondikeState, BakersKlondikeAction, typeof settings> = {
  ...
  reducer,isTerminal,component:BakersKlondikeGame,
