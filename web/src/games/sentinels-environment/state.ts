...
export interface SentinelsEnvironmentSettings { dummy: boolean; }
export interface SentinelsEnvironmentState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type SentinelsEnvironmentAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: SentinelsEnvironmentSettings): SentinelsEnvironmentState {
