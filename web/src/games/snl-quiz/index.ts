...
const SnlQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SnlQuizGame as unknown as React.ComponentType<unknown> })));
const settings = { questions: { kind:"enum" as const, label:"Questions", options:["10","20","30"] as const, default:"10" as const } } as const;
type S = SettingsOf<typeof settings>;
export const snlQuizPlugin: GamePlugin<SnlQuizState, SnlQuizAction, typeof settings> = {
  id:"snl-quiz", title:"Saturday Night Live Quiz", category:"board",
  players:{ min:1, max:1, multiplayer:false },
  description:"Test your knowledge of SNL: cast members, sketches, hosts, and 50 years of late-night comedy.",
