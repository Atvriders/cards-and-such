...
const BatFlyerGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BatFlyerGame as unknown as React.ComponentType<unknown> })));
...
export const batFlyerPlugin: GamePlugin<BatFlyerState, BatFlyerAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: BatFlyerState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-bat-flyer-primary"]', pulses: 3 } : null,component:BatFlyerGame,
};
