...
import { FiveCardStudCasGame } from "./Game.js";
const settings = { dummy: { kind: "boolean" as const, label: "dummy", default: false } } as const;
type S = SettingsOf<typeof settings>;
const hint = (state: FiveCardStudCasState): HintTarget | null => (state.phase === "see" ? { selector: '[data-testid="hint-target-five-card-stud-cas-primary"]', pulses: 3 } : null);
export const fiveCardStudCasPlugin: GamePlugin<FiveCardStudCasState, FiveCardStudCasAction, typeof settings> = {
  ...
  reducer, isTerminal, hint, component: FiveCardStudCasGame,
};
