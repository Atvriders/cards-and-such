...
export interface FiveCardStudCasSettings { dummy: boolean; }
export interface FiveCardStudCasState { rngSeed: number; round: number; you: number[]; cpu: number[]; phase: "see" | "scored" | "done"; score: number; pts: number; result: string; }
export type FiveCardStudCasAction = { type: "play" } | { type: "fold" } | { type: "next" };
...
export function initialState(seed: number, _s: FiveCardStudCasSettings): FiveCardStudCasState {
...
export function reducer(state: FiveCardStudCasState, action: FiveCardStudCasAction): FiveCardStudCasState {
...
export function isTerminal(state: FiveCardStudCasState): { score: number } | null {
