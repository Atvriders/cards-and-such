...
const PatchworkExpressGameGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PatchworkExpressGameGame as unknown as React.ComponentType<unknown> })));
...
export const patchworkExpressGamePlugin: GamePlugin<PatchworkExpressGameState, PatchworkExpressGameAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: PatchworkExpressGameState): HintTarget | null => {
    const sel = tileHintSelector(state, "patex-grid");
