...
export interface PenguinSoliSettings { dummy: boolean; }

export interface PenguinSoliState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: PenguinSoliSettings): PenguinSoliState {
...
export function reducer(state: PenguinSoliState, action: PenguinSoliAction): PenguinSoliState {
...
export function isTerminal(state: PenguinSoliState): { score: number } | null {
