...
export interface KlondikeDealOneSettings { dummy: boolean; }

export interface KlondikeDealOneState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type KlondikeDealOneAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: KlondikeDealOneSettings): KlondikeDealOneState {
...
export function reducer(state: KlondikeDealOneState, action: KlondikeDealOneAction): KlondikeDealOneState {
...
export function isTerminal(state: KlondikeDealOneState): { score: number } | null {
