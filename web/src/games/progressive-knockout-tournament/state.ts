...
export interface ProgressiveKnockoutTournamentSettings { rounds: "10"; }

export interface ProgressiveKnockoutTournamentState {
  rngSeed: number;
  score: number;
  round: number;
  maxRounds: number;
...
export type ProgressiveKnockoutTournamentAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: ProgressiveKnockoutTournamentSettings): ProgressiveKnockoutTournamentState {
  return { rngSeed: seed >>> 0, score: 0, round: 1, maxRounds: 10, hand: [], lastGain: 0, phase: "ready" };
}

export function reducer(state: ProgressiveKnockoutTournamentState, action: ProgressiveKnockoutTournamentAction): ProgressiveKnockoutTournamentState {
...
export function isTerminal(state: ProgressiveKnockoutTournamentState): { score: number } | null {
