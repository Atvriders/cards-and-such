...
export type DoubleDummyWhistState = HuTrickState;
export type DoubleDummyWhistAction = HuTrickAction;
export interface DoubleDummyWhistSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: DoubleDummyWhistSettings): DoubleDummyWhistState => engine.initialState(seed);
