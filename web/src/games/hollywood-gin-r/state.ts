...
export interface HollywoodGinRSettings { dummy: boolean; }
export interface HollywoodGinRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type HollywoodGinRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: HollywoodGinRSettings): HollywoodGinRState {
...
export function reducer(state: HollywoodGinRState, action: HollywoodGinRAction): HollywoodGinRState {
...
export function isTerminal(state: HollywoodGinRState): { score: number } | null {
