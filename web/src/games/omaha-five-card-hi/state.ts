...
export interface OmahaFiveCardHiSettings { dummy: boolean; }
export interface OmahaFiveCardHiState { rngSeed: number; round: number; hand: number[]; rank: string; rankPts: number; score: number; phase: "deal" | "scored" | "done"; }
export type OmahaFiveCardHiAction = { type: "deal" } | { type: "next" };
...
export function initialState(seed: number, _s: OmahaFiveCardHiSettings): OmahaFiveCardHiState { return { rngSeed: seed, round: 1, hand: [], rank: "", rankPts: 0, score: 0, phase: "deal" }; }
export function reducer(state: OmahaFiveCardHiState, action: OmahaFiveCardHiAction): OmahaFiveCardHiState {
...
export function isTerminal(state: OmahaFiveCardHiState): { score: number } | null { return state.phase === "done" ? { score: state.score } : null; }
