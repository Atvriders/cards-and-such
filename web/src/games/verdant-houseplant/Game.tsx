...
export function VerdantHouseplant({ state, dispatch, onGameOver }: GameProps<VerdantHouseplantState, { mode: "easy" }>): JSX.Element {
      ...
      <div className="g-grid">
        {state.board.map((c, i) => (
          <div
            ...
            onClick={() => c === "" && dispatch({ type: "play", index: i } as VerdantHouseplantAction)}
          >
            {c}
          </div>
        ))}
