...
const QuadrupleAlliancePatGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.QuadrupleAlliancePatGame as unknown as React.ComponentType<unknown> })));
...
export const quadrupleAlliancePatPlugin: GamePlugin<QuadrupleAlliancePatState, QuadrupleAlliancePatAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as QuadrupleAlliancePatSettings),
  reducer,
  isTerminal,
  hint: (state: QuadrupleAlliancePatState): HintTarget | null => {
