...
export function SevensFanTanGame({ state, dispatch, onGameOver }: GameProps<SevensFanTanState, SevensFanTanSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="sevens-fan-tan-wrap sft-shed"><div className="sevens-fan-tan-done"><h2>Done!</h2><div>W: {state.wins} L: {state.losses}</div><div className="sevens-fan-tan-final">{state.score} pts</div></div></div>;
  return (
    <div className="sevens-fan-tan-wrap sft-shed">
