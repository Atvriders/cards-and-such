...
export interface HashiMiniState {
  puzzles: Puzzle[];
  idx: number;
  current: number[];
  ...
  score: number;
  phase: "playing" | "done";
  settings: HashiMiniSettings;
}

export type HashiMiniAction =
...
export const VALUES: readonly number[] = [1,2,3,4];
export const VALUE_LABELS: readonly string[] = ["1","2","3","4"];
...
export function initialState(seed: number, settings: HashiMiniSettings): HashiMiniState {
