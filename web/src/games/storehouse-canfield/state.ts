...
export interface StorehouseCanfieldSettings { dummy: boolean; }

export interface StorehouseCanfieldState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export type StorehouseCanfieldAction =
  | { type: "keep" }
...
export function initialState(seed: number, _s: StorehouseCanfieldSettings): StorehouseCanfieldState {
...
export function reducer(state: StorehouseCanfieldState, action: StorehouseCanfieldAction): StorehouseCanfieldState {
...
export function isTerminal(state: StorehouseCanfieldState): { score: number } | null {
