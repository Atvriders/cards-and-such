...
const PoeltlNbaGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PoeltlNbaGame as unknown as React.ComponentType<unknown> })));
...
export const poeltlNbaPlugin: GamePlugin<PoeltlNbaState, PoeltlNbaAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: PoeltlNbaState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-poeltl-nba-answer-0"]', pulses: 3 } : null, component: PoeltlNbaGame,
};
