...
const SanFranciscoQuakeQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SanFranciscoQuakeQuizGame as unknown as React.ComponentType<unknown> })));
...
export const sanFranciscoQuakeQuizPlugin: GamePlugin<SanFranciscoQuakeQuizState, SanFranciscoQuakeQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: SanFranciscoQuakeQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SanFranciscoQuakeQuizGame,
};
