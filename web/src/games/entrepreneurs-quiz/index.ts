...
const EntrepreneursQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.EntrepreneursQuizGame as unknown as React.ComponentType<unknown> })));
...
export const entrepreneursQuizPlugin: GamePlugin<EntrepreneursQuizState, EntrepreneursQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: EntrepreneursQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:EntrepreneursQuizGame,
};
