...
export interface RedAndBlackSettings { dummy: boolean; }

export interface RedAndBlackState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: RedAndBlackSettings): RedAndBlackState {
...
export function reducer(state: RedAndBlackState, action: RedAndBlackAction): RedAndBlackState {
...
export function isTerminal(state: RedAndBlackState): { score: number } | null {
