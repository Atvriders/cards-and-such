...
const SculptureQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SculptureQuizGame as unknown as React.ComponentType<unknown> })));
...
Choose 10, 20, or 30 questions in Settings. Whether you've stood before David in Florence or Cloud Gate in Chicago, this quiz will test your eye!`,
  ...
  reducer,isTerminal,
  hint: (state: SculptureQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:SculptureQuizGame,
};
