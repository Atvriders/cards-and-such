...
export const carcassonneSouthSeasPlugin: GamePlugin<CarcassonneSouthSeasState, CarcassonneSouthSeasAction, typeof settings> = {
  ...
  description: "Fishing, banana, shipping economics replace city scoring.",
  howToPlay: `Carcassonne: South Seas is a single-player tile-placement puzzle. Fishing, banana, shipping economics replace city scoring. Tiles draw from a randomized queue, and your job is to place each one onto a small grid in a way that maximises end-of-game scoring.

How it works: Each tile pair (orthogonal neighbours of same type) scores +2. Edge tiles representing shipping ports earn an extra +1 each.
