...
export const PUZZLES: Puzzle[] = [
  { prompt: "Cold dessert", choices: ["CAKE", "PIE", "ICECREAM", "TART"], correctIndex: 2 },
  { prompt: "Big African cat", choices: ["LION", "WOLF", "BEAR", "DEER"], correctIndex: 0 },
  { prompt: "Day after Mon.", choices: ["WED", "TUE", "THU", "FRI"], correctIndex: 1 },
  { prompt: "Pacific or Atlantic", choices: ["OCEAN", "RIVER", "POND", "LAKE"], correctIndex: 0 },
  { prompt: "Roman 50", choices: ["L", "C", "D", "M"], correctIndex: 0 },
  { prompt: "Snow vehicle", choices: ["BIKE", "BOAT", "SLED", "CAR"], correctIndex: 2 },
  { prompt: "Bee's product", choices: ["MILK", "HONEY", "SILK", "WAX"], correctIndex: 1 },
  { prompt: "Blacksmith metal", choices: ["GOLD", "TIN", "IRON", "ZINC"], correctIndex: 2 },
  { prompt: "Capital of France", choices: ["LYON", "NICE", "PARIS", "ROME"], correctIndex: 2 },
  { prompt: "Frozen water", choices: ["MIST", "ICE", "FOG", "DEW"], correctIndex: 1 },
];
