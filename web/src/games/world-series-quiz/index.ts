...
const WorldSeriesQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.WorldSeriesQuizGame as unknown as React.ComponentType<unknown> })));
...
export const worldSeriesQuizPlugin: GamePlugin<WorldSeriesQuizState, WorldSeriesQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: WorldSeriesQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:WorldSeriesQuizGame,
};
