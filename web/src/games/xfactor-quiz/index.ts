...
const XfactorQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.XfactorQuizGame as unknown as React.ComponentType<unknown> })));
...
export const xfactorQuizPlugin: GamePlugin<XfactorQuizState, XfactorQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: XfactorQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:XfactorQuizGame,
};
