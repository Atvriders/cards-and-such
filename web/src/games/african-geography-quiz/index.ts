...
const AfricanGeographyQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AfricanGeographyQuizGame as unknown as React.ComponentType<unknown> })));
...
export const africanGeographyQuizPlugin: GamePlugin<AfricanGeographyQuizState, AfricanGeographyQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: AfricanGeographyQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:AfricanGeographyQuizGame,
};
