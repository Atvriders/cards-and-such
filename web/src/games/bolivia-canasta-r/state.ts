...
export interface BoliviaCanastaRSettings { dummy: boolean; }
export interface BoliviaCanastaRState { rngSeed: number; round: number; hand: number[]; phase: "play" | "scored" | "done"; melds: number[][]; score: number; pts: number; deadwood: number; result: string; }
export type BoliviaCanastaRAction = { type: "score" } | { type: "next" };
...
export function initialState(seed: number, _s: BoliviaCanastaRSettings): BoliviaCanastaRState {
...
export function reducer(state: BoliviaCanastaRState, action: BoliviaCanastaRAction): BoliviaCanastaRState {
...
export function isTerminal(state: BoliviaCanastaRState): { score: number } | null {
