...
const KatrinaQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.KatrinaQuizGame as unknown as React.ComponentType<unknown> })));
...
export const katrinaQuizPlugin: GamePlugin<KatrinaQuizState, KatrinaQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: KatrinaQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:KatrinaQuizGame,
};
