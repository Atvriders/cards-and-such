...
const VoiceShowQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.VoiceShowQuizGame as unknown as React.ComponentType<unknown> })));
...
export const voiceShowQuizPlugin: GamePlugin<VoiceShowQuizState, VoiceShowQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: VoiceShowQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:VoiceShowQuizGame,
};
