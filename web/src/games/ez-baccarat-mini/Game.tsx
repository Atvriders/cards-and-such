...
import "./Game.css";
export function EzBaccaratMiniGame({ state, dispatch, onGameOver }: GameProps<EzBaccaratMiniState, EzBaccaratMiniSettings>): JSX.Element {
  const t = isTerminal(state); useEffect(() => { if (t) onGameOver(t.score); }, [t, onGameOver]);
  if (state.phase === "done") return <div className="dm-wrap"><h3>EZ Baccarat (Mini)</h3><div className="dm-done"><h2>Done!</h2><div className="dm-final">{state.score} pts</div></div></div>;
  return (
    <div className="dm-wrap">
      <h3>EZ Baccarat (Mini)</h3>
