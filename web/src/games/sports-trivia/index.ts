...
const SportsTrivia = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.SportsTrivia as unknown as React.ComponentType<unknown> })));
...
Your final score and accuracy are displayed at the end — challenge yourself to beat your previous best and become the ultimate sports expert!`,
  ...
  hint: (state: QuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-sports-trivia-answer-0"]', pulses: 3 } : null,component: SportsTrivia,
};
