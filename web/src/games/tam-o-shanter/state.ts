...
export interface TamOShanterSettings { dummy: boolean; }

export interface TamOShanterState {
  rngSeed: number;
  deck: number[];
  pos: number;
  hand: number[];
...
export function initialState(seed: number, _s: TamOShanterSettings): TamOShanterState {
...
export function reducer(state: TamOShanterState, action: TamOShanterAction): TamOShanterState {
...
export function isTerminal(state: TamOShanterState): { score: number } | null {
