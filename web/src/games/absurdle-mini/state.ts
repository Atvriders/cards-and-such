...
export const PUZZLES: Puzzle[] = [
  { prompt: "Five-letter word for 'home'", answer: "HOUSE", distractors: ["FLAT","SHED","TENT"] },
  { prompt: "Five-letter color", answer: "GREEN", distractors: ["RED","BLUE","BLACK"] },
  { prompt: "Five-letter mammal", answer: "HORSE", distractors: ["RAT","CAT","DOG"] },
  { prompt: "Five-letter sport", answer: "RUGBY", distractors: ["GOLF","POLO","SAIL"] },
  { prompt: "Five-letter weapon", answer: "SWORD", distractors: ["BOW","AXE","CLUB"] },
  { prompt: "Five-letter tree", answer: "MAPLE", distractors: ["OAK","FIR","ELM"] },
  { prompt: "Five-letter fruit", answer: "PEACH", distractors: ["FIG","KIWI","PLUM"] },
  { prompt: "Five-letter bird", answer: "EAGLE", distractors: ["OWL","CROW","HAWK"] },
  { prompt: "Five-letter drink", answer: "JUICE", distractors: ["TEA","ALE","RUM"] },
  { prompt: "Five-letter dance", answer: "TANGO", distractors: ["JIG","HOP","WALTZ"] },
];

export interface AbsurdleMiniSettings { rounds: "5" | "8" | "10"; }
