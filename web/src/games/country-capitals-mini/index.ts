...
const CountryCapitalsMiniGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CountryCapitalsMiniGame as unknown as React.ComponentType<unknown> })));
...
export const countryCapitalsMiniPlugin: GamePlugin<CountryCapitalsMiniState, CountryCapitalsMiniAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state: CountryCapitalsMiniState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-country-capitals-mini-answer-0"]', pulses: 3 } : null, component:CountryCapitalsMiniGame,
};
