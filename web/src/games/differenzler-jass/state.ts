...
export type DifferenzlerJassState = HuTrickState;
export type DifferenzlerJassAction = HuTrickAction;
export interface DifferenzlerJassSettings { dummy: boolean }
...
export const initialState = (seed: number, _s: DifferenzlerJassSettings): DifferenzlerJassState => engine.initialState(seed);
