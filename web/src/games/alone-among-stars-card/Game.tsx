...
export function AloneAmongStarsCardGame({ state, dispatch, onGameOver }: GameProps<AloneAmongStarsCardState, AloneAmongStarsCardSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="aasc-wrap"><div className="aasc-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
