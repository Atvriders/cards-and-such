...
const AloneAmongStarsCardGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.AloneAmongStarsCardGame as unknown as React.ComponentType<unknown> })));
...
export const aloneAmongStarsCardPlugin: GamePlugin<AloneAmongStarsCardState, AloneAmongStarsCardAction, typeof settings> = {
  ...
  reducer, isTerminal, hint: (state: AloneAmongStarsCardState): HintTarget | null => (state.phase === "choose" ? { selector: '[data-testid="hint-target-alone-among-stars-card-primary"]', pulses: 3 } : null), component: AloneAmongStarsCardGame,
};
