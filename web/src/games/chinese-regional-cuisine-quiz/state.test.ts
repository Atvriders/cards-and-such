...
describe("ChineseRegionalCuisineQuiz", () => {
  it("creates question pool", () => { expect(initialState(1,S).questions.length).toBeGreaterThanOrEqual(5); });
  ...
  it("submit on wrong answer adds zero", () => {
    const s=initialState(1,S);
