...
const ChineseRegionalCuisineQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.ChineseRegionalCuisineQuizGame as unknown as React.ComponentType<unknown> })));
...
Eat well and quiz hard!`,
  ...
  reducer,isTerminal,
  hint: (state: ChineseRegionalCuisineQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:ChineseRegionalCuisineQuizGame,
};
