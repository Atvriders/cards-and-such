...
const PaleoSurvivalGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.PaleoSurvivalGame as unknown as React.ComponentType<unknown> })));
...
export const paleoSurvivalPlugin: GamePlugin<PaleoSurvivalState, PaleoSurvivalAction, typeof settings> = {
  ...
  reducer,
  isTerminal,
  hint: (state: PaleoSurvivalState): HintTarget | null => (state.phase === "choosing" ? { selector: '[data-testid="hint-target-paleo-survival-primary"]', pulses: 3 } : null),
