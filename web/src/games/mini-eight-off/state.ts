...
export interface MiniEightOffSettings { dummy: boolean; }

export interface MiniEightOffState {
  rngSeed: number;
...
export type MiniEightOffAction = { type: "remove"; index: number } | { type: "noop" };
...
export function initialState(seed: number, _settings: MiniEightOffSettings): MiniEightOffState {
...
export function reducer(state: MiniEightOffState, action: MiniEightOffAction): MiniEightOffState {
...
export function isTerminal(state: MiniEightOffState): { score: number } | null {
