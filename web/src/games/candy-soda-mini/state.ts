...
export interface CandySodaMiniSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface CandySodaMiniState {
  rngSeed: number;
  grid: Grid;
...
export type CandySodaMiniAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: CandySodaMiniSettings): CandySodaMiniState {
...
export function reducer(state: CandySodaMiniState, action: CandySodaMiniAction): CandySodaMiniState {
...
export function isTerminal(state: CandySodaMiniState): { score: number } | null {
