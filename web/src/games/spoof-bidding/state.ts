...
export type SpoofBiddingAction = { type: "throw" } | { type: "next" };

export function initialState(seed: number, _s: SpoofBiddingSettings): SpoofBiddingState {
...
export function isTerminal(s: SpoofBiddingState): { score: number } | null { return s.phase === "done" ? { score: s.score } : null; }
