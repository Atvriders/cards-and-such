...
const DogCareQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.DogCareQuizGame as unknown as React.ComponentType<unknown> })));
...
export const dogCareQuizPlugin: GamePlugin<DogCareQuizState, DogCareQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: DogCareQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:DogCareQuizGame,
};
