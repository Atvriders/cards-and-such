...
export function SunderedIslesSagaGame({ state, dispatch, onGameOver }: GameProps<SunderedIslesSagaState, SunderedIslesSagaSettings>): JSX.Element {
  ...
  if (state.phase === "done") return <div className="sis-wrap"><div className="sis-done"><h2>Saga End</h2><p style={{ fontSize:"1.6rem", fontWeight:900, color:"#8e44ad" }}>{state.score} pts</p></div></div>;
