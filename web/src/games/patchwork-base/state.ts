...
export interface PatchworkBaseSettings { dummy: boolean; }
export interface PatchworkBaseState {
  rngSeed: number;
...
export type PatchworkBaseAction = { type: "place"; index: number };
...
export function initialState(seed: number, _s: PatchworkBaseSettings): PatchworkBaseState {
...
export function reducer(state: PatchworkBaseState, action: PatchworkBaseAction): PatchworkBaseState {
...
export function isTerminal(state: PatchworkBaseState): { score: number } | null {
