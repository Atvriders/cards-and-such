    ...
    <div className="proverbquiz-wrap">
      ...
      <div className="proverbquiz-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type: "select", choice: i } as ProverbQuizAction)}><span className="proverbquiz-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
