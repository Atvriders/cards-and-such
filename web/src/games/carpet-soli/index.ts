...
const CarpetSoliGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.CarpetSoliGame as unknown as React.ComponentType<unknown> })));
...
export const carpetSoliPlugin: GamePlugin<CarpetSoliState, CarpetSoliAction, typeof settings> = {
  ...
  settings,
  initialState: (seed: number, s: S) => initialState(seed, s as unknown as CarpetSoliSettings),
  reducer,
  isTerminal,
  hint: (state: CarpetSoliState): HintTarget | null => {
    const FOUNDATION_IDS = ["f1","f2","f3","f4","f5","f6","f7","f8"];
    const TABLEAU_IDS = ["t1","t2","t3","t4","t5","t6","t7","t8","t9","t10","t11","t12","t13","t14","t15","t16","t17","t18","t19","t20"];
