...
const HorrorFilmsQuizGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.HorrorFilmsQuizGame as unknown as React.ComponentType<unknown> })));
...
export const horrorFilmsQuizPlugin: GamePlugin<HorrorFilmsQuizState, HorrorFilmsQuizAction, typeof settings> = {
  ...
  reducer,isTerminal,
  hint: (state: HorrorFilmsQuizState): HintTarget | null => state.phase === "playing" ? { selector: '[data-testid="hint-target-quiz-answer-0"]', pulses: 3 } : null,
  component:HorrorFilmsQuizGame,
};
