...
const BattleYahtzeeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.BattleYahtzeeGame as unknown as React.ComponentType<unknown> })));
...
export const battleYahtzeePlugin: GamePlugin<BattleYahtzeeState, BattleYahtzeeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (state): HintTarget | null => (state.phase === "done" ? null : { selector: '[data-testid="hint-target-battle-yahtzee-primary"]', pulses: 3 }), component:BattleYahtzeeGame,
};
