...
export interface EuropeanBjSettings { dummy: boolean }
export interface EuropeanBjState {
  rngSeed: number;
  round: number;
  you: number[];
  dealer: number[];
...
export type EuropeanBjAction = { type: "hit" } | { type: "stand" } | { type: "double" } | { type: "surrender" } | { type: "next" };
...
export function initialState(seed: number, _s: EuropeanBjSettings): EuropeanBjState {
...
export function reducer(state: EuropeanBjState, action: EuropeanBjAction): EuropeanBjState {
...
export function isTerminal(state: EuropeanBjState): { score: number } | null {
