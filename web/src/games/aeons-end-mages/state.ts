...
export interface AeonsEndMagesSettings { dummy: boolean; }
export interface AeonsEndMagesState {
  rngSeed: number;
  round: number;
  playerRoll: number;
  cpuRoll: number;
...
export type AeonsEndMagesAction = { type: "play" } | { type: "next" };
export function initialState(seed: number, _s: AeonsEndMagesSettings): AeonsEndMagesState {
