...
export function Game({ state, dispatch, onGameOver }: GameProps<PuzzleState, Settings>): JSX.Element {
  ...
  const phaseLabel = state.phase === "white1" ? "White (move 1)" : state.phase === "white2" ? "White (move 2)" : "Black";

  return (
    <div className="cp-puzzle">
      <div className="cp-header">
        <span className="cp-title">Mate in Two</span>
        <span className="cp-progress">Puzzle {state.puzzleIndex + 1} / 10 — {phaseLabel}</span>
      </div>
