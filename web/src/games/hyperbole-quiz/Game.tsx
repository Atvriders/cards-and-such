    ...
    <div className="hyperbolequiz-wrap">
      ...
      <div className="hyperbolequiz-choices">
        {q.choices.map((choice, i) => {
          ...
          return <button key={i} className={cls} disabled={isResult} onClick={() => dispatch({ type: "select", choice: i } as HyperboleQuizAction)}><span className="hyperbolequiz-choice-letter">{LABELS[i]}</span>{choice}</button>;
        })}
      </div>
