...
// Jewel Quest Arcade: 6x6 match-3 with 60s timer.
...
export interface JewelQuestArcadeSettings { dummy: boolean; }

export type Cell = number;
export type Grid = Cell[][];

export interface JewelQuestArcadeState {
  rngSeed: number;
  grid: Grid;
...
export type JewelQuestArcadeAction =
  | { type: "tick" }
...
export function initialState(seed: number, _settings: JewelQuestArcadeSettings): JewelQuestArcadeState {
...
export function reducer(state: JewelQuestArcadeState, action: JewelQuestArcadeAction): JewelQuestArcadeState {
...
export function isTerminal(state: JewelQuestArcadeState): { score: number } | null {
