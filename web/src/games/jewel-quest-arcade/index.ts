...
const JewelQuestArcadeGame = /* @__PURE__ */ lazy(() => import("./Game.js").then((mod) => ({ default: mod.JewelQuestArcadeGame as unknown as React.ComponentType<unknown> })));
...
export const jewelQuestArcadePlugin: GamePlugin<JewelQuestArcadeState, JewelQuestArcadeAction, typeof settings> = {
  ...
  reducer,isTerminal,hint: (s: any) => { const p = (s as any).phase; if (p === "gameover" || p === "done" || p === "ended" || (s as any).gameOver) return null; return { selector: '[data-testid="hint-target-jewel-quest-arcade-action"]', pulses: 3 }; }, component:JewelQuestArcadeGame,
};
