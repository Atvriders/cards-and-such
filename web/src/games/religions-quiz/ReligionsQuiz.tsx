...
import type { ReligionsQuizState, ReligionsQuizSettings } from "./state.js";
import { isTerminal } from "./state.js";
import "./ReligionsQuiz.css";
export function ReligionsQuiz({ state, dispatch, onGameOver }: GameProps<ReligionsQuizState, ReligionsQuizSettings>): JSX.Element {
