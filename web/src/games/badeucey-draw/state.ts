...
export interface BadeuceyDrawSettings { dummy: boolean; }
export interface BadeuceyDrawState { rngSeed: number; round: number; you: number[]; cpu: number[]; phase: "see" | "scored" | "done"; score: number; pts: number; result: string; }
export type BadeuceyDrawAction = { type: "play" } | { type: "fold" } | { type: "next" };
...
export function initialState(seed: number, _s: BadeuceyDrawSettings): BadeuceyDrawState {
...
export function reducer(state: BadeuceyDrawState, action: BadeuceyDrawAction): BadeuceyDrawState {
...
export function isTerminal(state: BadeuceyDrawState): { score: number } | null {
