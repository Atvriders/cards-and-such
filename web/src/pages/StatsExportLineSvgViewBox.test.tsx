...
/**
 * W1549: StatsPage's per-chart "Activity" line-chart export button
 * (`data-testid="stats-export-line"`) wraps a 14×14 download-glyph `<svg>`.
 ...
 *
 * Mirrors W1534 (stats-export-bar viewBox) for the sibling line-export
 * button, complementing the existing focusable, title, type, and
 * click-flow pins for the same button.
 */
describe("StatsPage — export-line inner SVG viewBox", () => {
  beforeEach(() => {
    localStorage.clear();
  });

  it("W1549: stats-export-line inner <svg> pins viewBox='0 0 16 16' for the 16-unit download-glyph coordinate system", () => {
    render(
      <MemoryRouter>
        <ConfirmProvider>
          <StatsPage />
