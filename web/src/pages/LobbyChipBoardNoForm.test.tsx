...
/**
 * W2675 — the LobbyPage `chip-board` Chip <button> MUST NOT carry a
 ...
 *   - W2657 / LobbyChipBoardNoName pins `name`-absence.
 ...
 * (or any other value) to the chip-board <button>. This file closes
 * that gap.
 *
 ...
 * changes.
 */
describe("LobbyPage — chip-board button has no form attribute (W2675)", () => {
  beforeEach(() => {
    localStorage.clear();
  });
  ...
  it("the chip-board <button> does NOT carry a form attribute", () => {
    render(
    ...
    // The actual contract: no `form` attribute on chip-board. Use
